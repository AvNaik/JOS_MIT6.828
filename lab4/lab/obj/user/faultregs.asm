	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800776:	0f be 80 64 16 80 00 	movsbl 0x801664(%eax),%eax
  80077d:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800941:	50                   	push   %eax
  800942:	68 7c 16 80 00       	push   $0x80167c
  800947:	53                   	push   %ebx
  800948:	56                   	push   %esi
  ...
  800959:	52                   	push   %edx
  80095a:	68 85 16 80 00       	push   $0x801685
  80095f:	53                   	push   %ebx
  800960:	56                   	push   %esi
  ...
  80097e:	b8 75 16 80 00       	mov    $0x801675,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801226:	50                   	push   %eax
  801227:	68 cf 18 80 00       	push   $0x8018cf
  80122c:	6a 21                	push   $0x21
  80122e:	68 e9 18 80 00       	push   $0x8018e9
  801233:	e8 b7 f3 ff ff       	call   8005ef <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  801238:	e8 d5 fd ff ff       	call   801012 <sys_getenvid>
  80123d:	83 ec 08             	sub    $0x8,%esp
  801240:	68 58 12 80 00       	push   $0x801258
  801245:	50                   	push   %eax
  801246:	e8 0e ff ff ff       	call   801159 <sys_env_set_pgfault_upcall>

	   // Save handler pointer for assembly to call.
	   _pgfault_handler = handler;
  80124b:	8b 45 08             	mov    0x8(%ebp),%eax
  80124e:	a3 d0 20 80 00       	mov    %eax,0x8020d0
}
...
movl _pgfault_handler, %eax
  801259:	a1 d0 20 80 00       	mov    0x8020d0,%eax
call *%eax
...
// LAB 4: Your code here.
  ...
  801267:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  80126b:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  80126e:	89 5c 24 30          	mov    %ebx,0x30(%esp)

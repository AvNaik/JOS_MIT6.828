	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ce:	e8 9d 0b 00 00       	call   800d70 <__udivdi3>
  ...
  800211:	e8 8a 0c 00 00       	call   800ea0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800a9c:	68 64 12 80 00       	push   $0x801264
  800aa1:	6a 23                	push   $0x23
  800aa3:	68 81 12 80 00       	push   $0x801281
  800aa8:	e8 74 02 00 00       	call   800d21 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b1d:	68 64 12 80 00       	push   $0x801264
  800b22:	6a 23                	push   $0x23
  800b24:	68 81 12 80 00       	push   $0x801281
  800b29:	e8 f3 01 00 00       	call   800d21 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b5f:	68 64 12 80 00       	push   $0x801264
  800b64:	6a 23                	push   $0x23
  800b66:	68 81 12 80 00       	push   $0x801281
  800b6b:	e8 b1 01 00 00       	call   800d21 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ba1:	68 64 12 80 00       	push   $0x801264
  800ba6:	6a 23                	push   $0x23
  800ba8:	68 81 12 80 00       	push   $0x801281
  800bad:	e8 6f 01 00 00       	call   800d21 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800be3:	68 64 12 80 00       	push   $0x801264
  800be8:	6a 23                	push   $0x23
  800bea:	68 81 12 80 00       	push   $0x801281
  800bef:	e8 2d 01 00 00       	call   800d21 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c25:	68 64 12 80 00       	push   $0x801264
  800c2a:	6a 23                	push   $0x23
  800c2c:	68 81 12 80 00       	push   $0x801281
  800c31:	e8 eb 00 00 00       	call   800d21 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800c89:	68 64 12 80 00       	push   $0x801264
  800c8e:	6a 23                	push   $0x23
  800c90:	68 81 12 80 00       	push   $0x801281
  800c95:	e8 87 00 00 00       	call   800d21 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800caf:	75 2a                	jne    800cdb <set_pgfault_handler+0x39>
			 // First time through!
  ...
  800cc9:	50                   	push   %eax
  800cca:	68 8f 12 80 00       	push   $0x80128f
  800ccf:	6a 21                	push   $0x21
  800cd1:	68 a9 12 80 00       	push   $0x8012a9
  800cd6:	e8 46 00 00 00       	call   800d21 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  800cdb:	e8 d5 fd ff ff       	call   800ab5 <sys_getenvid>
  800ce0:	83 ec 08             	sub    $0x8,%esp
  800ce3:	68 fb 0c 80 00       	push   $0x800cfb
  800ce8:	50                   	push   %eax
  800ce9:	e8 0e ff ff ff       	call   800bfc <sys_env_set_pgfault_upcall>

	   // Save handler pointer for assembly to call.
	   _pgfault_handler = handler;
  800cee:	8b 45 08             	mov    0x8(%ebp),%eax
  800cf1:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800cf6:	83 c4 10             	add    $0x10,%esp
  800cf9:	c9                   	leave  
  800cfa:	c3                   	ret    

00800cfb <_pgfault_upcall>:
...
movl _pgfault_handler, %eax
  800cfc:	a1 08 20 80 00       	mov    0x802008,%eax
call *%eax
...
// LAB 4: Your code here.
  ...
  800d0a:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  800d0e:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  800d11:	89 5c 24 30          	mov    %ebx,0x30(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d25:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800d26:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800d29:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800d2f:	e8 81 fd ff ff       	call   800ab5 <sys_getenvid>
  800d34:	83 ec 0c             	sub    $0xc,%esp
  800d37:	ff 75 0c             	pushl  0xc(%ebp)
  800d3a:	ff 75 08             	pushl  0x8(%ebp)
  800d3d:	56                   	push   %esi
  800d3e:	50                   	push   %eax
  800d3f:	68 b8 12 80 00       	push   $0x8012b8
  800d44:	e8 22 f4 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800d49:	83 c4 18             	add    $0x18,%esp
  800d4c:	53                   	push   %ebx
  800d4d:	ff 75 10             	pushl  0x10(%ebp)
  800d50:	e8 c5 f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800d55:	c7 04 24 1a 10 80 00 	movl   $0x80101a,(%esp)
  800d5c:	e8 0a f4 ff ff       	call   80016b <cprintf>
  800d61:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800d64:	cc                   	int3   
  800d65:	eb fd                	jmp    800d64 <_panic+0x43>

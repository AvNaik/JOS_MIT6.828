...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 1c             	sub    $0x1c,%esp
	...
	if ((who = fork()) != 0) {
  80003c:	e8 97 0d 00 00       	call   800dd8 <fork>
  ...
  800067:	e8 ce 0f 00 00       	call   80103a <ipc_send>
  ...
  800079:	56                   	push   %esi
  80007a:	e8 5c 0f 00 00       	call   800fdb <ipc_recv>
  ...
  8000a9:	e8 8c 0f 00 00       	call   80103a <ipc_send>
		if (i == 10)
...
sys_env_destroy(envid_t envid)
{
  ...
  800ae6:	e8 dc 05 00 00       	call   8010c7 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b67:	e8 5b 05 00 00       	call   8010c7 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ba9:	e8 19 05 00 00       	call   8010c7 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800beb:	e8 d7 04 00 00       	call   8010c7 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c2d:	e8 95 04 00 00       	call   8010c7 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c6f:	e8 53 04 00 00       	call   8010c7 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cd3:	e8 ef 03 00 00       	call   8010c7 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800cec:	8b 40 04             	mov    0x4(%eax),%eax
	   // Hint:
  ...
  800cf1:	c1 ea 0c             	shr    $0xc,%edx
  800cf4:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx

	   if (!(err & 2)) {
  800cfb:	a8 02                	test   $0x2,%al
  800cfd:	75 15                	jne    800d14 <pgfault+0x34>
			 panic("pgfault was not a write. err: %x", err);
  800cff:	50                   	push   %eax
  800d00:	68 d0 16 80 00       	push   $0x8016d0
  800d05:	68 bc 00 00 00       	push   $0xbc
  800d0a:	68 f1 16 80 00       	push   $0x8016f1
  800d0f:	e8 b3 03 00 00       	call   8010c7 <_panic>
	   } else if (!(pte & PTE_COW)) {
  800d14:	f6 c6 08             	test   $0x8,%dh
  800d17:	75 17                	jne    800d30 <pgfault+0x50>
			 panic("pgfault is not copy on write");
  800d19:	83 ec 04             	sub    $0x4,%esp
  800d1c:	68 fc 16 80 00       	push   $0x8016fc
  800d21:	68 be 00 00 00       	push   $0xbe
  800d26:	68 f1 16 80 00       	push   $0x8016f1
  800d2b:	e8 97 03 00 00       	call   8010c7 <_panic>
  ...
  800d35:	68 00 00 40 00       	push   $0x400000
  800d3a:	6a 00                	push   $0x0
  800d3c:	e8 f0 fd ff ff       	call   800b31 <sys_page_alloc>
  800d41:	83 c4 10             	add    $0x10,%esp
  800d44:	85 c0                	test   %eax,%eax
  800d46:	79 15                	jns    800d5d <pgfault+0x7d>
			 panic("sys_page_alloc: %e", r);
  800d48:	50                   	push   %eax
  800d49:	68 19 17 80 00       	push   $0x801719
  800d4e:	68 c9 00 00 00       	push   $0xc9
  800d53:	68 f1 16 80 00       	push   $0x8016f1
  800d58:	e8 6a 03 00 00       	call   8010c7 <_panic>
	   }
	   memmove(UTEMP, ROUNDDOWN(addr, PGSIZE), PGSIZE);
  800d5d:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  800d63:	83 ec 04             	sub    $0x4,%esp
  800d66:	68 00 10 00 00       	push   $0x1000
  800d6b:	53                   	push   %ebx
  800d6c:	68 00 00 40 00       	push   $0x400000
  800d71:	e8 4a fb ff ff       	call   8008c0 <memmove>
	   if ((r = sys_page_map(0,
  800d76:	c7 04 24 07 00 00 00 	movl   $0x7,(%esp)
  800d7d:	53                   	push   %ebx
  800d7e:	6a 00                	push   $0x0
  800d80:	68 00 00 40 00       	push   $0x400000
  800d85:	6a 00                	push   $0x0
  800d87:	e8 e8 fd ff ff       	call   800b74 <sys_page_map>
  800d8c:	83 c4 20             	add    $0x20,%esp
  800d8f:	85 c0                	test   %eax,%eax
  800d91:	79 15                	jns    800da8 <pgfault+0xc8>
								UTEMP,
								0,
  ...
  800d93:	50                   	push   %eax
  800d94:	68 2c 17 80 00       	push   $0x80172c
  800d99:	68 d1 00 00 00       	push   $0xd1
  800d9e:	68 f1 16 80 00       	push   $0x8016f1
  800da3:	e8 1f 03 00 00       	call   8010c7 <_panic>
	   }
	   if ((r = sys_page_unmap(0, UTEMP)) < 0) {
  800da8:	83 ec 08             	sub    $0x8,%esp
  800dab:	68 00 00 40 00       	push   $0x400000
  800db0:	6a 00                	push   $0x0
  800db2:	e8 ff fd ff ff       	call   800bb6 <sys_page_unmap>
  800db7:	83 c4 10             	add    $0x10,%esp
  800dba:	85 c0                	test   %eax,%eax
  800dbc:	79 15                	jns    800dd3 <pgfault+0xf3>
			 panic("unmap %e", r);
  800dbe:	50                   	push   %eax
  800dbf:	68 3c 17 80 00       	push   $0x80173c
  800dc4:	68 d4 00 00 00       	push   $0xd4
  800dc9:	68 f1 16 80 00       	push   $0x8016f1
  800dce:	e8 f4 02 00 00       	call   8010c7 <_panic>
	   }
}
...
fork(void)
{
  ...
  800de1:	68 e0 0c 80 00       	push   $0x800ce0
  800de6:	e8 22 03 00 00       	call   80110d <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800deb:	b8 07 00 00 00       	mov    $0x7,%eax
  800df0:	cd 30                	int    $0x30
  800df2:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  800df5:	89 45 dc             	mov    %eax,-0x24(%ebp)

	   envid_t envid = sys_exofork();
	   if (envid < 0) {
  800df8:	83 c4 10             	add    $0x10,%esp
  800dfb:	85 c0                	test   %eax,%eax
  800dfd:	79 15                	jns    800e14 <fork+0x3c>
			 panic("sys_exofork: %e", envid);
  800dff:	50                   	push   %eax
  800e00:	68 45 17 80 00       	push   $0x801745
  800e05:	68 25 01 00 00       	push   $0x125
  800e0a:	68 f1 16 80 00       	push   $0x8016f1
  800e0f:	e8 b3 02 00 00       	call   8010c7 <_panic>
  800e14:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  800e1b:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	   } else if (envid == 0) {  // child
  800e1f:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  800e23:	75 1c                	jne    800e41 <fork+0x69>
			 thisenv = &envs[ENVX(sys_getenvid())];
  800e25:	e8 c9 fc ff ff       	call   800af3 <sys_getenvid>
  800e2a:	25 ff 03 00 00       	and    $0x3ff,%eax
  800e2f:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e32:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800e37:	a3 04 20 80 00       	mov    %eax,0x802004
			 return envid;
  800e3c:	e9 75 01 00 00       	jmp    800fb6 <fork+0x1de>
	   //		thisenv->env_id,
	   //		envid);
	   ...
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
  800e41:	8b 7d e0             	mov    -0x20(%ebp),%edi
  800e44:	8b 04 bd 00 d0 7b ef 	mov    -0x10843000(,%edi,4),%eax
  800e4b:	a8 01                	test   $0x1,%al
  800e4d:	0f 84 1c 01 00 00    	je     800f6f <fork+0x197>
  800e53:	89 fb                	mov    %edi,%ebx
  800e55:	c1 e3 0a             	shl    $0xa,%ebx
  800e58:	c1 e7 16             	shl    $0x16,%edi
  800e5b:	be 00 00 00 00       	mov    $0x0,%esi
  800e60:	e9 f8 00 00 00       	jmp    800f5d <fork+0x185>
				    continue;
			 }
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
  800e65:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800e6b:	0f 84 e0 00 00 00    	je     800f51 <fork+0x179>
						  continue;
				    } else if (pn >= (UTOP >> PGSHIFT)) {
  800e71:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800e77:	0f 87 d0 00 00 00    	ja     800f4d <fork+0x175>
						  is_below_ulim = false;
				    } else if (uvpt[pn] & PTE_P) {
  800e7d:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800e84:	a8 01                	test   $0x1,%al
  800e86:	0f 84 c5 00 00 00    	je     800f51 <fork+0x179>
	   static int
duppage(envid_t envid, unsigned pn)
{
	   ...
	   int r;
	   pte_t pte = uvpt[pn];
  800e8c:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax

	   if (!(pte & PTE_W) && !(pte & PTE_COW)) {
  800e93:	a9 02 08 00 00       	test   $0x802,%eax
  800e98:	75 3d                	jne    800ed7 <fork+0xff>
			 if ((r = sys_page_map(thisenv->env_id,
  800e9a:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800ea0:	8b 52 48             	mov    0x48(%edx),%edx
  800ea3:	83 ec 0c             	sub    $0xc,%esp
  800ea6:	25 07 0e 00 00       	and    $0xe07,%eax
  800eab:	50                   	push   %eax
  800eac:	57                   	push   %edi
  800ead:	ff 75 dc             	pushl  -0x24(%ebp)
  800eb0:	57                   	push   %edi
  800eb1:	52                   	push   %edx
  800eb2:	e8 bd fc ff ff       	call   800b74 <sys_page_map>
  800eb7:	83 c4 20             	add    $0x20,%esp
  800eba:	85 c0                	test   %eax,%eax
  800ebc:	0f 89 8f 00 00 00    	jns    800f51 <fork+0x179>
									   (void *)(pn * PGSIZE),
									   envid,
									   (void *)(pn * PGSIZE),
									   pte & PTE_SYSCALL)) < 0) {
				    panic("sys_page_map: %e", r);
  800ec2:	50                   	push   %eax
  800ec3:	68 55 17 80 00       	push   $0x801755
  800ec8:	68 f0 00 00 00       	push   $0xf0
  800ecd:	68 f1 16 80 00       	push   $0x8016f1
  800ed2:	e8 f0 01 00 00       	call   8010c7 <_panic>
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
  800ed7:	25 05 06 00 00       	and    $0x605,%eax
  800edc:	80 cc 08             	or     $0x8,%ah
  800edf:	89 c1                	mov    %eax,%ecx
  800ee1:	89 45 d8             	mov    %eax,-0x28(%ebp)
  800ee4:	a1 04 20 80 00       	mov    0x802004,%eax
  800ee9:	8b 40 48             	mov    0x48(%eax),%eax
  800eec:	83 ec 0c             	sub    $0xc,%esp
  800eef:	51                   	push   %ecx
  800ef0:	57                   	push   %edi
  800ef1:	ff 75 dc             	pushl  -0x24(%ebp)
  800ef4:	57                   	push   %edi
  800ef5:	50                   	push   %eax
  800ef6:	e8 79 fc ff ff       	call   800b74 <sys_page_map>
  800efb:	83 c4 20             	add    $0x20,%esp
  800efe:	85 c0                	test   %eax,%eax
  800f00:	79 15                	jns    800f17 <fork+0x13f>
								(void *)(pn * PGSIZE),
								envid,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800f02:	50                   	push   %eax
  800f03:	68 55 17 80 00       	push   $0x801755
  800f08:	68 fe 00 00 00       	push   $0xfe
  800f0d:	68 f1 16 80 00       	push   $0x8016f1
  800f12:	e8 b0 01 00 00       	call   8010c7 <_panic>
	   }
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
								(void *)(pn * PGSIZE),
								thisenv->env_id,
  800f17:	a1 04 20 80 00       	mov    0x802004,%eax
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
	   }
	   ...
	   // remap our page to have copy on write
	   if ((r = sys_page_map(thisenv->env_id,
  800f1c:	8b 50 48             	mov    0x48(%eax),%edx
  800f1f:	8b 40 48             	mov    0x48(%eax),%eax
  800f22:	83 ec 0c             	sub    $0xc,%esp
  800f25:	ff 75 d8             	pushl  -0x28(%ebp)
  800f28:	57                   	push   %edi
  800f29:	52                   	push   %edx
  800f2a:	57                   	push   %edi
  800f2b:	50                   	push   %eax
  800f2c:	e8 43 fc ff ff       	call   800b74 <sys_page_map>
  800f31:	83 c4 20             	add    $0x20,%esp
  800f34:	85 c0                	test   %eax,%eax
  800f36:	79 19                	jns    800f51 <fork+0x179>
								(void *)(pn * PGSIZE),
								thisenv->env_id,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800f38:	50                   	push   %eax
  800f39:	68 55 17 80 00       	push   $0x801755
  800f3e:	68 07 01 00 00       	push   $0x107
  800f43:	68 f1 16 80 00       	push   $0x8016f1
  800f48:	e8 7a 01 00 00       	call   8010c7 <_panic>
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
						  continue;
						  ...
						  is_below_ulim = false;
  800f4d:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
				    continue;
			 ...
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
  800f51:	83 c6 01             	add    $0x1,%esi
  800f54:	83 c3 01             	add    $0x1,%ebx
  800f57:	81 c7 00 10 00 00    	add    $0x1000,%edi
  800f5d:	81 fe ff 03 00 00    	cmp    $0x3ff,%esi
  800f63:	7f 0a                	jg     800f6f <fork+0x197>
  800f65:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800f69:	0f 85 f6 fe ff ff    	jne    800e65 <fork+0x8d>
	   ...
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
  800f6f:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
  800f73:	8b 45 e0             	mov    -0x20(%ebp),%eax
  800f76:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  800f7b:	7f 0a                	jg     800f87 <fork+0x1af>
  800f7d:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800f81:	0f 85 ba fe ff ff    	jne    800e41 <fork+0x69>
	   }
	   //	cprintf("\n");
  ...
  800f8a:	68 66 11 80 00       	push   $0x801166
  800f8f:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  800f92:	56                   	push   %esi
  800f93:	e8 a2 fc ff ff       	call   800c3a <sys_env_set_pgfault_upcall>
	   // allocate the user exception stack (not COW)
	   sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_W | PTE_U);
  800f98:	83 c4 0c             	add    $0xc,%esp
  800f9b:	6a 06                	push   $0x6
  800f9d:	68 00 f0 bf ee       	push   $0xeebff000
  800fa2:	56                   	push   %esi
  800fa3:	e8 89 fb ff ff       	call   800b31 <sys_page_alloc>
	   // let the child start
	   sys_env_set_status(envid, ENV_RUNNABLE);
  800fa8:	83 c4 08             	add    $0x8,%esp
  800fab:	6a 02                	push   $0x2
  800fad:	56                   	push   %esi
  800fae:	e8 45 fc ff ff       	call   800bf8 <sys_env_set_status>

	   return envid;
  800fb3:	83 c4 10             	add    $0x10,%esp
}
  800fb6:	8b 45 d4             	mov    -0x2c(%ebp),%eax
...
sfork(void)
{
  ...
  800fc7:	68 66 17 80 00       	push   $0x801766
  800fcc:	68 52 01 00 00       	push   $0x152
  800fd1:	68 f1 16 80 00       	push   $0x8016f1
  800fd6:	e8 ec 00 00 00       	call   8010c7 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800fde:	56                   	push   %esi
  800fdf:	53                   	push   %ebx
  800fe0:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  800fe9:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  800feb:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  800ff0:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  800ff3:	83 ec 0c             	sub    $0xc,%esp
  800ff6:	50                   	push   %eax
  800ff7:	e8 a3 fc ff ff       	call   800c9f <sys_ipc_recv>
  ...
  801001:	78 0e                	js     801011 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  801003:	8b 15 04 20 80 00    	mov    0x802004,%edx
  801009:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  80100c:	8b 52 78             	mov    0x78(%edx),%edx
  80100f:	eb 0a                	jmp    80101b <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
  ...
  80101d:	74 02                	je     801021 <ipc_recv+0x46>
			 *from_env_store = s_envid;
  80101f:	89 0e                	mov    %ecx,(%esi)

	   if (perm_store)
  801021:	85 db                	test   %ebx,%ebx
  801023:	74 02                	je     801027 <ipc_recv+0x4c>
			 *perm_store = s_perm;
  801025:	89 13                	mov    %edx,(%ebx)

	   return (a >=0) ? thisenv -> env_ipc_value : a;
  801027:	85 c0                	test   %eax,%eax
  801029:	78 08                	js     801033 <ipc_recv+0x58>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801043:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  80104c:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  80104e:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  ...
  80105a:	56                   	push   %esi
  80105b:	57                   	push   %edi
  80105c:	e8 1b fc ff ff       	call   800c7c <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  801061:	83 c4 10             	add    $0x10,%esp
  801064:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801067:	75 07                	jne    801070 <ipc_send+0x36>
				    sys_yield();
  801069:	e8 a4 fa ff ff       	call   800b12 <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  80106e:	eb e6                	jmp    801056 <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  801072:	74 12                	je     801086 <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  801074:	50                   	push   %eax
  801075:	68 7c 17 80 00       	push   $0x80177c
  80107a:	6a 4b                	push   $0x4b
  80107c:	68 90 17 80 00       	push   $0x801790
  801081:	e8 41 00 00 00       	call   8010c7 <_panic>
			 }
	   }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801099:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80109c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  8010a2:	8b 52 50             	mov    0x50(%edx),%edx
  8010a5:	39 ca                	cmp    %ecx,%edx
  8010a7:	75 0d                	jne    8010b6 <ipc_find_env+0x28>
				    return envs[i].env_id;
  8010a9:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8010ac:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  8010b1:	8b 40 48             	mov    0x48(%eax),%eax
  8010b4:	eb 0f                	jmp    8010c5 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
	   int i;
	   for (i = 0; i < NENV; i++)
  8010b6:	83 c0 01             	add    $0x1,%eax
  8010b9:	3d 00 04 00 00       	cmp    $0x400,%eax
  8010be:	75 d9                	jne    801099 <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010cf:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8010d5:	e8 19 fa ff ff       	call   800af3 <sys_getenvid>
  8010da:	83 ec 0c             	sub    $0xc,%esp
  8010dd:	ff 75 0c             	pushl  0xc(%ebp)
  8010e0:	ff 75 08             	pushl  0x8(%ebp)
  8010e3:	56                   	push   %esi
  8010e4:	50                   	push   %eax
  8010e5:	68 9c 17 80 00       	push   $0x80179c
  ...
  8010f6:	e8 5d f0 ff ff       	call   800158 <vcprintf>
	cprintf("\n");
  8010fb:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  801102:	e8 a2 f0 ff ff       	call   8001a9 <cprintf>
  801107:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  80110a:	cc                   	int3   
  80110b:	eb fd                	jmp    80110a <_panic+0x43>

0080110d <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801113:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  80111a:	75 2a                	jne    801146 <set_pgfault_handler+0x39>
			 // First time through!
			 // LAB 4: Your code here.
  ...
  801128:	e8 04 fa ff ff       	call   800b31 <sys_page_alloc>
			 if (a < 0)
  80112d:	83 c4 10             	add    $0x10,%esp
  801130:	85 c0                	test   %eax,%eax
  801132:	79 12                	jns    801146 <set_pgfault_handler+0x39>
				    panic ("sys_page_alloc Failed. %e", a);
  801134:	50                   	push   %eax
  801135:	68 c0 17 80 00       	push   $0x8017c0
  80113a:	6a 21                	push   $0x21
  80113c:	68 da 17 80 00       	push   $0x8017da
  801141:	e8 81 ff ff ff       	call   8010c7 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  801146:	e8 a8 f9 ff ff       	call   800af3 <sys_getenvid>
  80114b:	83 ec 08             	sub    $0x8,%esp
  80114e:	68 66 11 80 00       	push   $0x801166
  801153:	50                   	push   %eax
  801154:	e8 e1 fa ff ff       	call   800c3a <sys_env_set_pgfault_upcall>
...
movl _pgfault_handler, %eax
  801167:	a1 08 20 80 00       	mov    0x802008,%eax
call *%eax
...
// LAB 4: Your code here.
  ...
  801171:	8b 44 24 28          	mov    0x28(%esp),%eax
   movl 48(%esp), %ebx	// grab trap-time esp
  801175:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  801179:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  80117c:	89 5c 24 30          	mov    %ebx,0x30(%esp)

...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	...
	if ((who = fork()) == 0) {
  800039:	e8 75 0e 00 00       	call   800eb3 <fork>
  ...
  8000db:	e8 35 10 00 00       	call   801115 <ipc_send>
		return;
  ...
  800131:	e8 df 0f 00 00       	call   801115 <ipc_send>
  ...
  800143:	50                   	push   %eax
  800144:	e8 6d 0f 00 00       	call   8010b6 <ipc_recv>
	cprintf("%x got message: %s\n", who, TEMP_ADDR);
...
sys_env_destroy(envid_t envid)
{
  ...
  800bc1:	e8 dc 05 00 00       	call   8011a2 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c42:	e8 5b 05 00 00       	call   8011a2 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c84:	e8 19 05 00 00       	call   8011a2 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cc6:	e8 d7 04 00 00       	call   8011a2 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d08:	e8 95 04 00 00       	call   8011a2 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4a:	e8 53 04 00 00       	call   8011a2 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dae:	e8 ef 03 00 00       	call   8011a2 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800dc7:	8b 40 04             	mov    0x4(%eax),%eax
	   // Hint:
  ...
  800dcf:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	   ...
	   if (!(err & 2)) {
  800dd6:	a8 02                	test   $0x2,%al
  800dd8:	75 15                	jne    800def <pgfault+0x34>
			 panic("pgfault was not a write. err: %x", err);
  800dda:	50                   	push   %eax
  800ddb:	68 30 18 80 00       	push   $0x801830
  800de0:	68 bc 00 00 00       	push   $0xbc
  800de5:	68 51 18 80 00       	push   $0x801851
  800dea:	e8 b3 03 00 00       	call   8011a2 <_panic>
	   } else if (!(pte & PTE_COW)) {
  800def:	f6 c6 08             	test   $0x8,%dh
  800df2:	75 17                	jne    800e0b <pgfault+0x50>
			 panic("pgfault is not copy on write");
  800df4:	83 ec 04             	sub    $0x4,%esp
  800df7:	68 5c 18 80 00       	push   $0x80185c
  800dfc:	68 be 00 00 00       	push   $0xbe
  800e01:	68 51 18 80 00       	push   $0x801851
  800e06:	e8 97 03 00 00       	call   8011a2 <_panic>
  ...
  800e17:	e8 f0 fd ff ff       	call   800c0c <sys_page_alloc>
  800e1c:	83 c4 10             	add    $0x10,%esp
  800e1f:	85 c0                	test   %eax,%eax
  800e21:	79 15                	jns    800e38 <pgfault+0x7d>
			 panic("sys_page_alloc: %e", r);
  800e23:	50                   	push   %eax
  800e24:	68 79 18 80 00       	push   $0x801879
  800e29:	68 c9 00 00 00       	push   $0xc9
  800e2e:	68 51 18 80 00       	push   $0x801851
  800e33:	e8 6a 03 00 00       	call   8011a2 <_panic>
	   }
	   memmove(UTEMP, ROUNDDOWN(addr, PGSIZE), PGSIZE);
  800e38:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  800e3e:	83 ec 04             	sub    $0x4,%esp
  800e41:	68 00 10 00 00       	push   $0x1000
  800e46:	53                   	push   %ebx
  800e47:	68 00 00 40 00       	push   $0x400000
  800e4c:	e8 4a fb ff ff       	call   80099b <memmove>
	   if ((r = sys_page_map(0,
  800e51:	c7 04 24 07 00 00 00 	movl   $0x7,(%esp)
  800e58:	53                   	push   %ebx
  800e59:	6a 00                	push   $0x0
  800e5b:	68 00 00 40 00       	push   $0x400000
  800e60:	6a 00                	push   $0x0
  800e62:	e8 e8 fd ff ff       	call   800c4f <sys_page_map>
  800e67:	83 c4 20             	add    $0x20,%esp
  800e6a:	85 c0                	test   %eax,%eax
  800e6c:	79 15                	jns    800e83 <pgfault+0xc8>
								UTEMP,
								0,
  ...
  800e6e:	50                   	push   %eax
  800e6f:	68 8c 18 80 00       	push   $0x80188c
  800e74:	68 d1 00 00 00       	push   $0xd1
  800e79:	68 51 18 80 00       	push   $0x801851
  800e7e:	e8 1f 03 00 00       	call   8011a2 <_panic>
	   }
	   if ((r = sys_page_unmap(0, UTEMP)) < 0) {
  800e83:	83 ec 08             	sub    $0x8,%esp
  800e86:	68 00 00 40 00       	push   $0x400000
  800e8b:	6a 00                	push   $0x0
  800e8d:	e8 ff fd ff ff       	call   800c91 <sys_page_unmap>
  800e92:	83 c4 10             	add    $0x10,%esp
  800e95:	85 c0                	test   %eax,%eax
  800e97:	79 15                	jns    800eae <pgfault+0xf3>
			 panic("unmap %e", r);
  800e99:	50                   	push   %eax
  800e9a:	68 9c 18 80 00       	push   $0x80189c
  800e9f:	68 d4 00 00 00       	push   $0xd4
  800ea4:	68 51 18 80 00       	push   $0x801851
  800ea9:	e8 f4 02 00 00       	call   8011a2 <_panic>
	   }
}
...
fork(void)
{
  ...
  800ebc:	68 bb 0d 80 00       	push   $0x800dbb
  800ec1:	e8 22 03 00 00       	call   8011e8 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800ecd:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  ...
  800ed8:	79 15                	jns    800eef <fork+0x3c>
			 panic("sys_exofork: %e", envid);
  800eda:	50                   	push   %eax
  800edb:	68 a5 18 80 00       	push   $0x8018a5
  800ee0:	68 25 01 00 00       	push   $0x125
  800ee5:	68 51 18 80 00       	push   $0x801851
  800eea:	e8 b3 02 00 00       	call   8011a2 <_panic>
  800eef:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  800ef6:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	   } else if (envid == 0) {  // child
  800efa:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  800efe:	75 1c                	jne    800f1c <fork+0x69>
			 thisenv = &envs[ENVX(sys_getenvid())];
  800f00:	e8 c9 fc ff ff       	call   800bce <sys_getenvid>
  800f05:	25 ff 03 00 00       	and    $0x3ff,%eax
  800f0a:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f0d:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800f12:	a3 0c 20 80 00       	mov    %eax,0x80200c
			 return envid;
  800f17:	e9 75 01 00 00       	jmp    801091 <fork+0x1de>
	   //		thisenv->env_id,
	   //		envid);
	   ...
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
  800f1c:	8b 7d e0             	mov    -0x20(%ebp),%edi
  800f1f:	8b 04 bd 00 d0 7b ef 	mov    -0x10843000(,%edi,4),%eax
  800f26:	a8 01                	test   $0x1,%al
  800f28:	0f 84 1c 01 00 00    	je     80104a <fork+0x197>
  800f2e:	89 fb                	mov    %edi,%ebx
  800f30:	c1 e3 0a             	shl    $0xa,%ebx
  800f33:	c1 e7 16             	shl    $0x16,%edi
  800f36:	be 00 00 00 00       	mov    $0x0,%esi
  800f3b:	e9 f8 00 00 00       	jmp    801038 <fork+0x185>
				    continue;
			 }
  ...
  800f46:	0f 84 e0 00 00 00    	je     80102c <fork+0x179>
						  continue;
				    } else if (pn >= (UTOP >> PGSHIFT)) {
  800f4c:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800f52:	0f 87 d0 00 00 00    	ja     801028 <fork+0x175>
						  is_below_ulim = false;
				    } else if (uvpt[pn] & PTE_P) {
  800f58:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800f5f:	a8 01                	test   $0x1,%al
  800f61:	0f 84 c5 00 00 00    	je     80102c <fork+0x179>
	   static int
duppage(envid_t envid, unsigned pn)
{
	   ...
	   int r;
	   pte_t pte = uvpt[pn];
  800f67:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax

	   if (!(pte & PTE_W) && !(pte & PTE_COW)) {
  800f6e:	a9 02 08 00 00       	test   $0x802,%eax
  800f73:	75 3d                	jne    800fb2 <fork+0xff>
			 if ((r = sys_page_map(thisenv->env_id,
  800f75:	8b 15 0c 20 80 00    	mov    0x80200c,%edx
  800f7b:	8b 52 48             	mov    0x48(%edx),%edx
  800f7e:	83 ec 0c             	sub    $0xc,%esp
  800f81:	25 07 0e 00 00       	and    $0xe07,%eax
  800f86:	50                   	push   %eax
  800f87:	57                   	push   %edi
  800f88:	ff 75 dc             	pushl  -0x24(%ebp)
  800f8b:	57                   	push   %edi
  800f8c:	52                   	push   %edx
  800f8d:	e8 bd fc ff ff       	call   800c4f <sys_page_map>
  800f92:	83 c4 20             	add    $0x20,%esp
  800f95:	85 c0                	test   %eax,%eax
  800f97:	0f 89 8f 00 00 00    	jns    80102c <fork+0x179>
									   (void *)(pn * PGSIZE),
									   envid,
									   (void *)(pn * PGSIZE),
									   pte & PTE_SYSCALL)) < 0) {
				    panic("sys_page_map: %e", r);
  800f9d:	50                   	push   %eax
  800f9e:	68 b5 18 80 00       	push   $0x8018b5
  800fa3:	68 f0 00 00 00       	push   $0xf0
  800fa8:	68 51 18 80 00       	push   $0x801851
  800fad:	e8 f0 01 00 00       	call   8011a2 <_panic>
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
  800fb2:	25 05 06 00 00       	and    $0x605,%eax
  800fb7:	80 cc 08             	or     $0x8,%ah
  800fba:	89 c1                	mov    %eax,%ecx
  800fbc:	89 45 d8             	mov    %eax,-0x28(%ebp)
  800fbf:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800fc4:	8b 40 48             	mov    0x48(%eax),%eax
  800fc7:	83 ec 0c             	sub    $0xc,%esp
  800fca:	51                   	push   %ecx
  800fcb:	57                   	push   %edi
  800fcc:	ff 75 dc             	pushl  -0x24(%ebp)
  800fcf:	57                   	push   %edi
  800fd0:	50                   	push   %eax
  800fd1:	e8 79 fc ff ff       	call   800c4f <sys_page_map>
  800fd6:	83 c4 20             	add    $0x20,%esp
  800fd9:	85 c0                	test   %eax,%eax
  800fdb:	79 15                	jns    800ff2 <fork+0x13f>
								(void *)(pn * PGSIZE),
								envid,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800fdd:	50                   	push   %eax
  800fde:	68 b5 18 80 00       	push   $0x8018b5
  800fe3:	68 fe 00 00 00       	push   $0xfe
  800fe8:	68 51 18 80 00       	push   $0x801851
  800fed:	e8 b0 01 00 00       	call   8011a2 <_panic>
	   }
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
								(void *)(pn * PGSIZE),
								thisenv->env_id,
  800ff2:	a1 0c 20 80 00       	mov    0x80200c,%eax
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
	   }
	   ...
	   // remap our page to have copy on write
	   if ((r = sys_page_map(thisenv->env_id,
  800ff7:	8b 50 48             	mov    0x48(%eax),%edx
  800ffa:	8b 40 48             	mov    0x48(%eax),%eax
  800ffd:	83 ec 0c             	sub    $0xc,%esp
  801000:	ff 75 d8             	pushl  -0x28(%ebp)
  801003:	57                   	push   %edi
  801004:	52                   	push   %edx
  801005:	57                   	push   %edi
  801006:	50                   	push   %eax
  801007:	e8 43 fc ff ff       	call   800c4f <sys_page_map>
  80100c:	83 c4 20             	add    $0x20,%esp
  80100f:	85 c0                	test   %eax,%eax
  801011:	79 19                	jns    80102c <fork+0x179>
								(void *)(pn * PGSIZE),
								thisenv->env_id,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  801013:	50                   	push   %eax
  801014:	68 b5 18 80 00       	push   $0x8018b5
  801019:	68 07 01 00 00       	push   $0x107
  80101e:	68 51 18 80 00       	push   $0x801851
  801023:	e8 7a 01 00 00       	call   8011a2 <_panic>
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
						  continue;
						  ...
						  is_below_ulim = false;
  801028:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
				    continue;
			 ...
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
  80102c:	83 c6 01             	add    $0x1,%esi
  80102f:	83 c3 01             	add    $0x1,%ebx
  801032:	81 c7 00 10 00 00    	add    $0x1000,%edi
  801038:	81 fe ff 03 00 00    	cmp    $0x3ff,%esi
  80103e:	7f 0a                	jg     80104a <fork+0x197>
  801040:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  801044:	0f 85 f6 fe ff ff    	jne    800f40 <fork+0x8d>
	   ...
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
  80104a:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
  80104e:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801051:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801056:	7f 0a                	jg     801062 <fork+0x1af>
  801058:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  80105c:	0f 85 ba fe ff ff    	jne    800f1c <fork+0x69>
	   }
	   //	cprintf("\n");
  ...
  801065:	68 41 12 80 00       	push   $0x801241
  80106a:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  80106d:	56                   	push   %esi
  80106e:	e8 a2 fc ff ff       	call   800d15 <sys_env_set_pgfault_upcall>
	   // allocate the user exception stack (not COW)
	   sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_W | PTE_U);
  801073:	83 c4 0c             	add    $0xc,%esp
  801076:	6a 06                	push   $0x6
  801078:	68 00 f0 bf ee       	push   $0xeebff000
  80107d:	56                   	push   %esi
  80107e:	e8 89 fb ff ff       	call   800c0c <sys_page_alloc>
	   // let the child start
	   sys_env_set_status(envid, ENV_RUNNABLE);
  801083:	83 c4 08             	add    $0x8,%esp
  801086:	6a 02                	push   $0x2
  801088:	56                   	push   %esi
  801089:	e8 45 fc ff ff       	call   800cd3 <sys_env_set_status>
...
sfork(void)
{
  ...
  8010a2:	68 c6 18 80 00       	push   $0x8018c6
  8010a7:	68 52 01 00 00       	push   $0x152
  8010ac:	68 51 18 80 00       	push   $0x801851
  8010b1:	e8 ec 00 00 00       	call   8011a2 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8010c4:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  8010c6:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  8010cb:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  8010ce:	83 ec 0c             	sub    $0xc,%esp
  8010d1:	50                   	push   %eax
  8010d2:	e8 a3 fc ff ff       	call   800d7a <sys_ipc_recv>
  ...
  8010dc:	78 0e                	js     8010ec <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  8010de:	8b 15 0c 20 80 00    	mov    0x80200c,%edx
  8010e4:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  8010e7:	8b 52 78             	mov    0x78(%edx),%edx
  8010ea:	eb 0a                	jmp    8010f6 <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
  ...
  8010f8:	74 02                	je     8010fc <ipc_recv+0x46>
			 *from_env_store = s_envid;
  8010fa:	89 0e                	mov    %ecx,(%esi)

	   if (perm_store)
  8010fc:	85 db                	test   %ebx,%ebx
  8010fe:	74 02                	je     801102 <ipc_recv+0x4c>
			 *perm_store = s_perm;
  801100:	89 13                	mov    %edx,(%ebx)

	   return (a >=0) ? thisenv -> env_ipc_value : a;
  801102:	85 c0                	test   %eax,%eax
  801104:	78 08                	js     80110e <ipc_recv+0x58>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80111e:	8b 7d 08             	mov    0x8(%ebp),%edi
  801121:	8b 75 0c             	mov    0xc(%ebp),%esi
  801124:	8b 5d 10             	mov    0x10(%ebp),%ebx
	   // LAB 4: Your code here.
	   if (!pg) {
  801127:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  801129:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  80112e:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
  801131:	ff 75 14             	pushl  0x14(%ebp)
  801134:	53                   	push   %ebx
  801135:	56                   	push   %esi
  801136:	57                   	push   %edi
  801137:	e8 1b fc ff ff       	call   800d57 <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  80113c:	83 c4 10             	add    $0x10,%esp
  80113f:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801142:	75 07                	jne    80114b <ipc_send+0x36>
				    sys_yield();
  801144:	e8 a4 fa ff ff       	call   800bed <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  801149:	eb e6                	jmp    801131 <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  80114d:	74 12                	je     801161 <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  80114f:	50                   	push   %eax
  801150:	68 dc 18 80 00       	push   $0x8018dc
  801155:	6a 4b                	push   $0x4b
  801157:	68 f0 18 80 00       	push   $0x8018f0
  80115c:	e8 41 00 00 00       	call   8011a2 <_panic>
			 }
	   }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801174:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801177:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  80117d:	8b 52 50             	mov    0x50(%edx),%edx
  801180:	39 ca                	cmp    %ecx,%edx
  801182:	75 0d                	jne    801191 <ipc_find_env+0x28>
				    return envs[i].env_id;
  801184:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801187:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80118c:	8b 40 48             	mov    0x48(%eax),%eax
  80118f:	eb 0f                	jmp    8011a0 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801199:	75 d9                	jne    801174 <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011a6:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  8011a7:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8011aa:	8b 35 08 20 80 00    	mov    0x802008,%esi
  8011b0:	e8 19 fa ff ff       	call   800bce <sys_getenvid>
  8011b5:	83 ec 0c             	sub    $0xc,%esp
  8011b8:	ff 75 0c             	pushl  0xc(%ebp)
  8011bb:	ff 75 08             	pushl  0x8(%ebp)
  8011be:	56                   	push   %esi
  8011bf:	50                   	push   %eax
  8011c0:	68 fc 18 80 00       	push   $0x8018fc
  ...
  8011d1:	e8 5d f0 ff ff       	call   800233 <vcprintf>
	cprintf("\n");
  8011d6:	c7 04 24 12 15 80 00 	movl   $0x801512,(%esp)
  8011dd:	e8 a2 f0 ff ff       	call   800284 <cprintf>
  8011e2:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8011e5:	cc                   	int3   
  8011e6:	eb fd                	jmp    8011e5 <_panic+0x43>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8011ee:	83 3d 10 20 80 00 00 	cmpl   $0x0,0x802010
  8011f5:	75 2a                	jne    801221 <set_pgfault_handler+0x39>
			 // First time through!
			 // LAB 4: Your code here.
			 int a = sys_page_alloc (0, (void *) (UXSTACKTOP -PGSIZE), PTE_U | PTE_W);
  8011f7:	83 ec 04             	sub    $0x4,%esp
  8011fa:	6a 06                	push   $0x6
  8011fc:	68 00 f0 bf ee       	push   $0xeebff000
  801201:	6a 00                	push   $0x0
  801203:	e8 04 fa ff ff       	call   800c0c <sys_page_alloc>
			 if (a < 0)
  801208:	83 c4 10             	add    $0x10,%esp
  80120b:	85 c0                	test   %eax,%eax
  80120d:	79 12                	jns    801221 <set_pgfault_handler+0x39>
				    panic ("sys_page_alloc Failed. %e", a);
  80120f:	50                   	push   %eax
  801210:	68 20 19 80 00       	push   $0x801920
  801215:	6a 21                	push   $0x21
  801217:	68 3a 19 80 00       	push   $0x80193a
  80121c:	e8 81 ff ff ff       	call   8011a2 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  801221:	e8 a8 f9 ff ff       	call   800bce <sys_getenvid>
  801226:	83 ec 08             	sub    $0x8,%esp
  801229:	68 41 12 80 00       	push   $0x801241
  80122e:	50                   	push   %eax
  80122f:	e8 e1 fa ff ff       	call   800d15 <sys_env_set_pgfault_upcall>
...
// LAB 4: Your code here.
  ...
  801250:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  801254:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  801257:	89 5c 24 30          	mov    %ebx,0x30(%esp)

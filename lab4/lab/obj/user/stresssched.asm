...
umain(int argc, char **argv)
{
  ...
  80003f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800044:	e8 04 0e 00 00       	call   800e4d <fork>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d69:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	   ...
	   if (!(err & 2)) {
  800d70:	a8 02                	test   $0x2,%al
  800d72:	75 15                	jne    800d89 <pgfault+0x34>
			 panic("pgfault was not a write. err: %x", err);
  800d74:	50                   	push   %eax
  800d75:	68 50 16 80 00       	push   $0x801650
  800d7a:	68 bc 00 00 00       	push   $0xbc
  800d7f:	68 74 16 80 00       	push   $0x801674
  800d84:	e8 bc f3 ff ff       	call   800145 <_panic>
	   } else if (!(pte & PTE_COW)) {
  800d89:	f6 c6 08             	test   $0x8,%dh
  800d8c:	75 17                	jne    800da5 <pgfault+0x50>
			 panic("pgfault is not copy on write");
  800d8e:	83 ec 04             	sub    $0x4,%esp
  800d91:	68 7f 16 80 00       	push   $0x80167f
  800d96:	68 be 00 00 00       	push   $0xbe
  800d9b:	68 74 16 80 00       	push   $0x801674
  ...
  800daa:	68 00 00 40 00       	push   $0x400000
  800daf:	6a 00                	push   $0x0
  800db1:	e8 f0 fd ff ff       	call   800ba6 <sys_page_alloc>
  800db6:	83 c4 10             	add    $0x10,%esp
  800db9:	85 c0                	test   %eax,%eax
  800dbb:	79 15                	jns    800dd2 <pgfault+0x7d>
			 panic("sys_page_alloc: %e", r);
  800dbd:	50                   	push   %eax
  800dbe:	68 9c 16 80 00       	push   $0x80169c
  800dc3:	68 c9 00 00 00       	push   $0xc9
  800dc8:	68 74 16 80 00       	push   $0x801674
  800dcd:	e8 73 f3 ff ff       	call   800145 <_panic>
	   }
  ...
  800de6:	e8 4a fb ff ff       	call   800935 <memmove>
	   if ((r = sys_page_map(0,
  800deb:	c7 04 24 07 00 00 00 	movl   $0x7,(%esp)
  800df2:	53                   	push   %ebx
  800df3:	6a 00                	push   $0x0
  800df5:	68 00 00 40 00       	push   $0x400000
  800dfa:	6a 00                	push   $0x0
  800dfc:	e8 e8 fd ff ff       	call   800be9 <sys_page_map>
  800e01:	83 c4 20             	add    $0x20,%esp
  800e04:	85 c0                	test   %eax,%eax
  800e06:	79 15                	jns    800e1d <pgfault+0xc8>
								UTEMP,
								0,
  ...
  800e08:	50                   	push   %eax
  800e09:	68 af 16 80 00       	push   $0x8016af
  800e0e:	68 d1 00 00 00       	push   $0xd1
  800e13:	68 74 16 80 00       	push   $0x801674
  800e18:	e8 28 f3 ff ff       	call   800145 <_panic>
	   }
	   if ((r = sys_page_unmap(0, UTEMP)) < 0) {
  800e1d:	83 ec 08             	sub    $0x8,%esp
  800e20:	68 00 00 40 00       	push   $0x400000
  800e25:	6a 00                	push   $0x0
  800e27:	e8 ff fd ff ff       	call   800c2b <sys_page_unmap>
  800e2c:	83 c4 10             	add    $0x10,%esp
  800e2f:	85 c0                	test   %eax,%eax
  800e31:	79 15                	jns    800e48 <pgfault+0xf3>
			 panic("unmap %e", r);
  800e33:	50                   	push   %eax
  800e34:	68 bf 16 80 00       	push   $0x8016bf
  800e39:	68 d4 00 00 00       	push   $0xd4
  800e3e:	68 74 16 80 00       	push   $0x801674
...
fork(void)
{
  ...
  800e56:	68 55 0d 80 00       	push   $0x800d55
  800e5b:	e8 f0 01 00 00       	call   801050 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800e72:	79 15                	jns    800e89 <fork+0x3c>
			 panic("sys_exofork: %e", envid);
  800e74:	50                   	push   %eax
  800e75:	68 c8 16 80 00       	push   $0x8016c8
  800e7a:	68 25 01 00 00       	push   $0x125
  800e7f:	68 74 16 80 00       	push   $0x801674
  800e84:	e8 bc f2 ff ff       	call   800145 <_panic>
  800e89:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  800e90:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	   } else if (envid == 0) {  // child
  800e94:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  800e98:	75 1c                	jne    800eb6 <fork+0x69>
			 thisenv = &envs[ENVX(sys_getenvid())];
  800e9a:	e8 c9 fc ff ff       	call   800b68 <sys_getenvid>
  ...
  800eac:	a3 08 20 80 00       	mov    %eax,0x802008
			 return envid;
  800eb1:	e9 75 01 00 00       	jmp    80102b <fork+0x1de>
	   //		thisenv->env_id,
	   //		envid);
	   ...
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
  800eb6:	8b 7d e0             	mov    -0x20(%ebp),%edi
  800eb9:	8b 04 bd 00 d0 7b ef 	mov    -0x10843000(,%edi,4),%eax
  800ec0:	a8 01                	test   $0x1,%al
  800ec2:	0f 84 1c 01 00 00    	je     800fe4 <fork+0x197>
  800ec8:	89 fb                	mov    %edi,%ebx
  800eca:	c1 e3 0a             	shl    $0xa,%ebx
  800ecd:	c1 e7 16             	shl    $0x16,%edi
  800ed0:	be 00 00 00 00       	mov    $0x0,%esi
  800ed5:	e9 f8 00 00 00       	jmp    800fd2 <fork+0x185>
				    continue;
			 }
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
  800eda:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800ee0:	0f 84 e0 00 00 00    	je     800fc6 <fork+0x179>
						  continue;
				    } else if (pn >= (UTOP >> PGSHIFT)) {
  800ee6:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800eec:	0f 87 d0 00 00 00    	ja     800fc2 <fork+0x175>
						  is_below_ulim = false;
				    } else if (uvpt[pn] & PTE_P) {
  800ef2:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800ef9:	a8 01                	test   $0x1,%al
  800efb:	0f 84 c5 00 00 00    	je     800fc6 <fork+0x179>
	   static int
duppage(envid_t envid, unsigned pn)
{
	   ...
	   int r;
	   pte_t pte = uvpt[pn];
  800f01:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax

	   if (!(pte & PTE_W) && !(pte & PTE_COW)) {
  800f08:	a9 02 08 00 00       	test   $0x802,%eax
  800f0d:	75 3d                	jne    800f4c <fork+0xff>
			 if ((r = sys_page_map(thisenv->env_id,
  800f0f:	8b 15 08 20 80 00    	mov    0x802008,%edx
  800f15:	8b 52 48             	mov    0x48(%edx),%edx
  800f18:	83 ec 0c             	sub    $0xc,%esp
  800f1b:	25 07 0e 00 00       	and    $0xe07,%eax
  800f20:	50                   	push   %eax
  800f21:	57                   	push   %edi
  800f22:	ff 75 dc             	pushl  -0x24(%ebp)
  800f25:	57                   	push   %edi
  800f26:	52                   	push   %edx
  800f27:	e8 bd fc ff ff       	call   800be9 <sys_page_map>
  800f2c:	83 c4 20             	add    $0x20,%esp
  800f2f:	85 c0                	test   %eax,%eax
  800f31:	0f 89 8f 00 00 00    	jns    800fc6 <fork+0x179>
									   (void *)(pn * PGSIZE),
									   envid,
									   (void *)(pn * PGSIZE),
									   pte & PTE_SYSCALL)) < 0) {
				    panic("sys_page_map: %e", r);
  800f37:	50                   	push   %eax
  800f38:	68 d8 16 80 00       	push   $0x8016d8
  800f3d:	68 f0 00 00 00       	push   $0xf0
  800f42:	68 74 16 80 00       	push   $0x801674
  800f47:	e8 f9 f1 ff ff       	call   800145 <_panic>
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
  800f4c:	25 05 06 00 00       	and    $0x605,%eax
  800f51:	80 cc 08             	or     $0x8,%ah
  800f54:	89 c1                	mov    %eax,%ecx
  800f56:	89 45 d8             	mov    %eax,-0x28(%ebp)
  800f59:	a1 08 20 80 00       	mov    0x802008,%eax
  800f5e:	8b 40 48             	mov    0x48(%eax),%eax
  800f61:	83 ec 0c             	sub    $0xc,%esp
  800f64:	51                   	push   %ecx
  800f65:	57                   	push   %edi
  800f66:	ff 75 dc             	pushl  -0x24(%ebp)
  800f69:	57                   	push   %edi
  800f6a:	50                   	push   %eax
  800f6b:	e8 79 fc ff ff       	call   800be9 <sys_page_map>
  800f70:	83 c4 20             	add    $0x20,%esp
  800f73:	85 c0                	test   %eax,%eax
  800f75:	79 15                	jns    800f8c <fork+0x13f>
								(void *)(pn * PGSIZE),
								envid,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800f77:	50                   	push   %eax
  800f78:	68 d8 16 80 00       	push   $0x8016d8
  800f7d:	68 fe 00 00 00       	push   $0xfe
  800f82:	68 74 16 80 00       	push   $0x801674
  800f87:	e8 b9 f1 ff ff       	call   800145 <_panic>
	   }
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
								(void *)(pn * PGSIZE),
								thisenv->env_id,
  800f8c:	a1 08 20 80 00       	mov    0x802008,%eax
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
	   }
	   ...
	   // remap our page to have copy on write
	   if ((r = sys_page_map(thisenv->env_id,
  800f91:	8b 50 48             	mov    0x48(%eax),%edx
  800f94:	8b 40 48             	mov    0x48(%eax),%eax
  800f97:	83 ec 0c             	sub    $0xc,%esp
  800f9a:	ff 75 d8             	pushl  -0x28(%ebp)
  800f9d:	57                   	push   %edi
  800f9e:	52                   	push   %edx
  800f9f:	57                   	push   %edi
  800fa0:	50                   	push   %eax
  800fa1:	e8 43 fc ff ff       	call   800be9 <sys_page_map>
  800fa6:	83 c4 20             	add    $0x20,%esp
  800fa9:	85 c0                	test   %eax,%eax
  800fab:	79 19                	jns    800fc6 <fork+0x179>
								(void *)(pn * PGSIZE),
								thisenv->env_id,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800fad:	50                   	push   %eax
  800fae:	68 d8 16 80 00       	push   $0x8016d8
  800fb3:	68 07 01 00 00       	push   $0x107
  800fb8:	68 74 16 80 00       	push   $0x801674
  800fbd:	e8 83 f1 ff ff       	call   800145 <_panic>
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
						  continue;
						  ...
						  is_below_ulim = false;
  800fc2:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
				    continue;
			 ...
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
  800fc6:	83 c6 01             	add    $0x1,%esi
  800fc9:	83 c3 01             	add    $0x1,%ebx
  800fcc:	81 c7 00 10 00 00    	add    $0x1000,%edi
  800fd2:	81 fe ff 03 00 00    	cmp    $0x3ff,%esi
  800fd8:	7f 0a                	jg     800fe4 <fork+0x197>
  800fda:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800fde:	0f 85 f6 fe ff ff    	jne    800eda <fork+0x8d>
	   ...
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
  800fe4:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
  800fe8:	8b 45 e0             	mov    -0x20(%ebp),%eax
  800feb:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  800ff0:	7f 0a                	jg     800ffc <fork+0x1af>
  800ff2:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800ff6:	0f 85 ba fe ff ff    	jne    800eb6 <fork+0x69>
	   }
	   //	cprintf("\n");
  ...
  800fff:	68 a9 10 80 00       	push   $0x8010a9
  801004:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  801007:	56                   	push   %esi
  801008:	e8 a2 fc ff ff       	call   800caf <sys_env_set_pgfault_upcall>
  ...
  801010:	6a 06                	push   $0x6
  801012:	68 00 f0 bf ee       	push   $0xeebff000
  801017:	56                   	push   %esi
  801018:	e8 89 fb ff ff       	call   800ba6 <sys_page_alloc>
	   // let the child start
	   sys_env_set_status(envid, ENV_RUNNABLE);
  80101d:	83 c4 08             	add    $0x8,%esp
  801020:	6a 02                	push   $0x2
  801022:	56                   	push   %esi
  801023:	e8 45 fc ff ff       	call   800c6d <sys_env_set_status>

	   return envid;
  801028:	83 c4 10             	add    $0x10,%esp
}
  80102b:	8b 45 d4             	mov    -0x2c(%ebp),%eax
...
sfork(void)
{
  ...
  80103c:	68 e9 16 80 00       	push   $0x8016e9
  801041:	68 52 01 00 00       	push   $0x152
  801046:	68 74 16 80 00       	push   $0x801674
  80104b:	e8 f5 f0 ff ff       	call   800145 <_panic>

00801050 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801056:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  80105d:	75 2a                	jne    801089 <set_pgfault_handler+0x39>
			 // First time through!
			 // LAB 4: Your code here.
  ...
  80106b:	e8 36 fb ff ff       	call   800ba6 <sys_page_alloc>
			 if (a < 0)
  801070:	83 c4 10             	add    $0x10,%esp
  801073:	85 c0                	test   %eax,%eax
  801075:	79 12                	jns    801089 <set_pgfault_handler+0x39>
				    panic ("sys_page_alloc Failed. %e", a);
  801077:	50                   	push   %eax
  801078:	68 ff 16 80 00       	push   $0x8016ff
  80107d:	6a 21                	push   $0x21
  80107f:	68 19 17 80 00       	push   $0x801719
  801084:	e8 bc f0 ff ff       	call   800145 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  801089:	e8 da fa ff ff       	call   800b68 <sys_getenvid>
  80108e:	83 ec 08             	sub    $0x8,%esp
  801091:	68 a9 10 80 00       	push   $0x8010a9
  801096:	50                   	push   %eax
  801097:	e8 13 fc ff ff       	call   800caf <sys_env_set_pgfault_upcall>

	   // Save handler pointer for assembly to call.
	   _pgfault_handler = handler;
  80109c:	8b 45 08             	mov    0x8(%ebp),%eax
  80109f:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
  8010a4:	83 c4 10             	add    $0x10,%esp
  8010a7:	c9                   	leave  
  8010a8:	c3                   	ret    

008010a9 <_pgfault_upcall>:
...
movl _pgfault_handler, %eax
  8010aa:	a1 0c 20 80 00       	mov    0x80200c,%eax
call *%eax
...
// LAB 4: Your code here.
  ...
  8010b4:	8b 44 24 28          	mov    0x28(%esp),%eax
   movl 48(%esp), %ebx	// grab trap-time esp
  8010b8:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  8010bc:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  8010bf:	89 5c 24 30          	mov    %ebx,0x30(%esp)

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025e:	e8 5d 0b 00 00       	call   800dc0 <__udivdi3>
  ...
  8002a1:	e8 4a 0c 00 00       	call   800ef0 <__umoddi3>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d3f:	75 2a                	jne    800d6b <set_pgfault_handler+0x39>
			 // First time through!
  ...
  800d61:	68 89 13 80 00       	push   $0x801389
  800d66:	e8 b7 f3 ff ff       	call   800122 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  800d6b:	e8 d5 fd ff ff       	call   800b45 <sys_getenvid>
  800d70:	83 ec 08             	sub    $0x8,%esp
  800d73:	68 8b 0d 80 00       	push   $0x800d8b
  800d78:	50                   	push   %eax
  800d79:	e8 0e ff ff ff       	call   800c8c <sys_env_set_pgfault_upcall>
...
movl _pgfault_handler, %eax
  800d8c:	a1 08 20 80 00       	mov    0x802008,%eax
call *%eax
...
// LAB 4: Your code here.
  ...
  800d96:	8b 44 24 28          	mov    0x28(%esp),%eax
   movl 48(%esp), %ebx	// grab trap-time esp
  800d9a:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  800d9e:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  800da1:	89 5c 24 30          	mov    %ebx,0x30(%esp)

...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	i = 0;
	if ((who = sfork()) != 0) {
  80003c:	e8 c0 0f 00 00       	call   801001 <sfork>
  ...
  800082:	e8 f3 0f 00 00       	call   80107a <ipc_send>
  ...
  800094:	50                   	push   %eax
  800095:	e8 81 0f 00 00       	call   80101b <ipc_recv>
  ...
  8000e5:	e8 90 0f 00 00       	call   80107a <ipc_send>
		if (val == 10)
...
sys_env_destroy(envid_t envid)
{
  ...
  800b26:	e8 dc 05 00 00       	call   801107 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ba7:	e8 5b 05 00 00       	call   801107 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800be9:	e8 19 05 00 00       	call   801107 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c2b:	e8 d7 04 00 00       	call   801107 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c6d:	e8 95 04 00 00       	call   801107 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800caf:	e8 53 04 00 00       	call   801107 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d13:	e8 ef 03 00 00       	call   801107 <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d2c:	8b 40 04             	mov    0x4(%eax),%eax
	   // Hint:
  ...
  800d2f:	89 da                	mov    %ebx,%edx
  800d31:	c1 ea 0c             	shr    $0xc,%edx
  800d34:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx

	   if (!(err & 2)) {
  800d3b:	a8 02                	test   $0x2,%al
  800d3d:	75 15                	jne    800d54 <pgfault+0x34>
			 panic("pgfault was not a write. err: %x", err);
  800d3f:	50                   	push   %eax
  800d40:	68 30 17 80 00       	push   $0x801730
  800d45:	68 bc 00 00 00       	push   $0xbc
  800d4a:	68 51 17 80 00       	push   $0x801751
  800d4f:	e8 b3 03 00 00       	call   801107 <_panic>
	   } else if (!(pte & PTE_COW)) {
  800d54:	f6 c6 08             	test   $0x8,%dh
  800d57:	75 17                	jne    800d70 <pgfault+0x50>
			 panic("pgfault is not copy on write");
  800d59:	83 ec 04             	sub    $0x4,%esp
  800d5c:	68 5c 17 80 00       	push   $0x80175c
  800d61:	68 be 00 00 00       	push   $0xbe
  800d66:	68 51 17 80 00       	push   $0x801751
  800d6b:	e8 97 03 00 00       	call   801107 <_panic>
  ...
  800d75:	68 00 00 40 00       	push   $0x400000
  800d7a:	6a 00                	push   $0x0
  800d7c:	e8 f0 fd ff ff       	call   800b71 <sys_page_alloc>
  800d81:	83 c4 10             	add    $0x10,%esp
  800d84:	85 c0                	test   %eax,%eax
  800d86:	79 15                	jns    800d9d <pgfault+0x7d>
			 panic("sys_page_alloc: %e", r);
  800d88:	50                   	push   %eax
  800d89:	68 79 17 80 00       	push   $0x801779
  800d8e:	68 c9 00 00 00       	push   $0xc9
  800d93:	68 51 17 80 00       	push   $0x801751
  800d98:	e8 6a 03 00 00       	call   801107 <_panic>
	   }
  ...
  800dab:	53                   	push   %ebx
  800dac:	68 00 00 40 00       	push   $0x400000
  800db1:	e8 4a fb ff ff       	call   800900 <memmove>
	   if ((r = sys_page_map(0,
  800db6:	c7 04 24 07 00 00 00 	movl   $0x7,(%esp)
  800dbd:	53                   	push   %ebx
  800dbe:	6a 00                	push   $0x0
  800dc0:	68 00 00 40 00       	push   $0x400000
  800dc5:	6a 00                	push   $0x0
  800dc7:	e8 e8 fd ff ff       	call   800bb4 <sys_page_map>
  800dcc:	83 c4 20             	add    $0x20,%esp
  800dcf:	85 c0                	test   %eax,%eax
  800dd1:	79 15                	jns    800de8 <pgfault+0xc8>
								UTEMP,
								0,
  ...
  800dd3:	50                   	push   %eax
  800dd4:	68 8c 17 80 00       	push   $0x80178c
  800dd9:	68 d1 00 00 00       	push   $0xd1
  800dde:	68 51 17 80 00       	push   $0x801751
  800de3:	e8 1f 03 00 00       	call   801107 <_panic>
	   }
	   if ((r = sys_page_unmap(0, UTEMP)) < 0) {
  800de8:	83 ec 08             	sub    $0x8,%esp
  800deb:	68 00 00 40 00       	push   $0x400000
  800df0:	6a 00                	push   $0x0
  800df2:	e8 ff fd ff ff       	call   800bf6 <sys_page_unmap>
  800df7:	83 c4 10             	add    $0x10,%esp
  800dfa:	85 c0                	test   %eax,%eax
  800dfc:	79 15                	jns    800e13 <pgfault+0xf3>
			 panic("unmap %e", r);
  800dfe:	50                   	push   %eax
  800dff:	68 9c 17 80 00       	push   $0x80179c
  800e04:	68 d4 00 00 00       	push   $0xd4
  800e09:	68 51 17 80 00       	push   $0x801751
...
fork(void)
{
  ...
  800e21:	68 20 0d 80 00       	push   $0x800d20
  800e26:	e8 22 03 00 00       	call   80114d <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800e2b:	b8 07 00 00 00       	mov    $0x7,%eax
  800e30:	cd 30                	int    $0x30
  800e32:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  ...
  800e3d:	79 15                	jns    800e54 <fork+0x3c>
			 panic("sys_exofork: %e", envid);
  800e3f:	50                   	push   %eax
  800e40:	68 a5 17 80 00       	push   $0x8017a5
  800e45:	68 25 01 00 00       	push   $0x125
  800e4a:	68 51 17 80 00       	push   $0x801751
  800e4f:	e8 b3 02 00 00       	call   801107 <_panic>
  800e54:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  800e5b:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	   } else if (envid == 0) {  // child
  800e5f:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  800e63:	75 1c                	jne    800e81 <fork+0x69>
			 thisenv = &envs[ENVX(sys_getenvid())];
  800e65:	e8 c9 fc ff ff       	call   800b33 <sys_getenvid>
  ...
  800e77:	a3 08 20 80 00       	mov    %eax,0x802008
			 return envid;
  800e7c:	e9 75 01 00 00       	jmp    800ff6 <fork+0x1de>
	   //		thisenv->env_id,
	   //		envid);
	   ...
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
  800e81:	8b 7d e0             	mov    -0x20(%ebp),%edi
  800e84:	8b 04 bd 00 d0 7b ef 	mov    -0x10843000(,%edi,4),%eax
  800e8b:	a8 01                	test   $0x1,%al
  800e8d:	0f 84 1c 01 00 00    	je     800faf <fork+0x197>
  800e93:	89 fb                	mov    %edi,%ebx
  800e95:	c1 e3 0a             	shl    $0xa,%ebx
  800e98:	c1 e7 16             	shl    $0x16,%edi
  800e9b:	be 00 00 00 00       	mov    $0x0,%esi
  800ea0:	e9 f8 00 00 00       	jmp    800f9d <fork+0x185>
				    continue;
			 }
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
  800ea5:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800eab:	0f 84 e0 00 00 00    	je     800f91 <fork+0x179>
						  continue;
				    } else if (pn >= (UTOP >> PGSHIFT)) {
  800eb1:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800eb7:	0f 87 d0 00 00 00    	ja     800f8d <fork+0x175>
						  is_below_ulim = false;
				    } else if (uvpt[pn] & PTE_P) {
  800ebd:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800ec4:	a8 01                	test   $0x1,%al
  800ec6:	0f 84 c5 00 00 00    	je     800f91 <fork+0x179>
	   static int
duppage(envid_t envid, unsigned pn)
{
	   ...
	   int r;
	   pte_t pte = uvpt[pn];
  800ecc:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax

	   if (!(pte & PTE_W) && !(pte & PTE_COW)) {
  800ed3:	a9 02 08 00 00       	test   $0x802,%eax
  800ed8:	75 3d                	jne    800f17 <fork+0xff>
			 if ((r = sys_page_map(thisenv->env_id,
  800eda:	8b 15 08 20 80 00    	mov    0x802008,%edx
  ...
  800ef0:	57                   	push   %edi
  800ef1:	52                   	push   %edx
  800ef2:	e8 bd fc ff ff       	call   800bb4 <sys_page_map>
  800ef7:	83 c4 20             	add    $0x20,%esp
  800efa:	85 c0                	test   %eax,%eax
  800efc:	0f 89 8f 00 00 00    	jns    800f91 <fork+0x179>
									   (void *)(pn * PGSIZE),
									   envid,
									   (void *)(pn * PGSIZE),
									   pte & PTE_SYSCALL)) < 0) {
				    panic("sys_page_map: %e", r);
  800f02:	50                   	push   %eax
  800f03:	68 b5 17 80 00       	push   $0x8017b5
  800f08:	68 f0 00 00 00       	push   $0xf0
  800f0d:	68 51 17 80 00       	push   $0x801751
  800f12:	e8 f0 01 00 00       	call   801107 <_panic>
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
  800f17:	25 05 06 00 00       	and    $0x605,%eax
  800f1c:	80 cc 08             	or     $0x8,%ah
  ...
  800f2f:	51                   	push   %ecx
  800f30:	57                   	push   %edi
  800f31:	ff 75 dc             	pushl  -0x24(%ebp)
  800f34:	57                   	push   %edi
  800f35:	50                   	push   %eax
  800f36:	e8 79 fc ff ff       	call   800bb4 <sys_page_map>
  800f3b:	83 c4 20             	add    $0x20,%esp
  800f3e:	85 c0                	test   %eax,%eax
  800f40:	79 15                	jns    800f57 <fork+0x13f>
								(void *)(pn * PGSIZE),
								envid,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800f42:	50                   	push   %eax
  800f43:	68 b5 17 80 00       	push   $0x8017b5
  800f48:	68 fe 00 00 00       	push   $0xfe
  800f4d:	68 51 17 80 00       	push   $0x801751
  800f52:	e8 b0 01 00 00       	call   801107 <_panic>
	   }
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
								(void *)(pn * PGSIZE),
								thisenv->env_id,
  800f57:	a1 08 20 80 00       	mov    0x802008,%eax
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
	   }
	   ...
	   // remap our page to have copy on write
	   if ((r = sys_page_map(thisenv->env_id,
  800f5c:	8b 50 48             	mov    0x48(%eax),%edx
  800f5f:	8b 40 48             	mov    0x48(%eax),%eax
  800f62:	83 ec 0c             	sub    $0xc,%esp
  800f65:	ff 75 d8             	pushl  -0x28(%ebp)
  800f68:	57                   	push   %edi
  800f69:	52                   	push   %edx
  800f6a:	57                   	push   %edi
  800f6b:	50                   	push   %eax
  800f6c:	e8 43 fc ff ff       	call   800bb4 <sys_page_map>
  800f71:	83 c4 20             	add    $0x20,%esp
  800f74:	85 c0                	test   %eax,%eax
  800f76:	79 19                	jns    800f91 <fork+0x179>
								(void *)(pn * PGSIZE),
								thisenv->env_id,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800f78:	50                   	push   %eax
  800f79:	68 b5 17 80 00       	push   $0x8017b5
  800f7e:	68 07 01 00 00       	push   $0x107
  800f83:	68 51 17 80 00       	push   $0x801751
  800f88:	e8 7a 01 00 00       	call   801107 <_panic>
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
						  continue;
						  ...
						  is_below_ulim = false;
  800f8d:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
				    continue;
			 ...
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
  800f91:	83 c6 01             	add    $0x1,%esi
  800f94:	83 c3 01             	add    $0x1,%ebx
  800f97:	81 c7 00 10 00 00    	add    $0x1000,%edi
  800f9d:	81 fe ff 03 00 00    	cmp    $0x3ff,%esi
  800fa3:	7f 0a                	jg     800faf <fork+0x197>
  800fa5:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800fa9:	0f 85 f6 fe ff ff    	jne    800ea5 <fork+0x8d>
	   ...
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
  800faf:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
  800fb3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  800fb6:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  800fbb:	7f 0a                	jg     800fc7 <fork+0x1af>
  800fbd:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800fc1:	0f 85 ba fe ff ff    	jne    800e81 <fork+0x69>
	   }
	   //	cprintf("\n");
  ...
  800fca:	68 a6 11 80 00       	push   $0x8011a6
  800fcf:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  800fd2:	56                   	push   %esi
  800fd3:	e8 a2 fc ff ff       	call   800c7a <sys_env_set_pgfault_upcall>
  ...
  800fe2:	56                   	push   %esi
  800fe3:	e8 89 fb ff ff       	call   800b71 <sys_page_alloc>
	   // let the child start
	   sys_env_set_status(envid, ENV_RUNNABLE);
  800fe8:	83 c4 08             	add    $0x8,%esp
  800feb:	6a 02                	push   $0x2
  800fed:	56                   	push   %esi
  800fee:	e8 45 fc ff ff       	call   800c38 <sys_env_set_status>

	   return envid;
  800ff3:	83 c4 10             	add    $0x10,%esp
}
  800ff6:	8b 45 d4             	mov    -0x2c(%ebp),%eax
...
sfork(void)
{
  ...
  801007:	68 c6 17 80 00       	push   $0x8017c6
  80100c:	68 52 01 00 00       	push   $0x152
  801011:	68 51 17 80 00       	push   $0x801751
  801016:	e8 ec 00 00 00       	call   801107 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801029:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  80102b:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801030:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  801033:	83 ec 0c             	sub    $0xc,%esp
  801036:	50                   	push   %eax
  801037:	e8 a3 fc ff ff       	call   800cdf <sys_ipc_recv>
  ...
  801041:	78 0e                	js     801051 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  801043:	8b 15 08 20 80 00    	mov    0x802008,%edx
  801049:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  80104c:	8b 52 78             	mov    0x78(%edx),%edx
  80104f:	eb 0a                	jmp    80105b <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80108c:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  80108e:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  801093:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
  ...
  80109a:	56                   	push   %esi
  80109b:	57                   	push   %edi
  80109c:	e8 1b fc ff ff       	call   800cbc <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  8010a1:	83 c4 10             	add    $0x10,%esp
  8010a4:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8010a7:	75 07                	jne    8010b0 <ipc_send+0x36>
				    sys_yield();
  8010a9:	e8 a4 fa ff ff       	call   800b52 <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  8010ae:	eb e6                	jmp    801096 <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  8010b2:	74 12                	je     8010c6 <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  8010b4:	50                   	push   %eax
  8010b5:	68 dc 17 80 00       	push   $0x8017dc
  8010ba:	6a 4b                	push   $0x4b
  8010bc:	68 f0 17 80 00       	push   $0x8017f0
  8010c1:	e8 41 00 00 00       	call   801107 <_panic>
			 }
	   }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  8010e7:	75 0d                	jne    8010f6 <ipc_find_env+0x28>
				    return envs[i].env_id;
  8010e9:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8010ec:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  8010f1:	8b 40 48             	mov    0x48(%eax),%eax
  8010f4:	eb 0f                	jmp    801105 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
  ...
  8010fe:	75 d9                	jne    8010d9 <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801136:	e8 5d f0 ff ff       	call   800198 <vcprintf>
	cprintf("\n");
  80113b:	c7 04 24 78 14 80 00 	movl   $0x801478,(%esp)
  801142:	e8 a2 f0 ff ff       	call   8001e9 <cprintf>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80115a:	75 2a                	jne    801186 <set_pgfault_handler+0x39>
			 // First time through!
			 // LAB 4: Your code here.
  ...
  801168:	e8 04 fa ff ff       	call   800b71 <sys_page_alloc>
			 if (a < 0)
  80116d:	83 c4 10             	add    $0x10,%esp
  801170:	85 c0                	test   %eax,%eax
  801172:	79 12                	jns    801186 <set_pgfault_handler+0x39>
				    panic ("sys_page_alloc Failed. %e", a);
  801174:	50                   	push   %eax
  801175:	68 20 18 80 00       	push   $0x801820
  80117a:	6a 21                	push   $0x21
  80117c:	68 3a 18 80 00       	push   $0x80183a
  801181:	e8 81 ff ff ff       	call   801107 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  801186:	e8 a8 f9 ff ff       	call   800b33 <sys_getenvid>
  80118b:	83 ec 08             	sub    $0x8,%esp
  80118e:	68 a6 11 80 00       	push   $0x8011a6
  801193:	50                   	push   %eax
  801194:	e8 e1 fa ff ff       	call   800c7a <sys_env_set_pgfault_upcall>
...
movl _pgfault_handler, %eax
  8011a7:	a1 0c 20 80 00       	mov    0x80200c,%eax
call *%eax
...
// LAB 4: Your code here.
  ...
  8011b1:	8b 44 24 28          	mov    0x28(%esp),%eax
   movl 48(%esp), %ebx	// grab trap-time esp
  8011b5:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  8011b9:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  8011bc:	89 5c 24 30          	mov    %ebx,0x30(%esp)

...
umain(int argc, char **argv)
{
  ...
  800096:	50                   	push   %eax
  800097:	e8 86 0c 00 00       	call   800d22 <ipc_send>
...
sys_env_destroy(envid_t envid)
{
  ...
  800ac9:	e8 e1 02 00 00       	call   800daf <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4a:	e8 60 02 00 00       	call   800daf <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b8c:	e8 1e 02 00 00       	call   800daf <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bce:	e8 dc 01 00 00       	call   800daf <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c10:	e8 9a 01 00 00       	call   800daf <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c52:	e8 58 01 00 00       	call   800daf <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cb6:	e8 f4 00 00 00       	call   800daf <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800cd1:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  800cd3:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  ...
  800ce9:	78 0e                	js     800cf9 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  800ceb:	8b 15 04 20 80 00    	mov    0x802004,%edx
  800cf1:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  800cf4:	8b 52 78             	mov    0x78(%edx),%edx
  800cf7:	eb 0a                	jmp    800d03 <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d34:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  800d36:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  800d3b:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
  ...
  800d42:	56                   	push   %esi
  800d43:	57                   	push   %edi
  800d44:	e8 16 ff ff ff       	call   800c5f <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  800d49:	83 c4 10             	add    $0x10,%esp
  800d4c:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800d4f:	75 07                	jne    800d58 <ipc_send+0x36>
				    sys_yield();
  800d51:	e8 9f fd ff ff       	call   800af5 <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  800d56:	eb e6                	jmp    800d3e <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  800d5a:	74 12                	je     800d6e <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  800d5c:	50                   	push   %eax
  800d5d:	68 4f 13 80 00       	push   $0x80134f
  800d62:	6a 4b                	push   $0x4b
  800d64:	68 63 13 80 00       	push   $0x801363
  800d69:	e8 41 00 00 00       	call   800daf <_panic>
			 }
	   }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  800d81:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800d84:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800d8a:	8b 52 50             	mov    0x50(%edx),%edx
  800d8d:	39 ca                	cmp    %ecx,%edx
  800d8f:	75 0d                	jne    800d9e <ipc_find_env+0x28>
				    return envs[i].env_id;
  800d91:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800d94:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800d99:	8b 40 48             	mov    0x48(%eax),%eax
  800d9c:	eb 0f                	jmp    800dad <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800da6:	75 d9                	jne    800d81 <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800db3:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800db4:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800db7:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800dbd:	e8 14 fd ff ff       	call   800ad6 <sys_getenvid>
  800dc2:	83 ec 0c             	sub    $0xc,%esp
  800dc5:	ff 75 0c             	pushl  0xc(%ebp)
  800dc8:	ff 75 08             	pushl  0x8(%ebp)
  800dcb:	56                   	push   %esi
  800dcc:	50                   	push   %eax
  800dcd:	68 70 13 80 00       	push   $0x801370
  800dd2:	e8 b5 f3 ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800dd7:	83 c4 18             	add    $0x18,%esp
  800dda:	53                   	push   %ebx
  800ddb:	ff 75 10             	pushl  0x10(%ebp)
  800dde:	e8 58 f3 ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  800de3:	c7 04 24 af 10 80 00 	movl   $0x8010af,(%esp)
  800dea:	e8 9d f3 ff ff       	call   80018c <cprintf>
  800def:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800df2:	cc                   	int3   
  800df3:	eb fd                	jmp    800df2 <_panic+0x43>

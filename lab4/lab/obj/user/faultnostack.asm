...
// LAB 4: Your code here.
  ...
  800326:	8b 5c 24 30          	mov    0x30(%esp),%ebx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036c:	e8 54 00 00 00       	call   8003c5 <vcprintf>
	cprintf("\n");
  800371:	c7 04 24 3c 10 80 00 	movl   $0x80103c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800479:	e8 c2 08 00 00       	call   800d40 <__udivdi3>
  ...
  8004bc:	e8 af 09 00 00       	call   800e70 <__umoddi3>
  8004c1:	83 c4 14             	add    $0x14,%esp
  8004c4:	0f be 80 3e 10 80 00 	movsbl 0x80103e(%eax),%eax
  8004cb:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80068f:	50                   	push   %eax
  800690:	68 56 10 80 00       	push   $0x801056
  800695:	53                   	push   %ebx
  800696:	56                   	push   %esi
  ...
  8006a7:	52                   	push   %edx
  8006a8:	68 5f 10 80 00       	push   $0x80105f
  8006ad:	53                   	push   %ebx
  8006ae:	56                   	push   %esi
  ...
  8006cc:	b8 4f 10 80 00       	mov    $0x80104f,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800cef:	75 2a                	jne    800d1b <set_pgfault_handler+0x39>
			 // First time through!
			 // LAB 4: Your code here.
  ...
  800d11:	68 9e 12 80 00       	push   $0x80129e
  800d16:	e8 22 f6 ff ff       	call   80033d <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  800d1b:	e8 0a f4 ff ff       	call   80012a <sys_getenvid>
  800d20:	83 ec 08             	sub    $0x8,%esp
  800d23:	68 17 03 80 00       	push   $0x800317
  800d28:	50                   	push   %eax
  800d29:	e8 43 f5 ff ff       	call   800271 <sys_env_set_pgfault_upcall>

	   // Save handler pointer for assembly to call.
	   _pgfault_handler = handler;
  800d2e:	8b 45 08             	mov    0x8(%ebp),%eax
  800d31:	a3 08 20 80 00       	mov    %eax,0x802008
}

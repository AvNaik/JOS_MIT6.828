	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800294:	0f be 80 dc 10 80 00 	movsbl 0x8010dc(%eax),%eax
  80029b:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80045f:	50                   	push   %eax
  800460:	68 f4 10 80 00       	push   $0x8010f4
  800465:	53                   	push   %ebx
  800466:	56                   	push   %esi
  ...
  800477:	52                   	push   %edx
  800478:	68 fd 10 80 00       	push   $0x8010fd
  80047d:	53                   	push   %ebx
  80047e:	56                   	push   %esi
  ...
  80049c:	b8 ed 10 80 00       	mov    $0x8010ed,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d2a:	75 2a                	jne    800d56 <set_pgfault_handler+0x39>
			 // First time through!
  ...
  800d4c:	68 69 13 80 00       	push   $0x801369
  800d51:	e8 b7 f3 ff ff       	call   80010d <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  800d56:	e8 d5 fd ff ff       	call   800b30 <sys_getenvid>
  800d5b:	83 ec 08             	sub    $0x8,%esp
  800d5e:	68 76 0d 80 00       	push   $0x800d76
  800d63:	50                   	push   %eax
  800d64:	e8 0e ff ff ff       	call   800c77 <sys_env_set_pgfault_upcall>
...
// LAB 4: Your code here.
  ...
  800d85:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  800d89:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  800d8c:	89 5c 24 30          	mov    %ebx,0x30(%esp)

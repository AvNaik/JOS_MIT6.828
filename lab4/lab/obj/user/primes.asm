...
top:
  ...
  800046:	56                   	push   %esi
  800047:	e8 0f 10 00 00       	call   80105b <ipc_recv>
  ...
  800060:	e8 c4 01 00 00       	call   800229 <cprintf>
	...
	if ((id = fork()) < 0)
  800065:	e8 ee 0d 00 00       	call   800e58 <fork>
  ...
  800071:	79 12                	jns    800085 <primeproc+0x52>
		panic("fork: %e", id);
  800073:	50                   	push   %eax
  800074:	68 8f 17 80 00       	push   $0x80178f
  ...
  800093:	56                   	push   %esi
  800094:	e8 c2 0f 00 00       	call   80105b <ipc_recv>
  ...
  8000a9:	51                   	push   %ecx
  8000aa:	57                   	push   %edi
  8000ab:	e8 0a 10 00 00       	call   8010ba <ipc_send>
...
umain(int argc, char **argv)
{
  ...
  8000b9:	53                   	push   %ebx
	...
	if ((id = fork()) < 0)
  8000ba:	e8 99 0d 00 00       	call   800e58 <fork>
  8000bf:	89 c6                	mov    %eax,%esi
  8000c1:	85 c0                	test   %eax,%eax
  8000c3:	79 12                	jns    8000d7 <umain+0x22>
		panic("fork: %e", id);
  8000c5:	50                   	push   %eax
  8000c6:	68 8f 17 80 00       	push   $0x80178f
  ...
  8000e9:	53                   	push   %ebx
  8000ea:	56                   	push   %esi
  8000eb:	e8 ca 0f 00 00       	call   8010ba <ipc_send>
		panic("fork: %e", id);
	if (id == 0)
		primeproc();
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004a2:	50                   	push   %eax
  8004a3:	68 c1 14 80 00       	push   $0x8014c1
  8004a8:	53                   	push   %ebx
  8004a9:	56                   	push   %esi
  ...
  8004ba:	52                   	push   %edx
  8004bb:	68 ca 14 80 00       	push   $0x8014ca
  8004c0:	53                   	push   %ebx
  8004c1:	56                   	push   %esi
  ...
  8004df:	b8 ba 14 80 00       	mov    $0x8014ba,%eax
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d6f:	89 da                	mov    %ebx,%edx
  800d71:	c1 ea 0c             	shr    $0xc,%edx
  800d74:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx

	   if (!(err & 2)) {
  800d7b:	a8 02                	test   $0x2,%al
  800d7d:	75 15                	jne    800d94 <pgfault+0x34>
			 panic("pgfault was not a write. err: %x", err);
  800d7f:	50                   	push   %eax
  800d80:	68 10 17 80 00       	push   $0x801710
  800d85:	68 bc 00 00 00       	push   $0xbc
  800d8a:	68 34 17 80 00       	push   $0x801734
  800d8f:	e8 bc f3 ff ff       	call   800150 <_panic>
	   } else if (!(pte & PTE_COW)) {
  800d94:	f6 c6 08             	test   $0x8,%dh
  800d97:	75 17                	jne    800db0 <pgfault+0x50>
			 panic("pgfault is not copy on write");
  800d99:	83 ec 04             	sub    $0x4,%esp
  800d9c:	68 3f 17 80 00       	push   $0x80173f
  800da1:	68 be 00 00 00       	push   $0xbe
  800da6:	68 34 17 80 00       	push   $0x801734
  ...
  800db5:	68 00 00 40 00       	push   $0x400000
  800dba:	6a 00                	push   $0x0
  800dbc:	e8 f0 fd ff ff       	call   800bb1 <sys_page_alloc>
  800dc1:	83 c4 10             	add    $0x10,%esp
  800dc4:	85 c0                	test   %eax,%eax
  800dc6:	79 15                	jns    800ddd <pgfault+0x7d>
			 panic("sys_page_alloc: %e", r);
  800dc8:	50                   	push   %eax
  800dc9:	68 5c 17 80 00       	push   $0x80175c
  800dce:	68 c9 00 00 00       	push   $0xc9
  800dd3:	68 34 17 80 00       	push   $0x801734
  800dd8:	e8 73 f3 ff ff       	call   800150 <_panic>
	   }
  ...
  800deb:	53                   	push   %ebx
  800dec:	68 00 00 40 00       	push   $0x400000
  800df1:	e8 4a fb ff ff       	call   800940 <memmove>
	   if ((r = sys_page_map(0,
  ...
  800e07:	e8 e8 fd ff ff       	call   800bf4 <sys_page_map>
  800e0c:	83 c4 20             	add    $0x20,%esp
  800e0f:	85 c0                	test   %eax,%eax
  800e11:	79 15                	jns    800e28 <pgfault+0xc8>
								UTEMP,
								0,
  ...
  800e13:	50                   	push   %eax
  800e14:	68 6f 17 80 00       	push   $0x80176f
  800e19:	68 d1 00 00 00       	push   $0xd1
  800e1e:	68 34 17 80 00       	push   $0x801734
  ...
  800e32:	e8 ff fd ff ff       	call   800c36 <sys_page_unmap>
  800e37:	83 c4 10             	add    $0x10,%esp
  800e3a:	85 c0                	test   %eax,%eax
  800e3c:	79 15                	jns    800e53 <pgfault+0xf3>
			 panic("unmap %e", r);
  800e3e:	50                   	push   %eax
  800e3f:	68 7f 17 80 00       	push   $0x80177f
  800e44:	68 d4 00 00 00       	push   $0xd4
  800e49:	68 34 17 80 00       	push   $0x801734
...
fork(void)
{
  ...
  800e61:	68 60 0d 80 00       	push   $0x800d60
  800e66:	e8 dc 02 00 00       	call   801147 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800e72:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  800e75:	89 45 dc             	mov    %eax,-0x24(%ebp)

	   envid_t envid = sys_exofork();
	   if (envid < 0) {
  800e78:	83 c4 10             	add    $0x10,%esp
  800e7b:	85 c0                	test   %eax,%eax
  800e7d:	79 15                	jns    800e94 <fork+0x3c>
			 panic("sys_exofork: %e", envid);
  800e7f:	50                   	push   %eax
  800e80:	68 88 17 80 00       	push   $0x801788
  800e85:	68 25 01 00 00       	push   $0x125
  800e8a:	68 34 17 80 00       	push   $0x801734
  800e8f:	e8 bc f2 ff ff       	call   800150 <_panic>
  800e94:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  800e9b:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	   } else if (envid == 0) {  // child
  800e9f:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  800ea3:	75 1c                	jne    800ec1 <fork+0x69>
			 thisenv = &envs[ENVX(sys_getenvid())];
  800ea5:	e8 c9 fc ff ff       	call   800b73 <sys_getenvid>
  800eaa:	25 ff 03 00 00       	and    $0x3ff,%eax
  800eaf:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800eb2:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800eb7:	a3 04 20 80 00       	mov    %eax,0x802004
			 return envid;
  800ebc:	e9 75 01 00 00       	jmp    801036 <fork+0x1de>
	   //		thisenv->env_id,
	   //		envid);
	   ...
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
  800ec1:	8b 7d e0             	mov    -0x20(%ebp),%edi
  800ec4:	8b 04 bd 00 d0 7b ef 	mov    -0x10843000(,%edi,4),%eax
  800ecb:	a8 01                	test   $0x1,%al
  800ecd:	0f 84 1c 01 00 00    	je     800fef <fork+0x197>
  800ed3:	89 fb                	mov    %edi,%ebx
  800ed5:	c1 e3 0a             	shl    $0xa,%ebx
  800ed8:	c1 e7 16             	shl    $0x16,%edi
  800edb:	be 00 00 00 00       	mov    $0x0,%esi
  800ee0:	e9 f8 00 00 00       	jmp    800fdd <fork+0x185>
				    continue;
			 }
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
  800ee5:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800eeb:	0f 84 e0 00 00 00    	je     800fd1 <fork+0x179>
						  continue;
				    } else if (pn >= (UTOP >> PGSHIFT)) {
  800ef1:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  800ef7:	0f 87 d0 00 00 00    	ja     800fcd <fork+0x175>
						  is_below_ulim = false;
				    } else if (uvpt[pn] & PTE_P) {
  800efd:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
  800f04:	a8 01                	test   $0x1,%al
  800f06:	0f 84 c5 00 00 00    	je     800fd1 <fork+0x179>
	   static int
duppage(envid_t envid, unsigned pn)
{
  ...
  800f13:	a9 02 08 00 00       	test   $0x802,%eax
  800f18:	75 3d                	jne    800f57 <fork+0xff>
			 if ((r = sys_page_map(thisenv->env_id,
  800f1a:	8b 15 04 20 80 00    	mov    0x802004,%edx
  ...
  800f30:	57                   	push   %edi
  800f31:	52                   	push   %edx
  800f32:	e8 bd fc ff ff       	call   800bf4 <sys_page_map>
  800f37:	83 c4 20             	add    $0x20,%esp
  800f3a:	85 c0                	test   %eax,%eax
  800f3c:	0f 89 8f 00 00 00    	jns    800fd1 <fork+0x179>
									   (void *)(pn * PGSIZE),
									   envid,
									   (void *)(pn * PGSIZE),
									   pte & PTE_SYSCALL)) < 0) {
				    panic("sys_page_map: %e", r);
  800f42:	50                   	push   %eax
  800f43:	68 98 17 80 00       	push   $0x801798
  800f48:	68 f0 00 00 00       	push   $0xf0
  800f4d:	68 34 17 80 00       	push   $0x801734
  ...
  800f80:	79 15                	jns    800f97 <fork+0x13f>
			 ...
			 panic("sys_page_map: %e", r);
  800f82:	50                   	push   %eax
  800f83:	68 98 17 80 00       	push   $0x801798
  800f88:	68 fe 00 00 00       	push   $0xfe
  800f8d:	68 34 17 80 00       	push   $0x801734
  800f92:	e8 b9 f1 ff ff       	call   800150 <_panic>
	   }
	   ...
	   if ((r = sys_page_map(thisenv->env_id,
								(void *)(pn * PGSIZE),
								thisenv->env_id,
  800f97:	a1 04 20 80 00       	mov    0x802004,%eax
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
	   }
	   ...
	   // remap our page to have copy on write
	   if ((r = sys_page_map(thisenv->env_id,
  800f9c:	8b 50 48             	mov    0x48(%eax),%edx
  800f9f:	8b 40 48             	mov    0x48(%eax),%eax
  800fa2:	83 ec 0c             	sub    $0xc,%esp
  800fa5:	ff 75 d8             	pushl  -0x28(%ebp)
  800fa8:	57                   	push   %edi
  800fa9:	52                   	push   %edx
  800faa:	57                   	push   %edi
  800fab:	50                   	push   %eax
  800fac:	e8 43 fc ff ff       	call   800bf4 <sys_page_map>
  800fb1:	83 c4 20             	add    $0x20,%esp
  800fb4:	85 c0                	test   %eax,%eax
  800fb6:	79 19                	jns    800fd1 <fork+0x179>
								(void *)(pn * PGSIZE),
								thisenv->env_id,
								(void *)(pn * PGSIZE),
								pte & PTE_SYSCALL)) < 0) {
			 panic("sys_page_map: %e", r);
  800fb8:	50                   	push   %eax
  800fb9:	68 98 17 80 00       	push   $0x801798
  800fbe:	68 07 01 00 00       	push   $0x107
  800fc3:	68 34 17 80 00       	push   $0x801734
  800fc8:	e8 83 f1 ff ff       	call   800150 <_panic>
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
				    unsigned pn = i * NPTENTRIES + j;
				    if (pn == ((UXSTACKTOP - PGSIZE) >> PGSHIFT)) {
						  continue;
						  ...
						  is_below_ulim = false;
  800fcd:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
			 if (!(uvpd[i] & PTE_P)) {
				    continue;
			 ...
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) {
  800fd1:	83 c6 01             	add    $0x1,%esi
  800fd4:	83 c3 01             	add    $0x1,%ebx
  800fd7:	81 c7 00 10 00 00    	add    $0x1000,%edi
  800fdd:	81 fe ff 03 00 00    	cmp    $0x3ff,%esi
  800fe3:	7f 0a                	jg     800fef <fork+0x197>
  800fe5:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  800fe9:	0f 85 f6 fe ff ff    	jne    800ee5 <fork+0x8d>
	   ...
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) {
  800fef:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
  800ff3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  800ff6:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  800ffb:	7f 0a                	jg     801007 <fork+0x1af>
  800ffd:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
  801001:	0f 85 ba fe ff ff    	jne    800ec1 <fork+0x69>
	   }
	   //	cprintf("\n");
  ...
  80100a:	68 a0 11 80 00       	push   $0x8011a0
  80100f:	8b 75 d4             	mov    -0x2c(%ebp),%esi
  801012:	56                   	push   %esi
  801013:	e8 a2 fc ff ff       	call   800cba <sys_env_set_pgfault_upcall>
	   // allocate the user exception stack (not COW)
	   sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_W | PTE_U);
  801018:	83 c4 0c             	add    $0xc,%esp
  80101b:	6a 06                	push   $0x6
  80101d:	68 00 f0 bf ee       	push   $0xeebff000
  801022:	56                   	push   %esi
  801023:	e8 89 fb ff ff       	call   800bb1 <sys_page_alloc>
	   // let the child start
	   sys_env_set_status(envid, ENV_RUNNABLE);
  801028:	83 c4 08             	add    $0x8,%esp
  80102b:	6a 02                	push   $0x2
  80102d:	56                   	push   %esi
  80102e:	e8 45 fc ff ff       	call   800c78 <sys_env_set_status>

	   return envid;
  801033:	83 c4 10             	add    $0x10,%esp
}
  801036:	8b 45 d4             	mov    -0x2c(%ebp),%eax
...
sfork(void)
{
  ...
  801047:	68 a9 17 80 00       	push   $0x8017a9
  80104c:	68 52 01 00 00       	push   $0x152
  801051:	68 34 17 80 00       	push   $0x801734
  801056:	e8 f5 f0 ff ff       	call   800150 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801069:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  80106b:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801070:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  801073:	83 ec 0c             	sub    $0xc,%esp
  801076:	50                   	push   %eax
  801077:	e8 a3 fc ff ff       	call   800d1f <sys_ipc_recv>
  ...
  801081:	78 0e                	js     801091 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  801083:	8b 15 04 20 80 00    	mov    0x802004,%edx
  801089:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  80108c:	8b 52 78             	mov    0x78(%edx),%edx
  80108f:	eb 0a                	jmp    80109b <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
  ...
  80109d:	74 02                	je     8010a1 <ipc_recv+0x46>
			 *from_env_store = s_envid;
  80109f:	89 0e                	mov    %ecx,(%esi)

	   if (perm_store)
  8010a1:	85 db                	test   %ebx,%ebx
  8010a3:	74 02                	je     8010a7 <ipc_recv+0x4c>
			 *perm_store = s_perm;
  8010a5:	89 13                	mov    %edx,(%ebx)

	   return (a >=0) ? thisenv -> env_ipc_value : a;
  8010a7:	85 c0                	test   %eax,%eax
  8010a9:	78 08                	js     8010b3 <ipc_recv+0x58>
  8010ab:	a1 04 20 80 00       	mov    0x802004,%eax
  8010b0:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8010cc:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  8010ce:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  8010d3:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
  8010d6:	ff 75 14             	pushl  0x14(%ebp)
  8010d9:	53                   	push   %ebx
  8010da:	56                   	push   %esi
  8010db:	57                   	push   %edi
  8010dc:	e8 1b fc ff ff       	call   800cfc <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  8010e1:	83 c4 10             	add    $0x10,%esp
  8010e4:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8010e7:	75 07                	jne    8010f0 <ipc_send+0x36>
				    sys_yield();
  8010e9:	e8 a4 fa ff ff       	call   800b92 <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  8010ee:	eb e6                	jmp    8010d6 <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  8010f2:	74 12                	je     801106 <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  8010f4:	50                   	push   %eax
  8010f5:	68 bf 17 80 00       	push   $0x8017bf
  8010fa:	6a 4b                	push   $0x4b
  8010fc:	68 d3 17 80 00       	push   $0x8017d3
...
ipc_find_env(enum EnvType type)
{
  ...
  801119:	6b d0 7c             	imul   $0x7c,%eax,%edx
  80111c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801122:	8b 52 50             	mov    0x50(%edx),%edx
  801125:	39 ca                	cmp    %ecx,%edx
  801127:	75 0d                	jne    801136 <ipc_find_env+0x28>
				    return envs[i].env_id;
  801129:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80112c:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801131:	8b 40 48             	mov    0x48(%eax),%eax
  801134:	eb 0f                	jmp    801145 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801139:	3d 00 04 00 00       	cmp    $0x400,%eax
  80113e:	75 d9                	jne    801119 <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80114d:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  801154:	75 2a                	jne    801180 <set_pgfault_handler+0x39>
			 // First time through!
			 // LAB 4: Your code here.
			 int a = sys_page_alloc (0, (void *) (UXSTACKTOP -PGSIZE), PTE_U | PTE_W);
  801156:	83 ec 04             	sub    $0x4,%esp
  801159:	6a 06                	push   $0x6
  80115b:	68 00 f0 bf ee       	push   $0xeebff000
  801160:	6a 00                	push   $0x0
  801162:	e8 4a fa ff ff       	call   800bb1 <sys_page_alloc>
			 if (a < 0)
  801167:	83 c4 10             	add    $0x10,%esp
  80116a:	85 c0                	test   %eax,%eax
  80116c:	79 12                	jns    801180 <set_pgfault_handler+0x39>
				    panic ("sys_page_alloc Failed. %e", a);
  80116e:	50                   	push   %eax
  80116f:	68 dd 17 80 00       	push   $0x8017dd
  801174:	6a 21                	push   $0x21
  801176:	68 f7 17 80 00       	push   $0x8017f7
  80117b:	e8 d0 ef ff ff       	call   800150 <_panic>
			 //panic("set_pgfault_handler not implemented");
	   }

	   sys_env_set_pgfault_upcall (sys_getenvid(),  _pgfault_upcall);
  801180:	e8 ee f9 ff ff       	call   800b73 <sys_getenvid>
  801185:	83 ec 08             	sub    $0x8,%esp
  801188:	68 a0 11 80 00       	push   $0x8011a0
  80118d:	50                   	push   %eax
  80118e:	e8 27 fb ff ff       	call   800cba <sys_env_set_pgfault_upcall>
...
// LAB 4: Your code here.
  ...
  8011af:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  ...
  8011b3:	83 eb 04             	sub    $0x4,%ebx
   movl %ebx, 48(%esp)	//adjust trap-time esp so ret will pop the eip
  8011b6:	89 5c 24 30          	mov    %ebx,0x30(%esp)

...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002e6:	ff 24 85 2c 0e 80 00 	jmp    *0x800e2c(,%eax,4)
  ...
  8003aa:	8b 14 85 84 0f 80 00 	mov    0x800f84(,%eax,4),%edx
  8003b1:	85 d2                	test   %edx,%edx
  8003b3:	75 18                	jne    8003cd <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003b5:	50                   	push   %eax
  8003b6:	68 b4 0d 80 00       	push   $0x800db4
  8003bb:	53                   	push   %ebx
  8003bc:	56                   	push   %esi
  ...
  8003cd:	52                   	push   %edx
  8003ce:	68 bd 0d 80 00       	push   $0x800dbd
  8003d3:	53                   	push   %ebx
  8003d4:	56                   	push   %esi
  ...
  8003f2:	b8 ad 0d 80 00       	mov    $0x800dad,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a6d:	68 a0 0f 80 00       	push   $0x800fa0
  800a72:	6a 23                	push   $0x23
  800a74:	68 bd 0f 80 00       	push   $0x800fbd
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ac1:	56                   	push   %esi
  800ac2:	50                   	push   %eax
  800ac3:	68 cc 0f 80 00       	push   $0x800fcc
  ...
  800ad4:	e8 12 f6 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800ad9:	c7 04 24 90 0d 80 00 	movl   $0x800d90,(%esp)

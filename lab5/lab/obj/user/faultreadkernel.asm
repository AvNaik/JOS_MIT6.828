	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 31 1e 80 00 	movsbl 0x801e31(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002eb:	ff 24 85 80 1f 80 00 	jmp    *0x801f80(,%eax,4)
  ...
  8003af:	8b 14 85 e0 20 80 00 	mov    0x8020e0(,%eax,4),%edx
  8003b6:	85 d2                	test   %edx,%edx
  8003b8:	75 18                	jne    8003d2 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003ba:	50                   	push   %eax
  8003bb:	68 49 1e 80 00       	push   $0x801e49
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003d2:	52                   	push   %edx
  8003d3:	68 11 22 80 00       	push   $0x802211
  8003d8:	53                   	push   %ebx
  8003d9:	56                   	push   %esi
  ...
  8003f7:	b8 42 1e 80 00       	mov    $0x801e42,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a72:	68 3f 21 80 00       	push   $0x80213f
  800a77:	6a 23                	push   $0x23
  800a79:	68 5c 21 80 00       	push   $0x80215c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800af3:	68 3f 21 80 00       	push   $0x80213f
  800af8:	6a 23                	push   $0x23
  800afa:	68 5c 21 80 00       	push   $0x80215c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b35:	68 3f 21 80 00       	push   $0x80213f
  800b3a:	6a 23                	push   $0x23
  800b3c:	68 5c 21 80 00       	push   $0x80215c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b77:	68 3f 21 80 00       	push   $0x80213f
  800b7c:	6a 23                	push   $0x23
  800b7e:	68 5c 21 80 00       	push   $0x80215c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bb9:	68 3f 21 80 00       	push   $0x80213f
  800bbe:	6a 23                	push   $0x23
  800bc0:	68 5c 21 80 00       	push   $0x80215c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800bfb:	68 3f 21 80 00       	push   $0x80213f
  800c00:	6a 23                	push   $0x23
  800c02:	68 5c 21 80 00       	push   $0x80215c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c3d:	68 3f 21 80 00       	push   $0x80213f
  800c42:	6a 23                	push   $0x23
  800c44:	68 5c 21 80 00       	push   $0x80215c
...
sys_ipc_recv(void *dstva)
{
  ...
  800ca1:	68 3f 21 80 00       	push   $0x80213f
  800ca6:	6a 23                	push   $0x23
  800ca8:	68 5c 21 80 00       	push   $0x80215c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800d8f:	ba e8 21 80 00       	mov    $0x8021e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dba:	51                   	push   %ecx
  800dbb:	50                   	push   %eax
  800dbc:	68 6c 21 80 00       	push   $0x80216c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800fe4:	53                   	push   %ebx
  800fe5:	50                   	push   %eax
  800fe6:	68 ad 21 80 00       	push   $0x8021ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010b9:	53                   	push   %ebx
  8010ba:	50                   	push   %eax
  8010bb:	68 c9 21 80 00       	push   $0x8021c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80116e:	53                   	push   %ebx
  80116f:	50                   	push   %eax
  801170:	68 8c 21 80 00       	push   $0x80218c
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8013aa:	68 f8 21 80 00       	push   $0x8021f8
  8013af:	68 ff 21 80 00       	push   $0x8021ff
  8013b4:	68 9a 00 00 00       	push   $0x9a
  8013b9:	68 14 22 80 00       	push   $0x802214
  ...
  8013ca:	68 1f 22 80 00       	push   $0x80221f
  8013cf:	68 ff 21 80 00       	push   $0x8021ff
  8013d4:	68 9b 00 00 00       	push   $0x9b
  8013d9:	68 14 22 80 00       	push   $0x802214
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80141a:	68 f8 21 80 00       	push   $0x8021f8
  80141f:	68 ff 21 80 00       	push   $0x8021ff
  801424:	6a 7c                	push   $0x7c
  801426:	68 14 22 80 00       	push   $0x802214
  80142b:	e8 bd 05 00 00       	call   8019ed <_panic>
	   assert(r <= PGSIZE);
  801430:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801435:	7e 16                	jle    80144d <devfile_read+0x65>
  801437:	68 32 22 80 00       	push   $0x802232
  80143c:	68 ff 21 80 00       	push   $0x8021ff
  801441:	6a 7d                	push   $0x7d
  801443:	68 14 22 80 00       	push   $0x802214
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801526:	68 3e 22 80 00       	push   $0x80223e
  80152b:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015d6:	50                   	push   %eax
  8015d7:	56                   	push   %esi
  8015d8:	68 45 22 80 00       	push   $0x802245
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80187a:	68 5d 22 80 00       	push   $0x80225d
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a09:	56                   	push   %esi
  801a0a:	50                   	push   %eax
  801a0b:	68 6c 22 80 00       	push   $0x80226c
  ...
  801a1c:	e8 cf e6 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801a21:	c7 04 24 56 22 80 00 	movl   $0x802256,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801aca:	74 12                	je     801ade <ipc_send+0x4c>
				    ...
				    panic("ipc_send failed: %e", err);
  801acc:	50                   	push   %eax
  801acd:	68 90 22 80 00       	push   $0x802290
  801ad2:	6a 4b                	push   $0x4b
  801ad4:	68 a4 22 80 00       	push   $0x8022a4

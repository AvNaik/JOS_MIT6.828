...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 7d 1e 80 00       	push   $0x801e7d
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800a47:	68 c8 1e 80 00       	push   $0x801ec8
  800a4c:	68 cf 1e 80 00       	push   $0x801ecf
  800a51:	68 9a 00 00 00       	push   $0x9a
  800a56:	68 e4 1e 80 00       	push   $0x801ee4
  ...
  800a67:	68 ef 1e 80 00       	push   $0x801eef
  800a6c:	68 cf 1e 80 00       	push   $0x801ecf
  800a71:	68 9b 00 00 00       	push   $0x9b
  800a76:	68 e4 1e 80 00       	push   $0x801ee4
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800ab7:	68 c8 1e 80 00       	push   $0x801ec8
  800abc:	68 cf 1e 80 00       	push   $0x801ecf
  800ac1:	6a 7c                	push   $0x7c
  800ac3:	68 e4 1e 80 00       	push   $0x801ee4
  800ac8:	e8 bd 05 00 00       	call   80108a <_panic>
	   assert(r <= PGSIZE);
  800acd:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ad2:	7e 16                	jle    800aea <devfile_read+0x65>
  800ad4:	68 02 1f 80 00       	push   $0x801f02
  800ad9:	68 cf 1e 80 00       	push   $0x801ecf
  800ade:	6a 7d                	push   $0x7d
  800ae0:	68 e4 1e 80 00       	push   $0x801ee4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bc3:	68 0e 1f 80 00       	push   $0x801f0e
  800bc8:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c73:	50                   	push   %eax
  800c74:	56                   	push   %esi
  800c75:	68 15 1f 80 00       	push   $0x801f15
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f17:	68 2d 1f 80 00       	push   $0x801f2d
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010a6:	56                   	push   %esi
  8010a7:	50                   	push   %eax
  8010a8:	68 3c 1f 80 00       	push   $0x801f3c
  ...
  8010b9:	e8 54 00 00 00       	call   801112 <vcprintf>
	cprintf("\n");
  8010be:	c7 04 24 26 1f 80 00 	movl   $0x801f26,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801211:	0f be 80 5f 1f 80 00 	movsbl 0x801f5f(%eax),%eax
  801218:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013dc:	50                   	push   %eax
  8013dd:	68 77 1f 80 00       	push   $0x801f77
  8013e2:	53                   	push   %ebx
  8013e3:	56                   	push   %esi
  ...
  8013f4:	52                   	push   %edx
  8013f5:	68 e1 1e 80 00       	push   $0x801ee1
  8013fa:	53                   	push   %ebx
  8013fb:	56                   	push   %esi
  ...
  801419:	b8 70 1f 80 00       	mov    $0x801f70,%eax

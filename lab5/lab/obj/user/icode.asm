...
umain(int argc, char **argv)
{
  ...
  800038:	81 ec 1c 02 00 00    	sub    $0x21c,%esp
	...
	binaryname = "icode";
  80003e:	c7 05 00 30 80 00 00 	movl   $0x802500,0x803000
  800045:	25 80 00 

	cprintf("icode startup\n");
  800048:	68 06 25 80 00       	push   $0x802506
  80004d:	e8 1b 02 00 00       	call   80026d <cprintf>

	cprintf("icode: open /motd\n");
  800052:	c7 04 24 15 25 80 00 	movl   $0x802515,(%esp)
  800059:	e8 0f 02 00 00       	call   80026d <cprintf>
	if ((fd = open("/motd", O_RDONLY)) < 0)
  80005e:	83 c4 08             	add    $0x8,%esp
  800061:	6a 00                	push   $0x0
  800063:	68 28 25 80 00       	push   $0x802528
  800068:	e8 29 15 00 00       	call   801596 <open>
  ...
  800076:	50                   	push   %eax
  800077:	68 2e 25 80 00       	push   $0x80252e
  80007c:	6a 0f                	push   $0xf
  80007e:	68 44 25 80 00       	push   $0x802544
  800083:	e8 0c 01 00 00       	call   800194 <_panic>

	cprintf("icode: read /motd\n");
  800088:	83 ec 0c             	sub    $0xc,%esp
  80008b:	68 51 25 80 00       	push   $0x802551
  ...
  8000c6:	68 64 25 80 00       	push   $0x802564
  ...
  8000d8:	c7 04 24 78 25 80 00 	movl   $0x802578,(%esp)
  8000df:	e8 89 01 00 00       	call   80026d <cprintf>
	if ((r = spawnl("/init", "init", "initarg1", "initarg2", (char*)0)) < 0)
  8000e4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000eb:	68 8c 25 80 00       	push   $0x80258c
  8000f0:	68 95 25 80 00       	push   $0x802595
  8000f5:	68 9f 25 80 00       	push   $0x80259f
  8000fa:	68 9e 25 80 00       	push   $0x80259e
  8000ff:	e8 d9 1a 00 00       	call   801bdd <spawnl>
  800104:	83 c4 20             	add    $0x20,%esp
  800107:	85 c0                	test   %eax,%eax
  800109:	79 12                	jns    80011d <umain+0xea>
		panic("icode: spawn /init: %e", r);
  80010b:	50                   	push   %eax
  80010c:	68 a4 25 80 00       	push   $0x8025a4
  800111:	6a 1a                	push   $0x1a
  800113:	68 44 25 80 00       	push   $0x802544
  800118:	e8 77 00 00 00       	call   800194 <_panic>

	cprintf("icode: exiting\n");
  80011d:	83 ec 0c             	sub    $0xc,%esp
  800120:	68 bb 25 80 00       	push   $0x8025bb
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001b0:	56                   	push   %esi
  8001b1:	50                   	push   %eax
  8001b2:	68 d8 25 80 00       	push   $0x8025d8
  ...
  8001c3:	e8 54 00 00 00       	call   80021c <vcprintf>
	cprintf("\n");
  8001c8:	c7 04 24 c8 2a 80 00 	movl   $0x802ac8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002d0:	e8 8b 1f 00 00       	call   802260 <__udivdi3>
  ...
  800313:	e8 78 20 00 00       	call   802390 <__umoddi3>
  800318:	83 c4 14             	add    $0x14,%esp
  80031b:	0f be 80 fb 25 80 00 	movsbl 0x8025fb(%eax),%eax
  800322:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800417:	ff 24 85 40 27 80 00 	jmp    *0x802740(,%eax,4)
  ...
  8004db:	8b 14 85 a0 28 80 00 	mov    0x8028a0(,%eax,4),%edx
  8004e2:	85 d2                	test   %edx,%edx
  8004e4:	75 18                	jne    8004fe <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8004e6:	50                   	push   %eax
  8004e7:	68 13 26 80 00       	push   $0x802613
  8004ec:	53                   	push   %ebx
  8004ed:	56                   	push   %esi
  ...
  8004fe:	52                   	push   %edx
  8004ff:	68 d1 29 80 00       	push   $0x8029d1
  800504:	53                   	push   %ebx
  800505:	56                   	push   %esi
  ...
  800523:	b8 0c 26 80 00       	mov    $0x80260c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b9e:	68 ff 28 80 00       	push   $0x8028ff
  800ba3:	6a 23                	push   $0x23
  800ba5:	68 1c 29 80 00       	push   $0x80291c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c1f:	68 ff 28 80 00       	push   $0x8028ff
  800c24:	6a 23                	push   $0x23
  800c26:	68 1c 29 80 00       	push   $0x80291c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c61:	68 ff 28 80 00       	push   $0x8028ff
  800c66:	6a 23                	push   $0x23
  800c68:	68 1c 29 80 00       	push   $0x80291c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca3:	68 ff 28 80 00       	push   $0x8028ff
  800ca8:	6a 23                	push   $0x23
  800caa:	68 1c 29 80 00       	push   $0x80291c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ce5:	68 ff 28 80 00       	push   $0x8028ff
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d27:	68 ff 28 80 00       	push   $0x8028ff
  800d2c:	6a 23                	push   $0x23
  800d2e:	68 1c 29 80 00       	push   $0x80291c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d69:	68 ff 28 80 00       	push   $0x8028ff
  800d6e:	6a 23                	push   $0x23
  800d70:	68 1c 29 80 00       	push   $0x80291c
...
sys_ipc_recv(void *dstva)
{
  ...
  800dcd:	68 ff 28 80 00       	push   $0x8028ff
  800dd2:	6a 23                	push   $0x23
  800dd4:	68 1c 29 80 00       	push   $0x80291c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ebb:	ba a8 29 80 00       	mov    $0x8029a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ee6:	51                   	push   %ecx
  800ee7:	50                   	push   %eax
  800ee8:	68 2c 29 80 00       	push   $0x80292c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801110:	53                   	push   %ebx
  801111:	50                   	push   %eax
  801112:	68 6d 29 80 00       	push   $0x80296d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011e5:	53                   	push   %ebx
  8011e6:	50                   	push   %eax
  8011e7:	68 89 29 80 00       	push   $0x802989
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80129a:	53                   	push   %ebx
  80129b:	50                   	push   %eax
  80129c:	68 4c 29 80 00       	push   $0x80294c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013ac:	e8 31 0e 00 00       	call   8021e2 <ipc_find_env>
  ...
  8013c7:	e8 c2 0d 00 00       	call   80218e <ipc_send>
	   return ipc_recv(NULL, dstva, NULL);
  8013cc:	83 c4 0c             	add    $0xc,%esp
  8013cf:	6a 00                	push   $0x0
  8013d1:	53                   	push   %ebx
  8013d2:	6a 00                	push   $0x0
  8013d4:	e8 56 0d 00 00       	call   80212f <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8014d6:	68 b8 29 80 00       	push   $0x8029b8
  8014db:	68 bf 29 80 00       	push   $0x8029bf
  8014e0:	68 9a 00 00 00       	push   $0x9a
  8014e5:	68 d4 29 80 00       	push   $0x8029d4
  ...
  8014f6:	68 df 29 80 00       	push   $0x8029df
  8014fb:	68 bf 29 80 00       	push   $0x8029bf
  801500:	68 9b 00 00 00       	push   $0x9b
  801505:	68 d4 29 80 00       	push   $0x8029d4
  80150a:	e8 85 ec ff ff       	call   800194 <_panic>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801546:	68 b8 29 80 00       	push   $0x8029b8
  80154b:	68 bf 29 80 00       	push   $0x8029bf
  801550:	6a 7c                	push   $0x7c
  801552:	68 d4 29 80 00       	push   $0x8029d4
  801557:	e8 38 ec ff ff       	call   800194 <_panic>
	   assert(r <= PGSIZE);
  80155c:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801561:	7e 16                	jle    801579 <devfile_read+0x65>
  801563:	68 f2 29 80 00       	push   $0x8029f2
  801568:	68 bf 29 80 00       	push   $0x8029bf
  80156d:	6a 7d                	push   $0x7d
  80156f:	68 d4 29 80 00       	push   $0x8029d4
  ...
  801585:	e8 fa f3 ff ff       	call   800984 <memmove>
	   return r;
...
open(const char *path, int mode)
{
  ...
  8015a0:	53                   	push   %ebx
  8015a1:	e8 13 f2 ff ff       	call   8007b9 <strlen>
  ...
  8015ce:	e8 1f f2 ff ff       	call   8007f2 <strcpy>
...
spawn(const char *prog, const char **argv)
{
  ...
  80163e:	56                   	push   %esi
  80163f:	53                   	push   %ebx
  801640:	81 ec 94 02 00 00    	sub    $0x294,%esp
  ...
  80164b:	e8 46 ff ff ff       	call   801596 <open>
  801650:	89 c1                	mov    %eax,%ecx
  801652:	89 85 88 fd ff ff    	mov    %eax,-0x278(%ebp)
  801658:	83 c4 10             	add    $0x10,%esp
  80165b:	85 c0                	test   %eax,%eax
  80165d:	0f 88 de 04 00 00    	js     801b41 <spawn+0x507>
			 return r;
	   fd = r;
  ...
  801666:	68 00 02 00 00       	push   $0x200
  80166b:	8d 85 e8 fd ff ff    	lea    -0x218(%ebp),%eax
  801671:	50                   	push   %eax
  801672:	51                   	push   %ecx
  801673:	e8 db fa ff ff       	call   801153 <readn>
  801678:	83 c4 10             	add    $0x10,%esp
  80167b:	3d 00 02 00 00       	cmp    $0x200,%eax
  801680:	75 0c                	jne    80168e <spawn+0x54>
				    || elf->e_magic != ELF_MAGIC) {
  801682:	81 bd e8 fd ff ff 7f 	cmpl   $0x464c457f,-0x218(%ebp)
  801689:	45 4c 46 
  80168c:	74 33                	je     8016c1 <spawn+0x87>
			 close(fd);
  80168e:	83 ec 0c             	sub    $0xc,%esp
  801691:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801697:	e8 ea f8 ff ff       	call   800f86 <close>
			 cprintf("elf magic %08x want %08x\n", elf->e_magic, ELF_MAGIC);
  80169c:	83 c4 0c             	add    $0xc,%esp
  80169f:	68 7f 45 4c 46       	push   $0x464c457f
  8016a4:	ff b5 e8 fd ff ff    	pushl  -0x218(%ebp)
  8016aa:	68 fe 29 80 00       	push   $0x8029fe
  8016af:	e8 b9 eb ff ff       	call   80026d <cprintf>
			 return -E_NOT_EXEC;
  8016b4:	83 c4 10             	add    $0x10,%esp
  8016b7:	bb f2 ff ff ff       	mov    $0xfffffff2,%ebx
  8016bc:	e9 12 05 00 00       	jmp    801bd3 <spawn+0x599>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  8016c1:	b8 07 00 00 00       	mov    $0x7,%eax
  8016c6:	cd 30                	int    $0x30
  8016c8:	89 85 74 fd ff ff    	mov    %eax,-0x28c(%ebp)
  8016ce:	89 85 90 fd ff ff    	mov    %eax,-0x270(%ebp)
	   }

	   // Create new child environment
	   if ((r = sys_exofork()) < 0)
  8016d4:	85 c0                	test   %eax,%eax
  8016d6:	0f 88 70 04 00 00    	js     801b4c <spawn+0x512>
			 return r;
	   child = r;
  ...
  8016de:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
  8016e4:	6b f6 7c             	imul   $0x7c,%esi,%esi
  8016e7:	81 c6 00 00 c0 ee    	add    $0xeec00000,%esi
  8016ed:	8d bd a4 fd ff ff    	lea    -0x25c(%ebp),%edi
  8016f3:	b9 11 00 00 00       	mov    $0x11,%ecx
  8016f8:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
	   child_tf.tf_eip = elf->e_entry;
  8016fa:	8b 85 00 fe ff ff    	mov    -0x200(%ebp),%eax
  801700:	89 85 d4 fd ff ff    	mov    %eax,-0x22c(%ebp)
  ...
  801713:	eb 13                	jmp    801728 <spawn+0xee>
	   for (argc = 0; argv[argc] != 0; argc++)
			 string_size += strlen(argv[argc]) + 1;
  801715:	83 ec 0c             	sub    $0xc,%esp
  801718:	50                   	push   %eax
  801719:	e8 9b f0 ff ff       	call   8007b9 <strlen>
  80171e:	8d 74 30 01          	lea    0x1(%eax,%esi,1),%esi
	   uintptr_t *argv_store;
  ...
  801728:	8d 0c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%ecx
  80172f:	8b 04 9f             	mov    (%edi,%ebx,4),%eax
  801732:	85 c0                	test   %eax,%eax
  801734:	75 df                	jne    801715 <spawn+0xdb>
  801736:	89 9d 84 fd ff ff    	mov    %ebx,-0x27c(%ebp)
  80173c:	89 8d 80 fd ff ff    	mov    %ecx,-0x280(%ebp)
  ...
  801742:	bf 00 10 40 00       	mov    $0x401000,%edi
  801747:	29 f7                	sub    %esi,%edi
	   // argv is below that.  There's one argument pointer per argument, plus
	   // a null pointer.
	   argv_store = (uintptr_t*) (ROUNDDOWN(string_store, 4) - 4 * (argc + 1));
  801749:	89 fa                	mov    %edi,%edx
  80174b:	83 e2 fc             	and    $0xfffffffc,%edx
  80174e:	8d 04 9d 04 00 00 00 	lea    0x4(,%ebx,4),%eax
  801755:	29 c2                	sub    %eax,%edx
  801757:	89 95 94 fd ff ff    	mov    %edx,-0x26c(%ebp)

	   // Make sure that argv, strings, and the 2 words that hold 'argc'
	   // and 'argv' themselves will all fit in a single stack page.
	   if ((void*) (argv_store - 2) < (void*) UTEMP)
  80175d:	8d 42 f8             	lea    -0x8(%edx),%eax
  801760:	3d ff ff 3f 00       	cmp    $0x3fffff,%eax
  801765:	0f 86 f1 03 00 00    	jbe    801b5c <spawn+0x522>
			 return -E_NO_MEM;
  ...
  801777:	e8 79 f4 ff ff       	call   800bf5 <sys_page_alloc>
  80177c:	83 c4 10             	add    $0x10,%esp
  80177f:	85 c0                	test   %eax,%eax
  801781:	0f 88 dc 03 00 00    	js     801b63 <spawn+0x529>
  801787:	be 00 00 00 00       	mov    $0x0,%esi
  80178c:	89 9d 8c fd ff ff    	mov    %ebx,-0x274(%ebp)
  801792:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  801795:	eb 30                	jmp    8017c7 <spawn+0x18d>
	   //	  environment.)
	   //
  ...
  801797:	8d 87 00 d0 7f ee    	lea    -0x11803000(%edi),%eax
  80179d:	8b 8d 94 fd ff ff    	mov    -0x26c(%ebp),%ecx
  8017a3:	89 04 b1             	mov    %eax,(%ecx,%esi,4)
			 strcpy(string_store, argv[i]);
  8017a6:	83 ec 08             	sub    $0x8,%esp
  8017a9:	ff 34 b3             	pushl  (%ebx,%esi,4)
  8017ac:	57                   	push   %edi
  8017ad:	e8 40 f0 ff ff       	call   8007f2 <strcpy>
			 string_store += strlen(argv[i]) + 1;
  8017b2:	83 c4 04             	add    $0x4,%esp
  8017b5:	ff 34 b3             	pushl  (%ebx,%esi,4)
  8017b8:	e8 fc ef ff ff       	call   8007b9 <strlen>
  8017bd:	8d 7c 07 01          	lea    0x1(%edi,%eax,1),%edi
	   ...
	   //	  (Again, use an address valid in the child's environment.)
	   for (i = 0; i < argc; i++) {
  8017c1:	83 c6 01             	add    $0x1,%esi
  8017c4:	83 c4 10             	add    $0x10,%esp
  8017c7:	39 b5 8c fd ff ff    	cmp    %esi,-0x274(%ebp)
  8017cd:	7f c8                	jg     801797 <spawn+0x15d>
			 argv_store[i] = UTEMP2USTACK(string_store);
			 strcpy(string_store, argv[i]);
			 string_store += strlen(argv[i]) + 1;
	   }
	   argv_store[argc] = 0;
  8017cf:	8b 85 94 fd ff ff    	mov    -0x26c(%ebp),%eax
  8017d5:	8b 95 80 fd ff ff    	mov    -0x280(%ebp),%edx
  8017db:	c7 04 10 00 00 00 00 	movl   $0x0,(%eax,%edx,1)
	   assert(string_store == (char*)UTEMP + PGSIZE);
  8017e2:	81 ff 00 10 40 00    	cmp    $0x401000,%edi
  8017e8:	74 19                	je     801803 <spawn+0x1c9>
  8017ea:	68 88 2a 80 00       	push   $0x802a88
  8017ef:	68 bf 29 80 00       	push   $0x8029bf
  8017f4:	68 f2 00 00 00       	push   $0xf2
  8017f9:	68 18 2a 80 00       	push   $0x802a18
  8017fe:	e8 91 e9 ff ff       	call   800194 <_panic>

	   argv_store[-1] = UTEMP2USTACK(argv_store);
  801803:	8b 8d 94 fd ff ff    	mov    -0x26c(%ebp),%ecx
  801809:	89 c8                	mov    %ecx,%eax
  80180b:	2d 00 30 80 11       	sub    $0x11803000,%eax
  801810:	89 41 fc             	mov    %eax,-0x4(%ecx)
	   argv_store[-2] = argc;
  801813:	8b 85 84 fd ff ff    	mov    -0x27c(%ebp),%eax
  801819:	89 41 f8             	mov    %eax,-0x8(%ecx)

	   *init_esp = UTEMP2USTACK(&argv_store[-2]);
  80181c:	8d 81 f8 cf 7f ee    	lea    -0x11803008(%ecx),%eax
  801822:	89 85 e0 fd ff ff    	mov    %eax,-0x220(%ebp)
  ...
  80182d:	68 00 d0 bf ee       	push   $0xeebfd000
  801832:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801838:	68 00 00 40 00       	push   $0x400000
  80183d:	6a 00                	push   $0x0
  80183f:	e8 f4 f3 ff ff       	call   800c38 <sys_page_map>
  801844:	89 c3                	mov    %eax,%ebx
  801846:	83 c4 20             	add    $0x20,%esp
  801849:	85 c0                	test   %eax,%eax
  80184b:	0f 88 70 03 00 00    	js     801bc1 <spawn+0x587>
			 goto error;
	   if ((r = sys_page_unmap(0, UTEMP)) < 0)
  801851:	83 ec 08             	sub    $0x8,%esp
  801854:	68 00 00 40 00       	push   $0x400000
  801859:	6a 00                	push   $0x0
  80185b:	e8 1a f4 ff ff       	call   800c7a <sys_page_unmap>
  801860:	89 c3                	mov    %eax,%ebx
  801862:	83 c4 10             	add    $0x10,%esp
  801865:	85 c0                	test   %eax,%eax
  801867:	0f 88 54 03 00 00    	js     801bc1 <spawn+0x587>
  ...
  80186d:	8b 85 04 fe ff ff    	mov    -0x1fc(%ebp),%eax
  801873:	8d 84 05 e8 fd ff ff 	lea    -0x218(%ebp,%eax,1),%eax
  80187a:	89 85 7c fd ff ff    	mov    %eax,-0x284(%ebp)
	   for (i = 0; i < elf->e_phnum; i++, ph++) {
  801880:	c7 85 78 fd ff ff 00 	movl   $0x0,-0x288(%ebp)
  801887:	00 00 00 
  80188a:	e9 86 01 00 00       	jmp    801a15 <spawn+0x3db>
			 if (ph->p_type != ELF_PROG_LOAD)
  80188f:	8b 85 7c fd ff ff    	mov    -0x284(%ebp),%eax
  801895:	83 38 01             	cmpl   $0x1,(%eax)
  801898:	0f 85 69 01 00 00    	jne    801a07 <spawn+0x3cd>
				    continue;
			 perm = PTE_P | PTE_U;
			 if (ph->p_flags & ELF_PROG_FLAG_WRITE)
  80189e:	89 c1                	mov    %eax,%ecx
  8018a0:	8b 40 18             	mov    0x18(%eax),%eax
  8018a3:	89 85 94 fd ff ff    	mov    %eax,-0x26c(%ebp)
  8018a9:	83 e0 02             	and    $0x2,%eax
				    perm |= PTE_W;
  8018ac:	83 f8 01             	cmp    $0x1,%eax
  8018af:	19 c0                	sbb    %eax,%eax
  8018b1:	83 e0 fe             	and    $0xfffffffe,%eax
  8018b4:	83 c0 07             	add    $0x7,%eax
  8018b7:	89 85 84 fd ff ff    	mov    %eax,-0x27c(%ebp)
			 if ((r = map_segment(child, ph->p_va, ph->p_memsz,
  8018bd:	89 c8                	mov    %ecx,%eax
  8018bf:	8b 49 04             	mov    0x4(%ecx),%ecx
  8018c2:	89 8d 80 fd ff ff    	mov    %ecx,-0x280(%ebp)
  8018c8:	8b 78 10             	mov    0x10(%eax),%edi
  8018cb:	8b 50 14             	mov    0x14(%eax),%edx
  8018ce:	89 95 8c fd ff ff    	mov    %edx,-0x274(%ebp)
  8018d4:	8b 70 08             	mov    0x8(%eax),%esi
	   int i, r;
	   void *blk;
	   ...
	   if ((i = PGOFF(va))) {
  8018d7:	89 f0                	mov    %esi,%eax
  8018d9:	25 ff 0f 00 00       	and    $0xfff,%eax
  8018de:	74 14                	je     8018f4 <spawn+0x2ba>
			 va -= i;
  8018e0:	29 c6                	sub    %eax,%esi
			 memsz += i;
  8018e2:	01 c2                	add    %eax,%edx
  8018e4:	89 95 8c fd ff ff    	mov    %edx,-0x274(%ebp)
			 filesz += i;
  8018ea:	01 c7                	add    %eax,%edi
			 fileoffset -= i;
  8018ec:	29 c1                	sub    %eax,%ecx
  8018ee:	89 8d 80 fd ff ff    	mov    %ecx,-0x280(%ebp)
	   }

	   for (i = 0; i < memsz; i += PGSIZE) {
  8018f4:	bb 00 00 00 00       	mov    $0x0,%ebx
  8018f9:	e9 f7 00 00 00       	jmp    8019f5 <spawn+0x3bb>
			 if (i >= filesz) {
  8018fe:	39 df                	cmp    %ebx,%edi
  801900:	77 27                	ja     801929 <spawn+0x2ef>
				    // allocate a blank page
				    if ((r = sys_page_alloc(child, (void*) (va + i), perm)) < 0)
  801902:	83 ec 04             	sub    $0x4,%esp
  801905:	ff b5 84 fd ff ff    	pushl  -0x27c(%ebp)
  80190b:	56                   	push   %esi
  80190c:	ff b5 90 fd ff ff    	pushl  -0x270(%ebp)
  801912:	e8 de f2 ff ff       	call   800bf5 <sys_page_alloc>
  801917:	83 c4 10             	add    $0x10,%esp
  80191a:	85 c0                	test   %eax,%eax
  80191c:	0f 89 c7 00 00 00    	jns    8019e9 <spawn+0x3af>
  801922:	89 c3                	mov    %eax,%ebx
  801924:	e9 48 02 00 00       	jmp    801b71 <spawn+0x537>
						  return r;
			 } else {
				    // from file
  ...
  801935:	e8 bb f2 ff ff       	call   800bf5 <sys_page_alloc>
  80193a:	83 c4 10             	add    $0x10,%esp
  80193d:	85 c0                	test   %eax,%eax
  80193f:	0f 88 22 02 00 00    	js     801b67 <spawn+0x52d>
						  return r;
				    if ((r = seek(fd, fileoffset + i)) < 0)
  801945:	83 ec 08             	sub    $0x8,%esp
  801948:	8b 85 80 fd ff ff    	mov    -0x280(%ebp),%eax
  80194e:	03 85 94 fd ff ff    	add    -0x26c(%ebp),%eax
  801954:	50                   	push   %eax
  801955:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  80195b:	e8 c8 f8 ff ff       	call   801228 <seek>
  801960:	83 c4 10             	add    $0x10,%esp
  801963:	85 c0                	test   %eax,%eax
  801965:	0f 88 00 02 00 00    	js     801b6b <spawn+0x531>
						  return r;
				    if ((r = readn(fd, UTEMP, MIN(PGSIZE, filesz-i))) < 0)
  80196b:	83 ec 04             	sub    $0x4,%esp
  80196e:	89 f8                	mov    %edi,%eax
  801970:	2b 85 94 fd ff ff    	sub    -0x26c(%ebp),%eax
  801976:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80197b:	b9 00 10 00 00       	mov    $0x1000,%ecx
  801980:	0f 47 c1             	cmova  %ecx,%eax
  801983:	50                   	push   %eax
  801984:	68 00 00 40 00       	push   $0x400000
  801989:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  80198f:	e8 bf f7 ff ff       	call   801153 <readn>
  801994:	83 c4 10             	add    $0x10,%esp
  801997:	85 c0                	test   %eax,%eax
  801999:	0f 88 d0 01 00 00    	js     801b6f <spawn+0x535>
						  return r;
				    if ((r = sys_page_map(0, UTEMP, child, (void*) (va + i), perm)) < 0)
  80199f:	83 ec 0c             	sub    $0xc,%esp
  8019a2:	ff b5 84 fd ff ff    	pushl  -0x27c(%ebp)
  8019a8:	56                   	push   %esi
  8019a9:	ff b5 90 fd ff ff    	pushl  -0x270(%ebp)
  8019af:	68 00 00 40 00       	push   $0x400000
  8019b4:	6a 00                	push   $0x0
  8019b6:	e8 7d f2 ff ff       	call   800c38 <sys_page_map>
  8019bb:	83 c4 20             	add    $0x20,%esp
  8019be:	85 c0                	test   %eax,%eax
  8019c0:	79 15                	jns    8019d7 <spawn+0x39d>
						  panic("spawn: sys_page_map data: %e", r);
  8019c2:	50                   	push   %eax
  8019c3:	68 24 2a 80 00       	push   $0x802a24
  8019c8:	68 25 01 00 00       	push   $0x125
  8019cd:	68 18 2a 80 00       	push   $0x802a18
  8019d2:	e8 bd e7 ff ff       	call   800194 <_panic>
				    sys_page_unmap(0, UTEMP);
  8019d7:	83 ec 08             	sub    $0x8,%esp
  8019da:	68 00 00 40 00       	push   $0x400000
  8019df:	6a 00                	push   $0x0
  8019e1:	e8 94 f2 ff ff       	call   800c7a <sys_page_unmap>
  8019e6:	83 c4 10             	add    $0x10,%esp
	   ...
	   for (i = 0; i < memsz; i += PGSIZE) {
  8019e9:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  8019ef:	81 c6 00 10 00 00    	add    $0x1000,%esi
  8019f5:	89 9d 94 fd ff ff    	mov    %ebx,-0x26c(%ebp)
  8019fb:	39 9d 8c fd ff ff    	cmp    %ebx,-0x274(%ebp)
  801a01:	0f 87 f7 fe ff ff    	ja     8018fe <spawn+0x2c4>
	   if ((r = init_stack(child, argv, &child_tf.tf_esp)) < 0)
			 return r;
	   ...
	   ph = (struct Proghdr*) (elf_buf + elf->e_phoff);
	   for (i = 0; i < elf->e_phnum; i++, ph++) {
  801a07:	83 85 78 fd ff ff 01 	addl   $0x1,-0x288(%ebp)
  801a0e:	83 85 7c fd ff ff 20 	addl   $0x20,-0x284(%ebp)
  801a15:	0f b7 85 14 fe ff ff 	movzwl -0x1ec(%ebp),%eax
  801a1c:	39 85 78 fd ff ff    	cmp    %eax,-0x288(%ebp)
  801a22:	0f 8c 67 fe ff ff    	jl     80188f <spawn+0x255>
				    perm |= PTE_W;
			 if ((r = map_segment(child, ph->p_va, ph->p_memsz,
  ...
  801a2b:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801a31:	e8 50 f5 ff ff       	call   800f86 <close>
...
copy_shared_pages(envid_t child)
{
  ...
  801a39:	c6 85 94 fd ff ff 01 	movb   $0x1,-0x26c(%ebp)
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) 
  801a40:	c7 85 8c fd ff ff 00 	movl   $0x0,-0x274(%ebp)
  801a47:	00 00 00 
	   {
			 if (!(uvpd[i] & PTE_P)) 
  801a4a:	8b bd 8c fd ff ff    	mov    -0x274(%ebp),%edi
  801a50:	8b 04 bd 00 d0 7b ef 	mov    -0x10843000(,%edi,4),%eax
  801a57:	a8 01                	test   $0x1,%al
  801a59:	74 7b                	je     801ad6 <spawn+0x49c>
  801a5b:	89 fb                	mov    %edi,%ebx
  801a5d:	c1 e3 0a             	shl    $0xa,%ebx
  801a60:	c1 e7 16             	shl    $0x16,%edi
  801a63:	be 00 00 00 00       	mov    $0x0,%esi
  801a68:	eb 5b                	jmp    801ac5 <spawn+0x48b>
				    continue;
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) 
			 {
				    unsigned pn = i * NPTENTRIES + j;
				    pte_t pte = uvpt[pn];
  801a6a:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
				    if (pn >= (UTOP >> PGSHIFT)) 
  801a71:	81 fb ff eb 0e 00    	cmp    $0xeebff,%ebx
  801a77:	77 39                	ja     801ab2 <spawn+0x478>
				    {
						  is_below_ulim = false;
				    } else if (pte & PTE_SHARE) 
  801a79:	f6 c4 04             	test   $0x4,%ah
  801a7c:	74 3b                	je     801ab9 <spawn+0x47f>
				    {
						  if ((r = sys_page_map(0, (void *)(pn * PGSIZE), child, (void *)(pn * PGSIZE), pte & PTE_SYSCALL)) < 0) {
  801a7e:	83 ec 0c             	sub    $0xc,%esp
  801a81:	25 07 0e 00 00       	and    $0xe07,%eax
  801a86:	50                   	push   %eax
  801a87:	57                   	push   %edi
  801a88:	ff b5 90 fd ff ff    	pushl  -0x270(%ebp)
  801a8e:	57                   	push   %edi
  801a8f:	6a 00                	push   $0x0
  801a91:	e8 a2 f1 ff ff       	call   800c38 <sys_page_map>
  801a96:	83 c4 20             	add    $0x20,%esp
  801a99:	85 c0                	test   %eax,%eax
  801a9b:	79 1c                	jns    801ab9 <spawn+0x47f>
	   close(fd);
	   fd = -1;
  ...
  801a9d:	50                   	push   %eax
  801a9e:	68 72 2a 80 00       	push   $0x802a72
  801aa3:	68 82 00 00 00       	push   $0x82
  801aa8:	68 18 2a 80 00       	push   $0x802a18
  801aad:	e8 e2 e6 ff ff       	call   800194 <_panic>
			 {
				    unsigned pn = i * NPTENTRIES + j;
				    pte_t pte = uvpt[pn];
				    if (pn >= (UTOP >> PGSHIFT)) 
				    {
						  is_below_ulim = false;
  801ab2:	c6 85 94 fd ff ff 00 	movb   $0x0,-0x26c(%ebp)
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) 
	   {
			 if (!(uvpd[i] & PTE_P)) 
				    continue;
			 for (int j = 0; is_below_ulim && j < NPTENTRIES; j++) 
  801ab9:	83 c6 01             	add    $0x1,%esi
  801abc:	83 c3 01             	add    $0x1,%ebx
  801abf:	81 c7 00 10 00 00    	add    $0x1000,%edi
  801ac5:	81 fe ff 03 00 00    	cmp    $0x3ff,%esi
  801acb:	7f 09                	jg     801ad6 <spawn+0x49c>
  801acd:	80 bd 94 fd ff ff 00 	cmpb   $0x0,-0x26c(%ebp)
  801ad4:	75 94                	jne    801a6a <spawn+0x430>
copy_shared_pages(envid_t child)
{
	   // LAB 5: Your code here.
	   int r;
	   bool is_below_ulim = true;
	   for (int i = 0; is_below_ulim && i < NPDENTRIES ; i++) 
  801ad6:	83 85 8c fd ff ff 01 	addl   $0x1,-0x274(%ebp)
  801add:	8b 85 8c fd ff ff    	mov    -0x274(%ebp),%eax
  801ae3:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801ae8:	0f 8f a4 00 00 00    	jg     801b92 <spawn+0x558>
  801aee:	80 bd 94 fd ff ff 00 	cmpb   $0x0,-0x26c(%ebp)
  801af5:	0f 85 4f ff ff ff    	jne    801a4a <spawn+0x410>
  801afb:	e9 92 00 00 00       	jmp    801b92 <spawn+0x558>
	   if ((r = copy_shared_pages(child)) < 0)
			 panic("copy_shared_pages: %e", r);
  ...
  801b00:	50                   	push   %eax
  801b01:	68 41 2a 80 00       	push   $0x802a41
  801b06:	68 86 00 00 00       	push   $0x86
  801b0b:	68 18 2a 80 00       	push   $0x802a18
  801b10:	e8 7f e6 ff ff       	call   800194 <_panic>

	   if ((r = sys_env_set_status(child, ENV_RUNNABLE)) < 0)
  801b15:	83 ec 08             	sub    $0x8,%esp
  801b18:	6a 02                	push   $0x2
  801b1a:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801b20:	e8 97 f1 ff ff       	call   800cbc <sys_env_set_status>
  801b25:	83 c4 10             	add    $0x10,%esp
  801b28:	85 c0                	test   %eax,%eax
  801b2a:	79 28                	jns    801b54 <spawn+0x51a>
			 panic("sys_env_set_status: %e", r);
  801b2c:	50                   	push   %eax
  801b2d:	68 5b 2a 80 00       	push   $0x802a5b
  801b32:	68 89 00 00 00       	push   $0x89
  801b37:	68 18 2a 80 00       	push   $0x802a18
  801b3c:	e8 53 e6 ff ff       	call   800194 <_panic>
	   //     correct initial eip and esp values in the child.
	   //
	   //   - Start the child process running with sys_env_set_status().
	   ...
	   if ((r = open(prog, O_RDONLY)) < 0)
			 return r;
  801b41:	8b 9d 88 fd ff ff    	mov    -0x278(%ebp),%ebx
  801b47:	e9 87 00 00 00       	jmp    801bd3 <spawn+0x599>
			 return -E_NOT_EXEC;
	   }
	   ...
	   if ((r = sys_exofork()) < 0)
			 return r;
  801b4c:	8b 9d 74 fd ff ff    	mov    -0x28c(%ebp),%ebx
  801b52:	eb 7f                	jmp    801bd3 <spawn+0x599>
			 panic("sys_env_set_trapframe: %e", r);
	   ...
	   return child;
  801b54:	8b 9d 74 fd ff ff    	mov    -0x28c(%ebp),%ebx
  801b5a:	eb 77                	jmp    801bd3 <spawn+0x599>
	   argv_store = (uintptr_t*) (ROUNDDOWN(string_store, 4) - 4 * (argc + 1));
	   ...
	   if ((void*) (argv_store - 2) < (void*) UTEMP)
			 return -E_NO_MEM;
  801b5c:	bb fc ff ff ff       	mov    $0xfffffffc,%ebx
  801b61:	eb 70                	jmp    801bd3 <spawn+0x599>

	   // Allocate the single stack page at UTEMP.
	   if ((r = sys_page_alloc(0, (void*) UTEMP, PTE_P|PTE_U|PTE_W)) < 0)
			 return r;
  801b63:	89 c3                	mov    %eax,%ebx
  801b65:	eb 6c                	jmp    801bd3 <spawn+0x599>
				    // allocate a blank page
				    if ((r = sys_page_alloc(child, (void*) (va + i), perm)) < 0)
						  return r;
			 } else {
  ...
  801b69:	eb 06                	jmp    801b71 <spawn+0x537>
						  return r;
				    if ((r = seek(fd, fileoffset + i)) < 0)
  801b6b:	89 c3                	mov    %eax,%ebx
  801b6d:	eb 02                	jmp    801b71 <spawn+0x537>
						  return r;
				    if ((r = readn(fd, UTEMP, MIN(PGSIZE, filesz-i))) < 0)
...
error:
  ...
  801b74:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801b7a:	e8 f7 ef ff ff       	call   800b76 <sys_env_destroy>
	   close(fd);
  801b7f:	83 c4 04             	add    $0x4,%esp
  801b82:	ff b5 88 fd ff ff    	pushl  -0x278(%ebp)
  801b88:	e8 f9 f3 ff ff       	call   800f86 <close>
	   return r;
  801b8d:	83 c4 10             	add    $0x10,%esp
  801b90:	eb 41                	jmp    801bd3 <spawn+0x599>
	   ...
	   child_tf.tf_eflags |= FL_IOPL_3;   // devious: see user/faultio.c
  801b92:	81 8d dc fd ff ff 00 	orl    $0x3000,-0x224(%ebp)
  801b99:	30 00 00 
	   if ((r = sys_env_set_trapframe(child, &child_tf)) < 0)
  801b9c:	83 ec 08             	sub    $0x8,%esp
  801b9f:	8d 85 a4 fd ff ff    	lea    -0x25c(%ebp),%eax
  801ba5:	50                   	push   %eax
  801ba6:	ff b5 74 fd ff ff    	pushl  -0x28c(%ebp)
  801bac:	e8 4d f1 ff ff       	call   800cfe <sys_env_set_trapframe>
  801bb1:	83 c4 10             	add    $0x10,%esp
  801bb4:	85 c0                	test   %eax,%eax
  801bb6:	0f 89 59 ff ff ff    	jns    801b15 <spawn+0x4db>
  801bbc:	e9 3f ff ff ff       	jmp    801b00 <spawn+0x4c6>
			 goto error;
...
error:
  ...
  801bcb:	e8 aa f0 ff ff       	call   800c7a <sys_page_unmap>
...
spawnl(const char *prog, const char *arg0, ...)
{
  ...
  801be2:	8d 55 10             	lea    0x10(%ebp),%edx
{
  ...
  801be5:	b8 00 00 00 00       	mov    $0x0,%eax
	   ...
	   va_start(vl, arg0);
	   while(va_arg(vl, void *) != NULL)
  801bea:	eb 03                	jmp    801bef <spawnl+0x12>
			 argc++;
  801bec:	83 c0 01             	add    $0x1,%eax
	   ...
	   va_start(vl, arg0);
	   while(va_arg(vl, void *) != NULL)
  801bef:	83 c2 04             	add    $0x4,%edx
  801bf2:	83 7a fc 00          	cmpl   $0x0,-0x4(%edx)
  801bf6:	75 f4                	jne    801bec <spawnl+0xf>
			 argc++;
	   va_end(vl);
  ...
  801bf8:	8d 14 85 1a 00 00 00 	lea    0x1a(,%eax,4),%edx
  801bff:	83 e2 f0             	and    $0xfffffff0,%edx
  801c02:	29 d4                	sub    %edx,%esp
  801c04:	8d 54 24 03          	lea    0x3(%esp),%edx
  801c08:	c1 ea 02             	shr    $0x2,%edx
  801c0b:	8d 34 95 00 00 00 00 	lea    0x0(,%edx,4),%esi
  801c12:	89 f3                	mov    %esi,%ebx
	   argv[0] = arg0;
  801c14:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801c17:	89 0c 95 00 00 00 00 	mov    %ecx,0x0(,%edx,4)
	   argv[argc+1] = NULL;
  801c1e:	c7 44 86 04 00 00 00 	movl   $0x0,0x4(%esi,%eax,4)
  801c25:	00 
  ...
  801c2d:	eb 0a                	jmp    801c39 <spawnl+0x5c>
			 argv[i+1] = va_arg(vl, const char *);
  801c2f:	83 c0 01             	add    $0x1,%eax
  801c32:	8b 4c 85 0c          	mov    0xc(%ebp,%eax,4),%ecx
  801c36:	89 0c 83             	mov    %ecx,(%ebx,%eax,4)
	   argv[0] = arg0;
	   argv[argc+1] = NULL;
  ...
  801c3b:	75 f2                	jne    801c2f <spawnl+0x52>
			 argv[i+1] = va_arg(vl, const char *);
	   va_end(vl);
  ...
  801c44:	e8 f1 f9 ff ff       	call   80163a <spawn>
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801c5e:	e8 93 f1 ff ff       	call   800df6 <fd2data>
  801c63:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801c65:	83 c4 08             	add    $0x8,%esp
  801c68:	68 b0 2a 80 00       	push   $0x802ab0
  801c6d:	53                   	push   %ebx
  801c6e:	e8 7f eb ff ff       	call   8007f2 <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  801cab:	e8 ca ef ff ff       	call   800c7a <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801cb0:	89 1c 24             	mov    %ebx,(%esp)
  801cb3:	e8 3e f1 ff ff       	call   800df6 <fd2data>
  801cb8:	83 c4 08             	add    $0x8,%esp
  801cbb:	50                   	push   %eax
  801cbc:	6a 00                	push   $0x0
  801cbe:	e8 b7 ef ff ff       	call   800c7a <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801cd1:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801cd4:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801cd6:	a1 04 40 80 00       	mov    0x804004,%eax
  801cdb:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  801cde:	83 ec 0c             	sub    $0xc,%esp
  801ce1:	ff 75 e0             	pushl  -0x20(%ebp)
  801ce4:	e8 32 05 00 00       	call   80221b <pageref>
  801ce9:	89 c3                	mov    %eax,%ebx
  801ceb:	89 3c 24             	mov    %edi,(%esp)
  801cee:	e8 28 05 00 00       	call   80221b <pageref>
  801cf3:	83 c4 10             	add    $0x10,%esp
  801cf6:	39 c3                	cmp    %eax,%ebx
  801cf8:	0f 94 c1             	sete   %cl
  801cfb:	0f b6 c9             	movzbl %cl,%ecx
  801cfe:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801d01:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801d07:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801d0a:	39 ce                	cmp    %ecx,%esi
  801d0c:	74 1b                	je     801d29 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  801d0e:	39 c3                	cmp    %eax,%ebx
  801d10:	75 c4                	jne    801cd6 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801d12:	8b 42 58             	mov    0x58(%edx),%eax
  801d15:	ff 75 e4             	pushl  -0x1c(%ebp)
  801d18:	50                   	push   %eax
  801d19:	56                   	push   %esi
  801d1a:	68 b7 2a 80 00       	push   $0x802ab7
  801d1f:	e8 49 e5 ff ff       	call   80026d <cprintf>
  801d24:	83 c4 10             	add    $0x10,%esp
  801d27:	eb ad                	jmp    801cd6 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801d40:	56                   	push   %esi
  801d41:	e8 b0 f0 ff ff       	call   800df6 <fd2data>
  ...
  801d50:	eb 4b                	jmp    801d9d <devpipe_write+0x69>
  ...
  801d56:	e8 6d ff ff ff       	call   801cc8 <_pipeisclosed>
  801d5b:	85 c0                	test   %eax,%eax
  801d5d:	75 48                	jne    801da7 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  801d5f:	e8 72 ee ff ff       	call   800bd6 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801d67:	8b 0b                	mov    (%ebx),%ecx
  801d69:	8d 51 20             	lea    0x20(%ecx),%edx
  801d6c:	39 d0                	cmp    %edx,%eax
  801d6e:	73 e2                	jae    801d52 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801d73:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  801d77:	88 4d e7             	mov    %cl,-0x19(%ebp)
  801d7a:	89 c2                	mov    %eax,%edx
  801d7c:	c1 fa 1f             	sar    $0x1f,%edx
  801d7f:	89 d1                	mov    %edx,%ecx
  801d81:	c1 e9 1b             	shr    $0x1b,%ecx
  801d84:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  801d87:	83 e2 1f             	and    $0x1f,%edx
  801d8a:	29 ca                	sub    %ecx,%edx
  801d8c:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  801d90:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  801d94:	83 c0 01             	add    $0x1,%eax
  801d97:	89 43 04             	mov    %eax,0x4(%ebx)
	if (debug)
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801d9a:	83 c7 01             	add    $0x1,%edi
  801d9d:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801da0:	75 c2                	jne    801d64 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801da5:	eb 05                	jmp    801dac <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801dbd:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801dc0:	57                   	push   %edi
  801dc1:	e8 30 f0 ff ff       	call   800df6 <fd2data>
  ...
  801dd0:	eb 3d                	jmp    801e0f <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801dd2:	85 db                	test   %ebx,%ebx
  801dd4:	74 04                	je     801dda <devpipe_read+0x26>
				return i;
  801dd6:	89 d8                	mov    %ebx,%eax
  801dd8:	eb 44                	jmp    801e1e <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  801dda:	89 f2                	mov    %esi,%edx
  801ddc:	89 f8                	mov    %edi,%eax
  801dde:	e8 e5 fe ff ff       	call   801cc8 <_pipeisclosed>
  801de3:	85 c0                	test   %eax,%eax
  801de5:	75 32                	jne    801e19 <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801de7:	e8 ea ed ff ff       	call   800bd6 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  801dee:	3b 46 04             	cmp    0x4(%esi),%eax
  801df1:	74 df                	je     801dd2 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801dfe:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801e03:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801e06:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  801e09:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801e0c:	83 c3 01             	add    $0x1,%ebx
  801e0f:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801e12:	75 d8                	jne    801dec <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  801e17:	eb 05                	jmp    801e1e <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  801ea1:	e8 50 ef ff ff       	call   800df6 <fd2data>
  ...
  801f1b:	e8 c6 ee ff ff       	call   800de6 <fd2num>
  801f20:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801f23:	89 01                	mov    %eax,(%ecx)
	pfd[1] = fd2num(fd1);
  801f25:	83 c4 04             	add    $0x4,%esp
  801f28:	ff 75 f0             	pushl  -0x10(%ebp)
  801f2b:	e8 b6 ee ff ff       	call   800de6 <fd2num>
  801f30:	8b 4d 08             	mov    0x8(%ebp),%ecx
  801f33:	89 41 04             	mov    %eax,0x4(%ecx)
	return 0;
  801f36:	83 c4 10             	add    $0x10,%esp
  801f39:	ba 00 00 00 00       	mov    $0x0,%edx
  801f3e:	eb 30                	jmp    801f70 <pipe+0x14a>
  ...
  801f46:	e8 2f ed ff ff       	call   800c7a <sys_page_unmap>
  ...
  801f56:	e8 1f ed ff ff       	call   800c7a <sys_page_unmap>
  ...
  801f66:	e8 0f ed ff ff       	call   800c7a <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801f86:	e8 d1 ee ff ff       	call   800e5c <fd_lookup>
  801f8b:	83 c4 10             	add    $0x10,%esp
  801f8e:	85 c0                	test   %eax,%eax
  801f90:	78 18                	js     801faa <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801f92:	83 ec 0c             	sub    $0xc,%esp
  801f95:	ff 75 f4             	pushl  -0xc(%ebp)
  801f98:	e8 59 ee ff ff       	call   800df6 <fd2data>
	return _pipeisclosed(fd, p);
  801f9d:	89 c2                	mov    %eax,%edx
  801f9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801fa2:	e8 21 fd ff ff       	call   801cc8 <_pipeisclosed>
  801fa7:	83 c4 10             	add    $0x10,%esp
}
  801faa:	c9                   	leave  
  801fab:	c3                   	ret    

00801fac <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801fbc:	68 cf 2a 80 00       	push   $0x802acf
  801fc1:	ff 75 0c             	pushl  0xc(%ebp)
  801fc4:	e8 29 e8 ff ff       	call   8007f2 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801fd4:	56                   	push   %esi
  801fd5:	53                   	push   %ebx
  801fd6:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  801fe1:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801fe7:	eb 2d                	jmp    802016 <devcons_write+0x46>
		m = n - tot;
  ...
  801fee:	83 fb 7f             	cmp    $0x7f,%ebx
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801ff1:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801ff6:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  ...
  802000:	50                   	push   %eax
  802001:	57                   	push   %edi
  802002:	e8 7d e9 ff ff       	call   800984 <memmove>
		sys_cputs(buf, m);
  802007:	83 c4 08             	add    $0x8,%esp
  80200a:	53                   	push   %ebx
  80200b:	57                   	push   %edi
  80200c:	e8 28 eb ff ff       	call   800b39 <sys_cputs>
	int tot, m;
	char buf[128];
  ...
  80201b:	72 cc                	jb     801fe9 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  802034:	74 2a                	je     802060 <devcons_read+0x3b>
  802036:	eb 05                	jmp    80203d <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  802038:	e8 99 eb ff ff       	call   800bd6 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  80203d:	e8 15 eb ff ff       	call   800b57 <sys_cgetc>
  802042:	85 c0                	test   %eax,%eax
  802044:	74 f2                	je     802038 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  802046:	85 c0                	test   %eax,%eax
  802048:	78 16                	js     802060 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  80204a:	83 f8 04             	cmp    $0x4,%eax
  80204d:	74 0c                	je     80205b <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  ...
  802059:	eb 05                	jmp    802060 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  802073:	50                   	push   %eax
  802074:	e8 c0 ea ff ff       	call   800b39 <sys_cputs>
}
...
getchar(void)
{
  ...
  80208c:	e8 31 f0 ff ff       	call   8010c2 <read>
	if (r < 0)
  802091:	83 c4 10             	add    $0x10,%esp
  802094:	85 c0                	test   %eax,%eax
  802096:	78 0f                	js     8020a7 <getchar+0x29>
		return r;
	if (r < 1)
  802098:	85 c0                	test   %eax,%eax
  80209a:	7e 06                	jle    8020a2 <getchar+0x24>
		return -E_EOF;
	return c;
  80209c:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  8020a0:	eb 05                	jmp    8020a7 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  8020a2:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  8020a7:	c9                   	leave  
  8020a8:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  8020b6:	e8 a1 ed ff ff       	call   800e5c <fd_lookup>
  8020bb:	83 c4 10             	add    $0x10,%esp
  8020be:	85 c0                	test   %eax,%eax
  8020c0:	78 11                	js     8020d3 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  8020c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8020c5:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  8020cb:	39 10                	cmp    %edx,(%eax)
  8020cd:	0f 94 c0             	sete   %al
  8020d0:	0f b6 c0             	movzbl %al,%eax
}
  8020d3:	c9                   	leave  
  8020d4:	c3                   	ret    
...
opencons(void)
{
  ...
  8020de:	50                   	push   %eax
  8020df:	e8 29 ed ff ff       	call   800e0d <fd_alloc>
...
opencons(void)
{
  ...
  8020eb:	78 3e                	js     80212b <opencons+0x56>
		return r;
  ...
  8020fa:	e8 f6 ea ff ff       	call   800bf5 <sys_page_alloc>
  ...
  802106:	78 23                	js     80212b <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  802108:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  ...
  802120:	50                   	push   %eax
  802121:	e8 c0 ec ff ff       	call   800de6 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802132:	56                   	push   %esi
  802133:	53                   	push   %ebx
  802134:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  80213d:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  80213f:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  802144:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  802147:	83 ec 0c             	sub    $0xc,%esp
  80214a:	50                   	push   %eax
  80214b:	e8 55 ec ff ff       	call   800da5 <sys_ipc_recv>
  ...
  802155:	78 0e                	js     802165 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  802157:	8b 15 04 40 80 00    	mov    0x804004,%edx
  80215d:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  802160:	8b 52 78             	mov    0x78(%edx),%edx
  802163:	eb 0a                	jmp    80216f <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
  ...
  802171:	74 02                	je     802175 <ipc_recv+0x46>
			 *from_env_store = s_envid;
  802173:	89 0e                	mov    %ecx,(%esi)

	   if (perm_store)
  802175:	85 db                	test   %ebx,%ebx
  802177:	74 02                	je     80217b <ipc_recv+0x4c>
			 *perm_store = s_perm;
  802179:	89 13                	mov    %edx,(%ebx)

	   return (a >=0) ? thisenv -> env_ipc_value : a;
  80217b:	85 c0                	test   %eax,%eax
  80217d:	78 08                	js     802187 <ipc_recv+0x58>
  80217f:	a1 04 40 80 00       	mov    0x804004,%eax
  802184:	8b 40 70             	mov    0x70(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8021a0:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  8021a2:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  8021a7:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
  ...
  8021ae:	56                   	push   %esi
  8021af:	57                   	push   %edi
  8021b0:	e8 cd eb ff ff       	call   800d82 <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  8021b5:	83 c4 10             	add    $0x10,%esp
  8021b8:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8021bb:	75 07                	jne    8021c4 <ipc_send+0x36>
				    sys_yield();
  8021bd:	e8 14 ea ff ff       	call   800bd6 <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  8021c2:	eb e6                	jmp    8021aa <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  8021c6:	74 12                	je     8021da <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  8021c8:	50                   	push   %eax
  8021c9:	68 db 2a 80 00       	push   $0x802adb
  8021ce:	6a 4b                	push   $0x4b
  8021d0:	68 ef 2a 80 00       	push   $0x802aef
  8021d5:	e8 ba df ff ff       	call   800194 <_panic>
			 }
	   }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  8021fb:	75 0d                	jne    80220a <ipc_find_env+0x28>
				    return envs[i].env_id;
  8021fd:	6b c0 7c             	imul   $0x7c,%eax,%eax
  802200:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  802205:	8b 40 48             	mov    0x48(%eax),%eax
  802208:	eb 0f                	jmp    802219 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
  ...
  802212:	75 d9                	jne    8021ed <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001b4:	e8 b7 19 00 00       	call   801b70 <__udivdi3>
  ...
  8001f7:	e8 a4 1a 00 00       	call   801ca0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800a8e:	e8 6a 0f 00 00       	call   8019fd <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b0f:	e8 e9 0e 00 00       	call   8019fd <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b51:	e8 a7 0e 00 00       	call   8019fd <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b93:	e8 65 0e 00 00       	call   8019fd <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bd5:	e8 23 0e 00 00       	call   8019fd <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c17:	e8 e1 0d 00 00       	call   8019fd <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c59:	e8 9f 0d 00 00       	call   8019fd <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cbd:	e8 3b 0d 00 00       	call   8019fd <_panic>
...
stat(const char *path, struct Stat *stat)
{
  ...
  801249:	e8 2c 02 00 00       	call   80147a <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801290:	e8 61 08 00 00       	call   801af6 <ipc_find_env>
  ...
  8012ab:	e8 f2 07 00 00       	call   801aa2 <ipc_send>
	   return ipc_recv(NULL, dstva, NULL);
  8012b0:	83 c4 0c             	add    $0xc,%esp
  8012b3:	6a 00                	push   $0x0
  8012b5:	53                   	push   %ebx
  8012b6:	6a 00                	push   $0x0
  8012b8:	e8 86 07 00 00       	call   801a43 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80137e:	89 1d 04 50 80 00    	mov    %ebx,0x805004
	   int bytes_written = sizeof(fsipcbuf.write.req_buf);
	   memmove (fsipcbuf.write.req_buf, buf, MIN(bytes_written, n));
  801384:	81 fb f8 0f 00 00    	cmp    $0xff8,%ebx
  80138a:	b8 f8 0f 00 00       	mov    $0xff8,%eax
  ...
  8013b4:	78 3d                	js     8013f3 <devfile_write+0x8a>
			 return r;

	   assert (r <= n);
  8013b6:	39 c3                	cmp    %eax,%ebx
  8013b8:	73 19                	jae    8013d3 <devfile_write+0x6a>
  8013ba:	68 f8 21 80 00       	push   $0x8021f8
  8013bf:	68 ff 21 80 00       	push   $0x8021ff
  8013c4:	68 9a 00 00 00       	push   $0x9a
  8013c9:	68 14 22 80 00       	push   $0x802214
  8013ce:	e8 2a 06 00 00       	call   8019fd <_panic>
	   assert (r <= bytes_written);
  8013d3:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8013d8:	7e 19                	jle    8013f3 <devfile_write+0x8a>
  8013da:	68 1f 22 80 00       	push   $0x80221f
  8013df:	68 ff 21 80 00       	push   $0x8021ff
  8013e4:	68 9b 00 00 00       	push   $0x9b
  8013e9:	68 14 22 80 00       	push   $0x802214
  8013ee:	e8 0a 06 00 00       	call   8019fd <_panic>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80140b:	89 35 04 50 80 00    	mov    %esi,0x805004
	   if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  801411:	ba 00 00 00 00       	mov    $0x0,%edx
  801416:	b8 03 00 00 00       	mov    $0x3,%eax
  80141b:	e8 59 fe ff ff       	call   801279 <fsipc>
  801420:	89 c3                	mov    %eax,%ebx
  801422:	85 c0                	test   %eax,%eax
  801424:	78 4b                	js     801471 <devfile_read+0x79>
			 return r;
	   assert(r <= n);
  801426:	39 c6                	cmp    %eax,%esi
  801428:	73 16                	jae    801440 <devfile_read+0x48>
  80142a:	68 f8 21 80 00       	push   $0x8021f8
  80142f:	68 ff 21 80 00       	push   $0x8021ff
  801434:	6a 7c                	push   $0x7c
  801436:	68 14 22 80 00       	push   $0x802214
  80143b:	e8 bd 05 00 00       	call   8019fd <_panic>
	   assert(r <= PGSIZE);
  801440:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801445:	7e 16                	jle    80145d <devfile_read+0x65>
  801447:	68 32 22 80 00       	push   $0x802232
  80144c:	68 ff 21 80 00       	push   $0x8021ff
  801451:	6a 7d                	push   $0x7d
  801453:	68 14 22 80 00       	push   $0x802214
  801458:	e8 a0 05 00 00       	call   8019fd <_panic>
	   memmove(buf, fsipcbuf.readRet.ret_buf, r);
  80145d:	83 ec 04             	sub    $0x4,%esp
  801460:	50                   	push   %eax
  801461:	68 00 50 80 00       	push   $0x805000
  801466:	ff 75 0c             	pushl  0xc(%ebp)
  801469:	e8 fa f3 ff ff       	call   800868 <memmove>
	   return r;
...
open(const char *path, int mode)
{
  ...
  801484:	53                   	push   %ebx
  801485:	e8 13 f2 ff ff       	call   80069d <strlen>
  80148a:	83 c4 10             	add    $0x10,%esp
  80148d:	3d ff 03 00 00       	cmp    $0x3ff,%eax
  801492:	7f 67                	jg     8014fb <open+0x81>
			 return -E_BAD_PATH;
  ...
  80149a:	50                   	push   %eax
  80149b:	e8 51 f8 ff ff       	call   800cf1 <fd_alloc>
  ...
  8014a7:	78 57                	js     801500 <open+0x86>
			 return r;
  ...
  8014f9:	eb 05                	jmp    801500 <open+0x86>
	   ...
	   if (strlen(path) >= MAXPATHLEN)
			 return -E_BAD_PATH;
  8014fb:	ba f4 ff ff ff       	mov    $0xfffffff4,%edx
			 fd_close(fd, 0);
			 return r;
	   }
...
sync(void)
{
  ...
  801517:	e8 5d fd ff ff       	call   801279 <fsipc>
}
  80151c:	c9                   	leave  
  80151d:	c3                   	ret    

0080151e <devpipe_stat>:
	return i;
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80152c:	e8 a9 f7 ff ff       	call   800cda <fd2data>
  801531:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801533:	83 c4 08             	add    $0x8,%esp
  801536:	68 3e 22 80 00       	push   $0x80223e
  80153b:	53                   	push   %ebx
  80153c:	e8 95 f1 ff ff       	call   8006d6 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801541:	8b 46 04             	mov    0x4(%esi),%eax
  801544:	2b 06                	sub    (%esi),%eax
  801546:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  80154c:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801553:	00 00 00 
	stat->st_dev = &devpipe;
  801556:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  80155d:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801579:	e8 e0 f5 ff ff       	call   800b5e <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  80157e:	89 1c 24             	mov    %ebx,(%esp)
  801581:	e8 54 f7 ff ff       	call   800cda <fd2data>
  801586:	83 c4 08             	add    $0x8,%esp
  801589:	50                   	push   %eax
  80158a:	6a 00                	push   $0x0
  80158c:	e8 cd f5 ff ff       	call   800b5e <sys_page_unmap>
}
  801591:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801594:	c9                   	leave  
  801595:	c3                   	ret    

00801596 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80159f:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  8015a9:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  8015ac:	83 ec 0c             	sub    $0xc,%esp
  8015af:	ff 75 e0             	pushl  -0x20(%ebp)
  8015b2:	e8 78 05 00 00       	call   801b2f <pageref>
  8015b7:	89 c3                	mov    %eax,%ebx
  8015b9:	89 3c 24             	mov    %edi,(%esp)
  8015bc:	e8 6e 05 00 00       	call   801b2f <pageref>
  8015c1:	83 c4 10             	add    $0x10,%esp
  8015c4:	39 c3                	cmp    %eax,%ebx
  8015c6:	0f 94 c1             	sete   %cl
  8015c9:	0f b6 c9             	movzbl %cl,%ecx
  8015cc:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  8015cf:	8b 15 04 40 80 00    	mov    0x804004,%edx
  8015d5:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  8015d8:	39 ce                	cmp    %ecx,%esi
  8015da:	74 1b                	je     8015f7 <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  8015dc:	39 c3                	cmp    %eax,%ebx
  8015de:	75 c4                	jne    8015a4 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  8015e0:	8b 42 58             	mov    0x58(%edx),%eax
  8015e3:	ff 75 e4             	pushl  -0x1c(%ebp)
  8015e6:	50                   	push   %eax
  8015e7:	56                   	push   %esi
  8015e8:	68 45 22 80 00       	push   $0x802245
  8015ed:	e8 5f eb ff ff       	call   800151 <cprintf>
  8015f2:	83 c4 10             	add    $0x10,%esp
  8015f5:	eb ad                	jmp    8015a4 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  80160e:	56                   	push   %esi
  80160f:	e8 c6 f6 ff ff       	call   800cda <fd2data>
  ...
  80161e:	eb 4b                	jmp    80166b <devpipe_write+0x69>
  ...
  801624:	e8 6d ff ff ff       	call   801596 <_pipeisclosed>
  801629:	85 c0                	test   %eax,%eax
  80162b:	75 48                	jne    801675 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  80162d:	e8 88 f4 ff ff       	call   800aba <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801632:	8b 43 04             	mov    0x4(%ebx),%eax
  801635:	8b 0b                	mov    (%ebx),%ecx
  801637:	8d 51 20             	lea    0x20(%ecx),%edx
  80163a:	39 d0                	cmp    %edx,%eax
  80163c:	73 e2                	jae    801620 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801641:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  801645:	88 4d e7             	mov    %cl,-0x19(%ebp)
  801648:	89 c2                	mov    %eax,%edx
  80164a:	c1 fa 1f             	sar    $0x1f,%edx
  80164d:	89 d1                	mov    %edx,%ecx
  80164f:	c1 e9 1b             	shr    $0x1b,%ecx
  801652:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  801655:	83 e2 1f             	and    $0x1f,%edx
  801658:	29 ca                	sub    %ecx,%edx
  80165a:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  ...
  801665:	89 43 04             	mov    %eax,0x4(%ebx)
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  801668:	83 c7 01             	add    $0x1,%edi
  80166b:	3b 7d 10             	cmp    0x10(%ebp),%edi
  80166e:	75 c2                	jne    801632 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801673:	eb 05                	jmp    80167a <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80168b:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  80168e:	57                   	push   %edi
  80168f:	e8 46 f6 ff ff       	call   800cda <fd2data>
  ...
  80169e:	eb 3d                	jmp    8016dd <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  8016a0:	85 db                	test   %ebx,%ebx
  8016a2:	74 04                	je     8016a8 <devpipe_read+0x26>
				return i;
  8016a4:	89 d8                	mov    %ebx,%eax
  8016a6:	eb 44                	jmp    8016ec <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  8016a8:	89 f2                	mov    %esi,%edx
  8016aa:	89 f8                	mov    %edi,%eax
  8016ac:	e8 e5 fe ff ff       	call   801596 <_pipeisclosed>
  8016b1:	85 c0                	test   %eax,%eax
  8016b3:	75 32                	jne    8016e7 <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  8016b5:	e8 00 f4 ff ff       	call   800aba <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  8016ba:	8b 06                	mov    (%esi),%eax
  8016bc:	3b 46 04             	cmp    0x4(%esi),%eax
  8016bf:	74 df                	je     8016a0 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  8016c1:	99                   	cltd   
  8016c2:	c1 ea 1b             	shr    $0x1b,%edx
  8016c5:	01 d0                	add    %edx,%eax
  8016c7:	83 e0 1f             	and    $0x1f,%eax
  8016ca:	29 d0                	sub    %edx,%eax
  8016cc:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  8016d1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8016d4:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  8016d7:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  8016dd:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  8016e0:	75 d8                	jne    8016ba <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  8016e5:	eb 05                	jmp    8016ec <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  80176f:	e8 66 f5 ff ff       	call   800cda <fd2data>
  ...
  8017ce:	8b 15 20 30 80 00    	mov    0x803020,%edx
  ...
  80180c:	eb 30                	jmp    80183e <pipe+0x14a>
  ...
  80181f:	ff 75 f0             	pushl  -0x10(%ebp)
  801822:	6a 00                	push   $0x0
  801824:	e8 35 f3 ff ff       	call   800b5e <sys_page_unmap>
  ...
  801834:	e8 25 f3 ff ff       	call   800b5e <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801854:	e8 e7 f4 ff ff       	call   800d40 <fd_lookup>
  801859:	83 c4 10             	add    $0x10,%esp
  80185c:	85 c0                	test   %eax,%eax
  80185e:	78 18                	js     801878 <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801860:	83 ec 0c             	sub    $0xc,%esp
  801863:	ff 75 f4             	pushl  -0xc(%ebp)
  801866:	e8 6f f4 ff ff       	call   800cda <fd2data>
	return _pipeisclosed(fd, p);
  80186b:	89 c2                	mov    %eax,%edx
  80186d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801870:	e8 21 fd ff ff       	call   801596 <_pipeisclosed>
  801875:	83 c4 10             	add    $0x10,%esp
}
  801878:	c9                   	leave  
  801879:	c3                   	ret    

0080187a <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80188a:	68 5d 22 80 00       	push   $0x80225d
  80188f:	ff 75 0c             	pushl  0xc(%ebp)
  801892:	e8 3f ee ff ff       	call   8006d6 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8018a2:	56                   	push   %esi
  8018a3:	53                   	push   %ebx
  8018a4:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  8018af:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  8018b5:	eb 2d                	jmp    8018e4 <devcons_write+0x46>
		m = n - tot;
  8018b7:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8018ba:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  8018bc:	83 fb 7f             	cmp    $0x7f,%ebx
	char buf[128];
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  8018bf:	ba 7f 00 00 00       	mov    $0x7f,%edx
  8018c4:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  8018c7:	83 ec 04             	sub    $0x4,%esp
  8018ca:	53                   	push   %ebx
  8018cb:	03 45 0c             	add    0xc(%ebp),%eax
  8018ce:	50                   	push   %eax
  8018cf:	57                   	push   %edi
  8018d0:	e8 93 ef ff ff       	call   800868 <memmove>
		sys_cputs(buf, m);
  8018d5:	83 c4 08             	add    $0x8,%esp
  8018d8:	53                   	push   %ebx
  8018d9:	57                   	push   %edi
  8018da:	e8 3e f1 ff ff       	call   800a1d <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801902:	74 2a                	je     80192e <devcons_read+0x3b>
  801904:	eb 05                	jmp    80190b <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801906:	e8 af f1 ff ff       	call   800aba <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  80190b:	e8 2b f1 ff ff       	call   800a3b <sys_cgetc>
  801910:	85 c0                	test   %eax,%eax
  801912:	74 f2                	je     801906 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801914:	85 c0                	test   %eax,%eax
  801916:	78 16                	js     80192e <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801918:	83 f8 04             	cmp    $0x4,%eax
  80191b:	74 0c                	je     801929 <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  ...
  801927:	eb 05                	jmp    80192e <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801939:	88 45 f7             	mov    %al,-0x9(%ebp)
  ...
  801941:	50                   	push   %eax
  801942:	e8 d6 f0 ff ff       	call   800a1d <sys_cputs>
}
...
getchar(void)
{
  ...
  801954:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801957:	50                   	push   %eax
  801958:	6a 00                	push   $0x0
  80195a:	e8 47 f6 ff ff       	call   800fa6 <read>
	if (r < 0)
  80195f:	83 c4 10             	add    $0x10,%esp
  801962:	85 c0                	test   %eax,%eax
  801964:	78 0f                	js     801975 <getchar+0x29>
		return r;
	if (r < 1)
  801966:	85 c0                	test   %eax,%eax
  801968:	7e 06                	jle    801970 <getchar+0x24>
		return -E_EOF;
	return c;
  80196a:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  80196e:	eb 05                	jmp    801975 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  801970:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801975:	c9                   	leave  
  801976:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  801984:	e8 b7 f3 ff ff       	call   800d40 <fd_lookup>
  801989:	83 c4 10             	add    $0x10,%esp
  80198c:	85 c0                	test   %eax,%eax
  80198e:	78 11                	js     8019a1 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  801990:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801993:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  801999:	39 10                	cmp    %edx,(%eax)
  80199b:	0f 94 c0             	sete   %al
...
opencons(void)
{
  ...
  8019ac:	50                   	push   %eax
  8019ad:	e8 3f f3 ff ff       	call   800cf1 <fd_alloc>
...
opencons(void)
{
  ...
  8019b9:	78 3e                	js     8019f9 <opencons+0x56>
		return r;
	if ((r = sys_page_alloc(0, fd, PTE_P|PTE_U|PTE_W|PTE_SHARE)) < 0)
  8019bb:	83 ec 04             	sub    $0x4,%esp
  8019be:	68 07 04 00 00       	push   $0x407
  8019c3:	ff 75 f4             	pushl  -0xc(%ebp)
  8019c6:	6a 00                	push   $0x0
  8019c8:	e8 0c f1 ff ff       	call   800ad9 <sys_page_alloc>
  ...
  8019d4:	78 23                	js     8019f9 <opencons+0x56>
		return r;
	fd->fd_dev_id = devcons.dev_id;
  8019d6:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  8019dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019df:	89 10                	mov    %edx,(%eax)
	fd->fd_omode = O_RDWR;
  8019e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019e4:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  8019eb:	83 ec 0c             	sub    $0xc,%esp
  8019ee:	50                   	push   %eax
  8019ef:	e8 d6 f2 ff ff       	call   800cca <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a01:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  801a02:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801a05:	8b 35 00 30 80 00    	mov    0x803000,%esi
  801a0b:	e8 8b f0 ff ff       	call   800a9b <sys_getenvid>
  801a10:	83 ec 0c             	sub    $0xc,%esp
  801a13:	ff 75 0c             	pushl  0xc(%ebp)
  801a16:	ff 75 08             	pushl  0x8(%ebp)
  801a19:	56                   	push   %esi
  801a1a:	50                   	push   %eax
  801a1b:	68 6c 22 80 00       	push   $0x80226c
  801a20:	e8 2c e7 ff ff       	call   800151 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801a25:	83 c4 18             	add    $0x18,%esp
  801a28:	53                   	push   %ebx
  801a29:	ff 75 10             	pushl  0x10(%ebp)
  801a2c:	e8 cf e6 ff ff       	call   800100 <vcprintf>
	cprintf("\n");
  801a31:	c7 04 24 56 22 80 00 	movl   $0x802256,(%esp)
  801a38:	e8 14 e7 ff ff       	call   800151 <cprintf>
  801a3d:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  801a40:	cc                   	int3   
  801a41:	eb fd                	jmp    801a40 <_panic+0x43>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a51:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  801a53:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801a58:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  801a5b:	83 ec 0c             	sub    $0xc,%esp
  801a5e:	50                   	push   %eax
  801a5f:	e8 25 f2 ff ff       	call   800c89 <sys_ipc_recv>
  ...
  801a69:	78 0e                	js     801a79 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  801a6b:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801a71:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  801a74:	8b 52 78             	mov    0x78(%edx),%edx
  801a77:	eb 0a                	jmp    801a83 <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
  ...
  801a85:	74 02                	je     801a89 <ipc_recv+0x46>
			 *from_env_store = s_envid;
  801a87:	89 0e                	mov    %ecx,(%esi)

	   if (perm_store)
  801a89:	85 db                	test   %ebx,%ebx
  801a8b:	74 02                	je     801a8f <ipc_recv+0x4c>
			 *perm_store = s_perm;
  801a8d:	89 13                	mov    %edx,(%ebx)

	   return (a >=0) ? thisenv -> env_ipc_value : a;
  801a8f:	85 c0                	test   %eax,%eax
  801a91:	78 08                	js     801a9b <ipc_recv+0x58>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801aae:	8b 75 0c             	mov    0xc(%ebp),%esi
  801ab1:	8b 5d 10             	mov    0x10(%ebp),%ebx
	   // LAB 4: Your code here.
	   if (!pg) {
  801ab4:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  801ab6:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  801abb:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
  ...
  801ac2:	56                   	push   %esi
  801ac3:	57                   	push   %edi
  801ac4:	e8 9d f1 ff ff       	call   800c66 <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  801ac9:	83 c4 10             	add    $0x10,%esp
  801acc:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801acf:	75 07                	jne    801ad8 <ipc_send+0x36>
				    sys_yield();
  801ad1:	e8 e4 ef ff ff       	call   800aba <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  801ad6:	eb e6                	jmp    801abe <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  801ada:	74 12                	je     801aee <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  801adc:	50                   	push   %eax
  801add:	68 90 22 80 00       	push   $0x802290
  801ae2:	6a 4b                	push   $0x4b
  801ae4:	68 a4 22 80 00       	push   $0x8022a4
  801ae9:	e8 0f ff ff ff       	call   8019fd <_panic>
			 }
	   }
}

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800377:	e8 74 19 00 00       	call   801cf0 <__udivdi3>
  ...
  8003ba:	e8 61 1a 00 00       	call   801e20 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8005a5:	52                   	push   %edx
  8005a6:	68 15 24 80 00       	push   $0x802415
  8005ab:	53                   	push   %ebx
  8005ac:	56                   	push   %esi
...
stat(const char *path, struct Stat *stat)
{
  ...
  80140c:	e8 2c 02 00 00       	call   80163d <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801453:	e8 1b 08 00 00       	call   801c73 <ipc_find_env>
  ...
  80146e:	e8 ac 07 00 00       	call   801c1f <ipc_send>
	   return ipc_recv(NULL, dstva, NULL);
  801473:	83 c4 0c             	add    $0xc,%esp
  801476:	6a 00                	push   $0x0
  801478:	53                   	push   %ebx
  801479:	6a 00                	push   $0x0
  80147b:	e8 40 07 00 00       	call   801bc0 <ipc_recv>
}
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801533:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  801541:	89 1d 04 50 80 00    	mov    %ebx,0x805004
	   int bytes_written = sizeof(fsipcbuf.write.req_buf);
	   memmove (fsipcbuf.write.req_buf, buf, MIN(bytes_written, n));
  801547:	81 fb f8 0f 00 00    	cmp    $0xff8,%ebx
  80154d:	b8 f8 0f 00 00       	mov    $0xff8,%eax
  801552:	0f 46 c3             	cmovbe %ebx,%eax
  801555:	50                   	push   %eax
  ...
  801577:	78 3d                	js     8015b6 <devfile_write+0x8a>
			 return r;

	   assert (r <= n);
  801579:	39 c3                	cmp    %eax,%ebx
  80157b:	73 19                	jae    801596 <devfile_write+0x6a>
  80157d:	68 fc 23 80 00       	push   $0x8023fc
  801582:	68 03 24 80 00       	push   $0x802403
  801587:	68 9a 00 00 00       	push   $0x9a
  80158c:	68 18 24 80 00       	push   $0x802418
  801591:	e8 a5 ec ff ff       	call   80023b <_panic>
	   assert (r <= bytes_written);
  801596:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  80159b:	7e 19                	jle    8015b6 <devfile_write+0x8a>
  80159d:	68 23 24 80 00       	push   $0x802423
  8015a2:	68 03 24 80 00       	push   $0x802403
  8015a7:	68 9b 00 00 00       	push   $0x9b
  8015ac:	68 18 24 80 00       	push   $0x802418
  8015b1:	e8 85 ec ff ff       	call   80023b <_panic>
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8015de:	e8 59 fe ff ff       	call   80143c <fsipc>
  ...
  8015ed:	68 fc 23 80 00       	push   $0x8023fc
  8015f2:	68 03 24 80 00       	push   $0x802403
  8015f7:	6a 7c                	push   $0x7c
  8015f9:	68 18 24 80 00       	push   $0x802418
  8015fe:	e8 38 ec ff ff       	call   80023b <_panic>
	   assert(r <= PGSIZE);
  801603:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801608:	7e 16                	jle    801620 <devfile_read+0x65>
  80160a:	68 36 24 80 00       	push   $0x802436
  80160f:	68 03 24 80 00       	push   $0x802403
  801614:	6a 7d                	push   $0x7d
  801616:	68 18 24 80 00       	push   $0x802418
  80161b:	e8 1b ec ff ff       	call   80023b <_panic>
	   memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801620:	83 ec 04             	sub    $0x4,%esp
  801623:	50                   	push   %eax
  801624:	68 00 50 80 00       	push   $0x805000
  801629:	ff 75 0c             	pushl  0xc(%ebp)
  80162c:	e8 fa f3 ff ff       	call   800a2b <memmove>
	   return r;
...
open(const char *path, int mode)
{
  ...
  801647:	53                   	push   %ebx
  801648:	e8 13 f2 ff ff       	call   800860 <strlen>
  ...
  80165d:	50                   	push   %eax
  80165e:	e8 51 f8 ff ff       	call   800eb4 <fd_alloc>
  ...
  801675:	e8 1f f2 ff ff       	call   800899 <strcpy>
  ...
  80168a:	e8 ad fd ff ff       	call   80143c <fsipc>
  ...
  8016a0:	e8 07 f9 ff ff       	call   800fac <fd_close>
			 return r;
  ...
  8016b2:	e8 d6 f7 ff ff       	call   800e8d <fd2num>
...
sync(void)
{
  ...
  8016da:	e8 5d fd ff ff       	call   80143c <fsipc>
}
  8016df:	c9                   	leave  
  8016e0:	c3                   	ret    

008016e1 <devpipe_stat>:
	return i;
}
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016ef:	e8 a9 f7 ff ff       	call   800e9d <fd2data>
  8016f4:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  8016f6:	83 c4 08             	add    $0x8,%esp
  8016f9:	68 42 24 80 00       	push   $0x802442
  8016fe:	53                   	push   %ebx
  8016ff:	e8 95 f1 ff ff       	call   800899 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  801704:	8b 46 04             	mov    0x4(%esi),%eax
  801707:	2b 06                	sub    (%esi),%eax
  801709:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  80170f:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  801716:	00 00 00 
	stat->st_dev = &devpipe;
  801719:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  801720:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  80173c:	e8 e0 f5 ff ff       	call   800d21 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801741:	89 1c 24             	mov    %ebx,(%esp)
  801744:	e8 54 f7 ff ff       	call   800e9d <fd2data>
  801749:	83 c4 08             	add    $0x8,%esp
  80174c:	50                   	push   %eax
  80174d:	6a 00                	push   $0x0
  80174f:	e8 cd f5 ff ff       	call   800d21 <sys_page_unmap>
}
  801754:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  801757:	c9                   	leave  
  801758:	c3                   	ret    

00801759 <_pipeisclosed>:
	return r;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801765:	89 d7                	mov    %edx,%edi
	int n, nn, ret;

	while (1) {
		n = thisenv->env_runs;
  801767:	a1 04 40 80 00       	mov    0x804004,%eax
  80176c:	8b 70 58             	mov    0x58(%eax),%esi
		ret = pageref(fd) == pageref(p);
  80176f:	83 ec 0c             	sub    $0xc,%esp
  801772:	ff 75 e0             	pushl  -0x20(%ebp)
  801775:	e8 32 05 00 00       	call   801cac <pageref>
  80177a:	89 c3                	mov    %eax,%ebx
  80177c:	89 3c 24             	mov    %edi,(%esp)
  80177f:	e8 28 05 00 00       	call   801cac <pageref>
  801784:	83 c4 10             	add    $0x10,%esp
  801787:	39 c3                	cmp    %eax,%ebx
  801789:	0f 94 c1             	sete   %cl
  80178c:	0f b6 c9             	movzbl %cl,%ecx
  80178f:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
		nn = thisenv->env_runs;
  801792:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801798:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  80179b:	39 ce                	cmp    %ecx,%esi
  80179d:	74 1b                	je     8017ba <_pipeisclosed+0x61>
			return ret;
		if (n != nn && ret == 1)
  80179f:	39 c3                	cmp    %eax,%ebx
  8017a1:	75 c4                	jne    801767 <_pipeisclosed+0xe>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  8017a3:	8b 42 58             	mov    0x58(%edx),%eax
  8017a6:	ff 75 e4             	pushl  -0x1c(%ebp)
  8017a9:	50                   	push   %eax
  8017aa:	56                   	push   %esi
  8017ab:	68 49 24 80 00       	push   $0x802449
  8017b0:	e8 5f eb ff ff       	call   800314 <cprintf>
  8017b5:	83 c4 10             	add    $0x10,%esp
  8017b8:	eb ad                	jmp    801767 <_pipeisclosed+0xe>
	}
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8017d1:	56                   	push   %esi
  8017d2:	e8 c6 f6 ff ff       	call   800e9d <fd2data>
  ...
  8017e1:	eb 4b                	jmp    80182e <devpipe_write+0x69>
  ...
  8017e7:	e8 6d ff ff ff       	call   801759 <_pipeisclosed>
  8017ec:	85 c0                	test   %eax,%eax
  8017ee:	75 48                	jne    801838 <devpipe_write+0x73>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_write yield\n");
			sys_yield();
  8017f0:	e8 88 f4 ff ff       	call   800c7d <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
  ...
  8017f8:	8b 0b                	mov    (%ebx),%ecx
  8017fa:	8d 51 20             	lea    0x20(%ecx),%edx
  8017fd:	39 d0                	cmp    %edx,%eax
  8017ff:	73 e2                	jae    8017e3 <devpipe_write+0x1e>
				cprintf("devpipe_write yield\n");
			sys_yield();
		}
  ...
  801804:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  801808:	88 4d e7             	mov    %cl,-0x19(%ebp)
  80180b:	89 c2                	mov    %eax,%edx
  80180d:	c1 fa 1f             	sar    $0x1f,%edx
  801810:	89 d1                	mov    %edx,%ecx
  801812:	c1 e9 1b             	shr    $0x1b,%ecx
  801815:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  801818:	83 e2 1f             	and    $0x1f,%edx
  80181b:	29 ca                	sub    %ecx,%edx
  80181d:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  801821:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  ...
  801828:	89 43 04             	mov    %eax,0x4(%ebx)
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  80182b:	83 c7 01             	add    $0x1,%edi
  80182e:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801831:	75 c2                	jne    8017f5 <devpipe_write+0x30>
		// wait to increment wpos until the byte is stored!
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
		p->p_wpos++;
	}
  ...
  801836:	eb 05                	jmp    80183d <devpipe_write+0x78>
			// pipe is full
			// if all the readers are gone
			// (it's only writers like us now),
			// note eof
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80184e:	8b 7d 08             	mov    0x8(%ebp),%edi
	...
	p = (struct Pipe*)fd2data(fd);
  801851:	57                   	push   %edi
  801852:	e8 46 f6 ff ff       	call   800e9d <fd2data>
  ...
  801861:	eb 3d                	jmp    8018a0 <devpipe_read+0x5b>
		while (p->p_rpos == p->p_wpos) {
			// pipe is empty
			// if we got any data, return it
			if (i > 0)
  801863:	85 db                	test   %ebx,%ebx
  801865:	74 04                	je     80186b <devpipe_read+0x26>
				return i;
  801867:	89 d8                	mov    %ebx,%eax
  801869:	eb 44                	jmp    8018af <devpipe_read+0x6a>
			// if all the writers are gone, note eof
			if (_pipeisclosed(fd, p))
  80186b:	89 f2                	mov    %esi,%edx
  80186d:	89 f8                	mov    %edi,%eax
  80186f:	e8 e5 fe ff ff       	call   801759 <_pipeisclosed>
  801874:	85 c0                	test   %eax,%eax
  801876:	75 32                	jne    8018aa <devpipe_read+0x65>
				return 0;
			// yield and see what happens
			if (debug)
				cprintf("devpipe_read yield\n");
			sys_yield();
  801878:	e8 00 f4 ff ff       	call   800c7d <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	for (i = 0; i < n; i++) {
		while (p->p_rpos == p->p_wpos) {
  80187d:	8b 06                	mov    (%esi),%eax
  80187f:	3b 46 04             	cmp    0x4(%esi),%eax
  801882:	74 df                	je     801863 <devpipe_read+0x1e>
				cprintf("devpipe_read yield\n");
			sys_yield();
		}
  ...
  801884:	99                   	cltd   
  801885:	c1 ea 1b             	shr    $0x1b,%edx
  801888:	01 d0                	add    %edx,%eax
  80188a:	83 e0 1f             	and    $0x1f,%eax
  80188d:	29 d0                	sub    %edx,%eax
  80188f:	0f b6 44 06 08       	movzbl 0x8(%esi,%eax,1),%eax
  801894:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801897:	88 04 19             	mov    %al,(%ecx,%ebx,1)
		p->p_rpos++;
  80189a:	83 06 01             	addl   $0x1,(%esi)
	if (debug)
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
	...
	buf = vbuf;
	for (i = 0; i < n; i++) {
  80189d:	83 c3 01             	add    $0x1,%ebx
  8018a0:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  8018a3:	75 d8                	jne    80187d <devpipe_read+0x38>
		// there's a byte.  take it.
		// wait to increment rpos until the byte is taken!
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
		p->p_rpos++;
  ...
  8018a8:	eb 05                	jmp    8018af <devpipe_read+0x6a>
			// if we got any data, return it
			if (i > 0)
				return i;
			// if all the writers are gone, note eof
...
pipe(int pfd[2])
{
  ...
  801932:	e8 66 f5 ff ff       	call   800e9d <fd2data>
  ...
  801950:	0f 88 89 00 00 00    	js     8019df <pipe+0x128>
		goto err2;
	if ((r = sys_page_map(0, va, 0, fd2data(fd1), PTE_P|PTE_W|PTE_U|PTE_SHARE)) < 0)
  801956:	83 ec 0c             	sub    $0xc,%esp
  801959:	ff 75 f0             	pushl  -0x10(%ebp)
  80195c:	e8 3c f5 ff ff       	call   800e9d <fd2data>
  801961:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  801968:	50                   	push   %eax
  801969:	6a 00                	push   $0x0
  80196b:	56                   	push   %esi
  80196c:	6a 00                	push   $0x0
  80196e:	e8 6c f3 ff ff       	call   800cdf <sys_page_map>
  801973:	89 c3                	mov    %eax,%ebx
  801975:	83 c4 20             	add    $0x20,%esp
  801978:	85 c0                	test   %eax,%eax
  80197a:	78 55                	js     8019d1 <pipe+0x11a>
		goto err3;
  ...
  80198a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)

	fd1->fd_dev_id = devpipe.dev_id;
  801991:	8b 15 20 30 80 00    	mov    0x803020,%edx
  801997:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80199a:	89 10                	mov    %edx,(%eax)
	fd1->fd_omode = O_WRONLY;
  80199c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80199f:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%eax)
  ...
  8019e7:	e8 35 f3 ff ff       	call   800d21 <sys_page_unmap>
  ...
  8019f7:	e8 25 f3 ff ff       	call   800d21 <sys_page_unmap>
...
pipeisclosed(int fdnum)
{
  ...
  801a17:	e8 e7 f4 ff ff       	call   800f03 <fd_lookup>
  801a1c:	83 c4 10             	add    $0x10,%esp
  801a1f:	85 c0                	test   %eax,%eax
  801a21:	78 18                	js     801a3b <pipeisclosed+0x31>
		return r;
	p = (struct Pipe*) fd2data(fd);
  801a23:	83 ec 0c             	sub    $0xc,%esp
  801a26:	ff 75 f4             	pushl  -0xc(%ebp)
  801a29:	e8 6f f4 ff ff       	call   800e9d <fd2data>
	return _pipeisclosed(fd, p);
  801a2e:	89 c2                	mov    %eax,%edx
  801a30:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a33:	e8 21 fd ff ff       	call   801759 <_pipeisclosed>
  801a38:	83 c4 10             	add    $0x10,%esp
}
  801a3b:	c9                   	leave  
  801a3c:	c3                   	ret    

00801a3d <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a4d:	68 61 24 80 00       	push   $0x802461
  801a52:	ff 75 0c             	pushl  0xc(%ebp)
  801a55:	e8 3f ee ff ff       	call   800899 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801a65:	56                   	push   %esi
  801a66:	53                   	push   %ebx
  801a67:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  801a72:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801a78:	eb 2d                	jmp    801aa7 <devcons_write+0x46>
		m = n - tot;
  801a7a:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801a7d:	29 f3                	sub    %esi,%ebx
		if (m > sizeof(buf) - 1)
  801a7f:	83 fb 7f             	cmp    $0x7f,%ebx
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
  801a82:	ba 7f 00 00 00       	mov    $0x7f,%edx
  801a87:	0f 47 da             	cmova  %edx,%ebx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
  801a8a:	83 ec 04             	sub    $0x4,%esp
  801a8d:	53                   	push   %ebx
  801a8e:	03 45 0c             	add    0xc(%ebp),%eax
  801a91:	50                   	push   %eax
  801a92:	57                   	push   %edi
  801a93:	e8 93 ef ff ff       	call   800a2b <memmove>
		sys_cputs(buf, m);
  801a98:	83 c4 08             	add    $0x8,%esp
  801a9b:	53                   	push   %ebx
  801a9c:	57                   	push   %edi
  801a9d:	e8 3e f1 ff ff       	call   800be0 <sys_cputs>
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801aa2:	01 de                	add    %ebx,%esi
  801aa4:	83 c4 10             	add    $0x10,%esp
  801aa7:	89 f0                	mov    %esi,%eax
  801aa9:	3b 75 10             	cmp    0x10(%ebp),%esi
  801aac:	72 cc                	jb     801a7a <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801ac5:	74 2a                	je     801af1 <devcons_read+0x3b>
  801ac7:	eb 05                	jmp    801ace <devcons_read+0x18>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801ac9:	e8 af f1 ff ff       	call   800c7d <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801ace:	e8 2b f1 ff ff       	call   800bfe <sys_cgetc>
  801ad3:	85 c0                	test   %eax,%eax
  801ad5:	74 f2                	je     801ac9 <devcons_read+0x13>
		sys_yield();
	if (c < 0)
  801ad7:	85 c0                	test   %eax,%eax
  801ad9:	78 16                	js     801af1 <devcons_read+0x3b>
		return c;
	if (c == 0x04)	// ctl-d is eof
  801adb:	83 f8 04             	cmp    $0x4,%eax
  801ade:	74 0c                	je     801aec <devcons_read+0x36>
		return 0;
	*(char*)vbuf = c;
  ...
  801aea:	eb 05                	jmp    801af1 <devcons_read+0x3b>
	while ((c = sys_cgetc()) == 0)
		sys_yield();
	if (c < 0)
		return c;
...
cputchar(int ch)
{
  ...
  801afc:	88 45 f7             	mov    %al,-0x9(%ebp)

	// Unlike standard Unix's putchar,
	// the cputchar function _always_ outputs to the system console.
	sys_cputs(&c, 1);
  801aff:	6a 01                	push   $0x1
  801b01:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801b04:	50                   	push   %eax
  801b05:	e8 d6 f0 ff ff       	call   800be0 <sys_cputs>
}
...
getchar(void)
{
  ...
  801b17:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801b1a:	50                   	push   %eax
  801b1b:	6a 00                	push   $0x0
  801b1d:	e8 47 f6 ff ff       	call   801169 <read>
	if (r < 0)
  801b22:	83 c4 10             	add    $0x10,%esp
  801b25:	85 c0                	test   %eax,%eax
  801b27:	78 0f                	js     801b38 <getchar+0x29>
		return r;
	if (r < 1)
  801b29:	85 c0                	test   %eax,%eax
  801b2b:	7e 06                	jle    801b33 <getchar+0x24>
		return -E_EOF;
	return c;
  801b2d:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  801b31:	eb 05                	jmp    801b38 <getchar+0x29>
	// getchar() reads a character from file descriptor 0.
	r = read(0, &c, 1);
	if (r < 0)
		return r;
	if (r < 1)
		return -E_EOF;
  801b33:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
	return c;
}
  801b38:	c9                   	leave  
  801b39:	c3                   	ret    
...
iscons(int fdnum)
{
  ...
  801b47:	e8 b7 f3 ff ff       	call   800f03 <fd_lookup>
  801b4c:	83 c4 10             	add    $0x10,%esp
  801b4f:	85 c0                	test   %eax,%eax
  801b51:	78 11                	js     801b64 <iscons+0x2a>
		return r;
	return fd->fd_dev_id == devcons.dev_id;
  801b53:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801b56:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  801b5c:	39 10                	cmp    %edx,(%eax)
...
opencons(void)
{
  ...
  801b6f:	50                   	push   %eax
  801b70:	e8 3f f3 ff ff       	call   800eb4 <fd_alloc>
...
opencons(void)
{
  ...
  801b7c:	78 3e                	js     801bbc <opencons+0x56>
		return r;
  ...
  801b8b:	e8 0c f1 ff ff       	call   800c9c <sys_page_alloc>
  ...
  801b97:	78 23                	js     801bbc <opencons+0x56>
		return r;
  ...
  801ba7:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
	return fd2num(fd);
  801bae:	83 ec 0c             	sub    $0xc,%esp
  801bb1:	50                   	push   %eax
  801bb2:	e8 d6 f2 ff ff       	call   800e8d <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bce:	85 c0                	test   %eax,%eax
			 pg = (void*) KERNBASE;
  801bd0:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  801bd5:	0f 44 c2             	cmove  %edx,%eax

	   a = sys_ipc_recv (pg);
  801bd8:	83 ec 0c             	sub    $0xc,%esp
  801bdb:	50                   	push   %eax
  801bdc:	e8 6b f2 ff ff       	call   800e4c <sys_ipc_recv>
  ...
  801be6:	78 0e                	js     801bf6 <ipc_recv+0x36>
	   {
			 s_envid = thisenv -> env_ipc_from;
  801be8:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801bee:	8b 4a 74             	mov    0x74(%edx),%ecx
			 s_perm = thisenv -> env_ipc_perm;
  801bf1:	8b 52 78             	mov    0x78(%edx),%edx
  801bf4:	eb 0a                	jmp    801c00 <ipc_recv+0x40>
			 pg = (void*) KERNBASE;
  ...
  801bf6:	ba 00 00 00 00       	mov    $0x0,%edx
	   ...
	   envid_t s_envid = 0;
  801bfb:	b9 00 00 00 00       	mov    $0x0,%ecx
	   {
			 s_envid = thisenv -> env_ipc_from;
			 s_perm = thisenv -> env_ipc_perm;
	   }
  ...
  801c02:	74 02                	je     801c06 <ipc_recv+0x46>
			 *from_env_store = s_envid;
  801c04:	89 0e                	mov    %ecx,(%esi)

	   if (perm_store)
  801c06:	85 db                	test   %ebx,%ebx
  801c08:	74 02                	je     801c0c <ipc_recv+0x4c>
			 *perm_store = s_perm;
  801c0a:	89 13                	mov    %edx,(%ebx)

	   return (a >=0) ? thisenv -> env_ipc_value : a;
  801c0c:	85 c0                	test   %eax,%eax
  801c0e:	78 08                	js     801c18 <ipc_recv+0x58>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c2b:	8b 75 0c             	mov    0xc(%ebp),%esi
  801c2e:	8b 5d 10             	mov    0x10(%ebp),%ebx
	   // LAB 4: Your code here.
	   if (!pg) {
  801c31:	85 db                	test   %ebx,%ebx
			 pg = (void *)KERNBASE;
  801c33:	b8 00 00 00 f0       	mov    $0xf0000000,%eax
  801c38:	0f 44 d8             	cmove  %eax,%ebx
	   }
	   while(true) {
  ...
  801c3f:	56                   	push   %esi
  801c40:	57                   	push   %edi
  801c41:	e8 e3 f1 ff ff       	call   800e29 <sys_ipc_try_send>
			 if (err == -E_IPC_NOT_RECV) {
  801c46:	83 c4 10             	add    $0x10,%esp
  801c49:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c4c:	75 07                	jne    801c55 <ipc_send+0x36>
				    sys_yield();
  801c4e:	e8 2a f0 ff ff       	call   800c7d <sys_yield>
			 } else if (err == 0) {
				    break;
			 } else {
  ...
  801c53:	eb e6                	jmp    801c3b <ipc_send+0x1c>
	   }
	   while(true) {
			 int err = sys_ipc_try_send(to_env, val, pg, perm);
			 if (err == -E_IPC_NOT_RECV) {
  ...
  801c57:	74 12                	je     801c6b <ipc_send+0x4c>
				    break;
			 } else {
				    panic("ipc_send failed: %e", err);
  801c59:	50                   	push   %eax
  801c5a:	68 6d 24 80 00       	push   $0x80246d
  801c5f:	6a 4b                	push   $0x4b
  801c61:	68 81 24 80 00       	push   $0x802481
  801c66:	e8 d0 e5 ff ff       	call   80023b <_panic>
			 }
	   }
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c7e:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c81:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c87:	8b 52 50             	mov    0x50(%edx),%edx
  801c8a:	39 ca                	cmp    %ecx,%edx
  801c8c:	75 0d                	jne    801c9b <ipc_find_env+0x28>
				    return envs[i].env_id;
  801c8e:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c91:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801c96:	8b 40 48             	mov    0x48(%eax),%eax
  801c99:	eb 0f                	jmp    801caa <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
	   envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801ca3:	75 d9                	jne    801c7e <ipc_find_env+0xb>
			 if (envs[i].env_type == type)
				    return envs[i].env_id;
	   return 0;
